...
})({"3F5J7":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "56b7f0d9b1320e91";
"use strict";
...
},{}],"chrle":[function(require,module,exports) {
(()=>{
    var _a = {
        "./node_modules/process/browser.js": (Ne)=>{
            var Y = Ne.exports = {}, se, _e;
            function Ze() {
            ...
            (function() {
                try {
                    typeof setTimeout == "function" ? se = setTimeout : se = Ze;
                } catch (Z) {
                    se = Ze;
                }
                try {
                    typeof clearTimeout == "function" ? _e = clearTimeout : _e = je;
                } catch (Z) {
                    _e = je;
                }
            })();
            function ct(Z) {
                if (se === setTimeout) return setTimeout(Z, 0);
                if ((se === Ze || !se) && setTimeout) return se = setTimeout, setTimeout(Z, 0);
                try {
                    return se(Z, 0);
                } catch (de) {
                    try {
                        return se.call(null, Z, 0);
                    } catch (Ue) {
                        return se.call(this, Z, 0);
                    }
                }
            }
            function er(Z) {
                if (_e === clearTimeout) return clearTimeout(Z);
                if ((_e === je || !_e) && clearTimeout) return _e = clearTimeout, clearTimeout(Z);
                try {
                    return _e(Z);
                } catch (de) {
                    try {
                        return _e.call(null, Z);
                    } catch (Ue) {
                        return _e.call(this, Z);
                    }
                }
            }
            var Ae = [], Ge = !1, ve, Ke = -1;
            function Ve() {
                !Ge || !ve || (Ge = !1, ve.length ? Ae = ve.concat(Ae) : Ke = -1, Ae.length && pe());
            }
            function pe() {
                if (!Ge) {
                    var Z = ct(Ve);
                    Ge = !0;
                    for(var de = Ae.length; de;){
                        for(ve = Ae, Ae = []; ++Ke < de;)ve && ve[Ke].run();
                        Ke = -1, de = Ae.length;
                    }
                    ve = null, Ge = !1, er(Z);
                }
            }
            Y.nextTick = function(Z) {
                var de = new Array(arguments.length - 1);
                if (arguments.length > 1) for(var Ue = 1; Ue < arguments.length; Ue++)de[Ue - 1] = arguments[Ue];
                Ae.push(new et(Z, de)), Ae.length === 1 && !Ge && ct(pe);
            };
            function et(Z, de) {
                this.fun = Z, this.array = de;
            }
            et.prototype.run = function() {
                this.fun.apply(null, this.array);
            }, Y.title = "browser", Y.browser = !0, Y.env = {}, Y.argv = [], Y.version = "", Y.versions = {};
            function we() {}
            Y.on = we, Y.addListener = we, Y.once = we, Y.off = we, Y.removeListener = we, Y.removeAllListeners = we, Y.emit = we, Y.prependListener = we, Y.prependOnceListener = we, Y.listeners = function(Z) {
                return [];
            }, Y.binding = function(Z) {
    ...
    function Oe(Ne) {
        ...
        return _a[Ne](se, se.exports, Oe), se.exports;
    }
    (()=>{
        Oe.g = function() {
...
` + t.stack) : t;
        ...
        const Y = new Ne;
        function se(e) {
            ct(e) || Y.onUnexpectedError(e);
        }
        function _e(e) {
            ct(e) || Y.onUnexpectedExternalError(e);
        }
        function Ze(e) {
        ...
        const je = "Canceled";
        function ct(e) {
            return e instanceof Error && e.name === je && e.message === je;
        }
        function er() {
            const e = new Error(je);
        ...
        (function(e) {
            ...
            e.first = o;
            function l(v, m) {
                for (const f of v)if (m(f)) return !0;
                return !1;
            }
            e.some = l;
            function u(v, m) {
                for (const f of v)if (m(f)) return f;
            }
            e.find = u;
            function* c(v, m) {
                for (const f of v)m(f) && (yield f);
            }
            e.filter = c;
            function* h(v, m) {
                for (const f of v)yield m(f);
            }
            e.map = h;
            function* d(...v) {
                for (const m of v)for (const f of m)yield f;
            }
            e.concat = d;
            function* p(v) {
                for (const m of v)for (const f of m)yield f;
            ...
            function g(v, m, f) {
                let b = f;
                for (const C of v)b = m(b, C);
                return b;
            }
            e.reduce = g;
            function* _(v, m, f = v.length) {
                for(m < 0 && (m += v.length), f < 0 ? f += v.length : f > v.length && (f = v.length); m < f; m++)yield v[m];
            }
            e.slice = _;
            function k(v, m = Number.POSITIVE_INFINITY) {
                const f = [];
                if (m === 0) return [
                    f,
                    v
            ...
            e.consume = k;
            function U(v, m, f = (b, C)=>b === C) {
                const b = v[Symbol.iterator](), C = m[Symbol.iterator]();
                for(;;){
                    const T = b.next(), E = C.next();
                    if (T.done !== E.done) return !1;
                    if (T.done) return !0;
                    if (!f(T.value, E.value)) return !1;
                }
            }
            e.equals = U;
        })(ve || (ve = {}));
        ...
        function et(e) {
            return Ve && Ve.trackDisposable(e), e;
        }
        ...
        function de(e) {
            if (ve.is(e)) {
                ...
                if (t.length > 1) throw new we(t);
                return Array.isArray(e) ? [] : e;
            } else if (e) return pe(e), e.dispose(), e;
        }
        function Ue(...e) {
            return e.forEach(pe), va(()=>de(e));
        }
        function va(e) {
            const t = et({
                dispose: ()=>{
        ...
        class ht {
            ...
            add(t) {
                ...
                return pe(t), this._isDisposed ? ht.DISABLE_DISPOSED_WARNING || console.warn(new Error("Trying to add a disposable to a DisposableStore that has already been disposed of. The added object will be leaked!").stack) : this._toDispose.add(t), t;
            }
        }
        ht.DISABLE_DISPOSED_WARNING = !1;
        class nn {
            constructor(){
                this._store = new ht, et(this);
            }
            dispose() {
        ...
        nn.None = Object.freeze({
            dispose () {}
        });
        class ll {
            constructor(){
                this._isDisposed = !1, et(this);
            }
            get value() {
            ...
            set value(t) {
                var n;
                this._isDisposed || t === this._value || ((n = this._value) === null || n === void 0 || n.dispose(), t && pe(t), this._value = t);
            }
            clear() {
                this.value = void 0;
            }
            dispose() {
                var t;
                this._isDisposed = !0, pe(this), (t = this._value) === null || t === void 0 || t.dispose(), this._value = void 0;
            }
        }
        class ul {
            constructor(t){
        ...
        var tr = Oe("./node_modules/process/browser.js"), rn;
        const an = "en";
        let dt = !1, ft = !1, Lt = !1, wa = !1, ya = !1, Ta = !1, nr = !1, Dt, sn = null, ka, Ye;
        const on = typeof self == "object" ? self : typeof Oe.g == "object" ? Oe.g : {};
        let K;
        typeof tr != "undefined" ? K = tr : typeof on.vscode != "undefined" && (K = on.vscode.process);
        const rr = typeof ((rn = K == null ? void 0 : K.versions) === null || rn === void 0 ? void 0 : rn.electron) == "string" && K.type === "renderer", Sa = rr && (K == null ? void 0 : K.sandboxed), hl = typeof (()=>{
            if (Sa) return "bypassHeatCheck";
            const e = K == null ? void 0 : K.env.ENABLE_VSCODE_BROWSER_CODE_LOADING;
            if (typeof e == "string") return e === "none" || e === "code" || e === "bypassHeatCheck" || e === "bypassHeatCheckAndEagerCompile" ? e : "bypassHeatCheck";
        })() == "string";
        if (typeof navigator == "object" && !rr) Ye = navigator.userAgent, dt = Ye.indexOf("Windows") >= 0, ft = Ye.indexOf("Macintosh") >= 0, nr = (Ye.indexOf("Macintosh") >= 0 || Ye.indexOf("iPad") >= 0 || Ye.indexOf("iPhone") >= 0) && !!navigator.maxTouchPoints && navigator.maxTouchPoints > 0, Lt = Ye.indexOf("Linux") >= 0, Ta = !0, Dt = navigator.language, sn = Dt;
        else if (typeof K == "object") {
            dt = K.platform === "win32", ft = K.platform === "darwin", Lt = K.platform === "linux", wa = Lt && !!K.env.SNAP && !!K.env.SNAP_REVISION, Dt = an, sn = an;
            const e = K.env.VSCODE_NLS_CONFIG;
            if (e) try {
                const t = JSON.parse(e), n = t.availableLanguages["*"];
                Dt = t.locale, sn = n || an, ka = t._translationsConfigFile;
            } catch (t) {}
            ya = !0;
        } else console.error("Unable to resolve platform.");
        let ln = 0;
        ft ? ln = 1 : dt ? ln = 3 : Lt && (ln = 2);
        const mt = dt, Aa = ft, dl = null, fl = null, ml = null, pl = null, gl = null, re = on, ir = function() {
            if (re.setImmediate) return re.setImmediate.bind(re);
            if (typeof re.postMessage == "function" && !re.importScripts) {
                let n = [];
                re.addEventListener("message", (i)=>{
                    if (i.data && i.data.vscodeSetImmediateId) for(let a = 0, s = n.length; a < s; a++){
                        const o = n[a];
                        if (o.id === i.data.vscodeSetImmediateId) {
                            n.splice(a, 1), o.callback();
                            return;
                        }
                    }
                });
            ...
            if (K && typeof K.nextTick == "function") return K.nextTick.bind(K);
        ...
        function _l() {
            if (!sr) {
                ...
                e[0] = 1, e[1] = 2, ar = new Uint16Array(e.buffer)[0] === 513;
            }
            return ar;
        }
        function vl(e) {
        ...
        function Sl(e) {
            if (or(e)) throw new Error("Assertion Failed: argument is undefined or null");
            return e;
        }
        function Da(e) {
        ...
        function xa(e, t) {
            if (Ca(t)) {
                ...
                if (!or(e) && e.constructor === t || t.length === 1 && t.call(void 0, e) === !0) return;
        ...
        function un(e) {
            const t = [];
            for (const n of Ea(e))typeof e[n] == "function" && t.push(n);
            return t;
        }
        function lr(e, t) {
            const n = (i)=>function() {
        ...
        let cr = !1;
        function Ll(e) {
            !isWeb || (cr || (cr = !0, console.warn("Could not create web worker(s). Falling back to loading web worker code in main thread, which might cause UI freezes. Please see https://github.com/microsoft/monaco-editor#faq")), console.warn(e.message));
        }
        class hr {
            constructor(t){
                this._workerId = -1, this._handler = t, this._lastSentReq = 0, this._pendingReplies = Object.create(null);
            }
            setWorkerId(t) {
                this._workerId = t;
            }
            ...
            _handleMessage(t) {
                if (t.seq) {
                    ...
                    let s = this._pendingReplies[a.seq];
                    if (delete this._pendingReplies[a.seq], a.err) {
                        let o = a.err;
                        a.err.$isError && (o = new Error, o.name = a.err.name, o.message = a.err.message, o.stack = a.err.stack), s.reject(o);
                        return;
                    }
                    s.resolve(a.res);
                    return;
                ...
                this._handler.handleMessage(n.method, n.args).then((a)=>{
                    ...
                    a.detail instanceof Error && (a.detail = Ze(a.detail)), this._send({
                        vsWorker: this._workerId,
                        seq: r,
                        res: void 0,
                        err: Ze(a)
            ...
            _send(t) {
                ...
                if (t.req) {
                    const r = t;
                    for(let i = 0; i < r.args.length; i++)r.args[i] instanceof ArrayBuffer && n.push(r.args[i]);
                } else {
                    const r = t;
        ...
        class Dl extends null {
            constructor(t, n, r){
                super();
                let i = null;
                this._worker = this._register(t.create("vs/base/common/worker/simpleWorker", (l)=>{
                    this._protocol.handleMessage(l);
                }, (l)=>{
                    i && i(l);
                })), this._protocol = new hr({
                    sendMessage: (l, u)=>{
                        this._worker.postMessage(l, u);
                    },
                    handleMessage: (l, u)=>{
                        if (typeof r[l] != "function") return Promise.reject(new Error("Missing method " + l + " on main thread host."));
                        try {
                            return Promise.resolve(r[l].apply(r, u));
                        } catch (c) {
                ...
                let a = null;
                typeof self.require != "undefined" && typeof self.require.getConfig == "function" ? a = self.require.getConfig() : typeof self.requirejs != "undefined" && (a = self.requirejs.s.contexts._.config);
                const s = types.getAllMethodNames(r);
                ...
                const o = (l, u)=>this._request(l, u);
                this._lazyProxy = new Promise((l, u)=>{
                    i = u, this._onModuleLoaded.then((c)=>{
                        l(types.createProxyObject(c, o));
                    }, (c)=>{
                        u(c), this._onError("Worker failed to load " + n, c);
                    });
                });
            }
            getProxyObject() {
            ...
            _request(t, n) {
                return new Promise((r, i)=>{
                    this._onModuleLoaded.then(()=>{
                        this._protocol.sendMessage(t, n).then(r, i);
                    }, i);
                });
            }
            _onError(t, n) {
        ...
        class dr {
            constructor(t, n){
                this._requestHandlerFactory = n, this._requestHandler = null, this._protocol = new hr({
                    sendMessage: (r, i)=>{
                        t(r, i);
                    },
            ...
            _handleMessage(t, n) {
                ...
                if (!this._requestHandler || typeof this._requestHandler[t] != "function") return Promise.reject(new Error("Missing requestHandler or method: " + t));
                try {
            ...
            initialize(t, n, r, i) {
                ...
                const s = lr(i, (o, l)=>this._protocol.sendMessage(o, l));
                return this._requestHandlerFactory ? (this._requestHandler = this._requestHandlerFactory(s), Promise.resolve(un(this._requestHandler))) : (n && (typeof n.baseUrl != "undefined" && delete n.baseUrl, typeof n.paths != "undefined" && typeof n.paths.vs != "undefined" && delete n.paths.vs, n.trustedTypesPolicy, delete n.trustedTypesPolicy, n.catchError = !0, self.require.config(n)), new Promise((o, l)=>{
                    self.require([
                        r
                    ], (u)=>{
                        if (this._requestHandler = u.create(s), !this._requestHandler) {
                            l(new Error("No RequestHandler!"));
                            return;
                        }
                        o(un(this._requestHandler));
                    }, l);
                }));
            }
        }
        ...
        function fr(e, t, n) {
            ...
            let r = t[Math.floor(t.length * Math.random())], i = [], a = [], s = [];
            for (let o of t){
                const l = n(o, r);
                l < 0 ? i.push(o) : l > 0 ? a.push(o) : s.push(o);
            }
            return e < i.length ? fr(e, i, n) : e < i.length + s.length ? s[0] : fr(e - (i.length + s.length), a, n);
        }
        function mr(e, t) {
            return cn(e, t, 0, e.length - 1, []), e;
        }
        function Ma(e, t, n, r, i, a) {
            let s = n, o = r + 1;
            for(let l = n; l <= i; l++)a[l] = e[l];
            for(let l = n; l <= i; l++)s > r ? e[l] = a[o++] : o > i ? e[l] = a[s++] : t(a[o], a[s]) < 0 ? e[l] = a[o++] : e[l] = a[s++];
        }
        function cn(e, t, n, r, i) {
            if (r <= n) return;
            const a = n + (r - n) / 2 | 0;
            cn(e, t, n, a, i), cn(e, t, a + 1, r, i), !(t(e[a], e[a + 1]) <= 0) && Ma(e, t, n, a, r, i);
        }
        function Il(e, t) {
            const n = [];
            let r;
            for (const i of mr(e.slice(0), t))!r || t(r[0], i) !== 0 ? (r = [
                i
            ], n.push(r)) : r.push(i);
            return n;
        }
        ...
        function Fl(e, t) {
            if (!t) return e.filter((r, i)=>e.indexOf(r) === i);
            const n = Object.create(null);
            return e.filter((r)=>{
                const i = t(r);
                return n[i] ? !1 : (n[i] = !0, !0);
            });
        }
        function Pl(e) {
            const t = new Set;
        ...
        const Ra = /{(\d+)}/g;
        function Ql(e, ...t) {
            return t.length === 0 ? e : e.replace(Ra, function(n, r) {
        ...
        function Ia(e, t) {
            ...
            if (n === 0 || r === 0) return e;
            let i = r, a = -1;
            for(; a = e.lastIndexOf(t, i - 1), !(a === -1 || a + n !== i);){
                if (a === 0) return "";
                i = a;
            }
        ...
        function eu(e, t, n = {}) {
            ...
            t || (e = Na(e)), n.wholeWord && (/\B/.test(e.charAt(0)) || (e = "\\b" + e), /\B/.test(e.charAt(e.length - 1)) || (e = e + "\\b"));
            let r = "";
        ...
        function ru(e, t = 0, n = e.length) {
            for(let r = t; r < n; r++){
                ...
                if (i !== 32 && i !== 9) return e.substring(t, r);
            }
            return e.substring(t, n);
        }
        function Wa(e, t = e.length - 1) {
            for(let n = t; n >= 0; n--){
        ...
        function Fa(e, t, n = 0, r = e.length, i = 0, a = t.length) {
            for(; n < r && i < a; n++, i++){
        ...
        function au(e, t) {
            return Pa(e, t, 0, e.length, 0, t.length);
        }
        function Pa(e, t, n = 0, r = e.length, i = 0, a = t.length) {
            for(; n < r && i < a; n++, i++){
                let l = e.charCodeAt(n), u = t.charCodeAt(i);
                if (l === u) continue;
                const c = l - u;
                if (!(c === 32 && dn(u)) && !(c === -32 && dn(l))) return hn(l) && hn(u) ? c : Fa(e.toLowerCase(), t.toLowerCase(), n, r, i, a);
            }
            const s = r - n, o = a - i;
            return s < o ? -1 : s > o ? 1 : 0;
        }
        ...
        function su(e, t) {
            return e.length === t.length && gr(e, t);
        }
        function gr(e, t, n = e.length) {
            for(let r = 0; r < n; r++){
                const i = e.charCodeAt(r), a = t.charCodeAt(r);
                if (i !== a) {
                    if (pr(i) && pr(a)) {
                        const s = Math.abs(i - a);
                        if (s !== 0 && s !== 32) return !1;
                    } else if (String.fromCharCode(i).toLowerCase() !== String.fromCharCode(a).toLowerCase()) return !1;
                }
            }
            return !0;
        }
        function ou(e, t) {
            const n = t.length;
            return t.length > e.length ? !1 : gr(e, t, n);
        }
        function lu(e, t) {
        ...
        function uu(e, t) {
            let n, r = Math.min(e.length, t.length);
            const i = e.length - 1, a = t.length - 1;
            for(n = 0; n < r; n++)if (e.charCodeAt(i - n) !== t.charCodeAt(a - n)) return n;
            return r;
        }
        function fn(e) {
        ...
        function _r(e, t) {
            ...
            if (xt(n) && t > 1) {
                ...
                if (fn(r)) return mn(r, n);
            }
            return n;
        }
        function cu(e, t) {
            const n = xe.getInstance(), r = t, i = e.length, a = br(e, i, t);
            t += a >= 65536 ? 2 : 1;
            let s = n.getGraphemeBreakType(a);
            for(; t < i;){
                const o = br(e, i, t), l = n.getGraphemeBreakType(o);
                if (vr(s, l)) break;
                t += o >= 65536 ? 2 : 1, s = l;
            }
            return t - r;
        ...
        function hu(e, t) {
            const n = xe.getInstance(), r = t, i = _r(e, t);
            t -= i >= 65536 ? 2 : 1;
            let a = n.getGraphemeBreakType(i);
            for(; t > 0;){
                const s = _r(e, t), o = n.getGraphemeBreakType(s);
                if (vr(o, a)) break;
                t -= s >= 65536 ? 2 : 1, a = o;
            }
            return r - t;
        ...
        function du(e) {
            ...
            for(; r < t;){
                const i = e[r];
                let a;
                if (i >= 240 && r + 3 < t ? a = (e[r++] & 7) << 18 >>> 0 | (e[r++] & 63) << 12 >>> 0 | (e[r++] & 63) << 6 >>> 0 | (e[r++] & 63) << 0 >>> 0 : i >= 224 && r + 2 < t ? a = (e[r++] & 15) << 12 >>> 0 | (e[r++] & 63) << 6 >>> 0 | (e[r++] & 63) << 0 >>> 0 : i >= 192 && r + 1 < t ? a = (e[r++] & 31) << 6 >>> 0 | (e[r++] & 63) << 0 >>> 0 : a = e[r++], a >= 0 && a <= 55295 || a >= 57344 && a <= 65535) n.push(String.fromCharCode(a));
                else if (a >= 65536 && a <= 1114111) {
                    const s = a - 65536, o = 55296 + ((s & 1047552) >>> 10), l = 56320 + ((s & 1023) >>> 0);
                    n.push(String.fromCharCode(o)), n.push(String.fromCharCode(l));
                } else n.push(String.fromCharCode(65533));
            }
            return n.join("");
        }
        const Ba = /(?:[\u05BE\u05C0\u05C3\u05C6\u05D0-\u05F4\u0608\u060B\u060D\u061B-\u064A\u066D-\u066F\u0671-\u06D5\u06E5\u06E6\u06EE\u06EF\u06FA-\u0710\u0712-\u072F\u074D-\u07A5\u07B1-\u07EA\u07F4\u07F5\u07FA-\u0815\u081A\u0824\u0828\u0830-\u0858\u085E-\u08BD\u200F\uFB1D\uFB1F-\uFB28\uFB2A-\uFD3D\uFD50-\uFDFC\uFE70-\uFEFC]|\uD802[\uDC00-\uDD1B\uDD20-\uDE00\uDE10-\uDE33\uDE40-\uDEE4\uDEEB-\uDF35\uDF40-\uDFFF]|\uD803[\uDC00-\uDCFF]|\uD83A[\uDC00-\uDCCF\uDD00-\uDD43\uDD50-\uDFFF]|\uD83B[\uDC00-\uDEBB])/;
        function fu(e) {
            return Ba.test(e);
        }
        const qa = /(?:[\u231A\u231B\u23F0\u23F3\u2600-\u27BF\u2B50\u2B55]|\uD83C[\uDDE6-\uDDFF\uDF00-\uDFFF]|\uD83D[\uDC00-\uDE4F\uDE80-\uDEFC\uDFE0-\uDFEB]|\uD83E[\uDD00-\uDDFF\uDE70-\uDED6])/;
        ...
        function bu(e) {
            for(let t = 0, n = e.length; t < n; t++)if (Ga(e.charCodeAt(t))) return !0;
            return !1;
        }
        function Ga(e) {
        ...
        function _u(e) {
            return e >= 127462 && e <= 127487 || e === 8986 || e === 8987 || e === 9200 || e === 9203 || e >= 9728 && e <= 10175 || e === 11088 || e === 11093 || e >= 127744 && e <= 128591 || e >= 128640 && e <= 128764 || e >= 128992 && e <= 129003 || e >= 129280 && e <= 129535 || e >= 129648 && e <= 129750;
        }
        const vu = String.fromCharCode(65279);
        function wu(e) {
        ...
        function Tu(e) {
            const t = 26;
            return e = e % (2 * t), e < t ? String.fromCharCode(97 + e) : String.fromCharCode(65 + e - t);
        }
        function ku(e) {
            return xe.getInstance().getGraphemeBreakType(e);
        }
        function vr(e, t) {
        ...
        function pn(e, t) {
            switch(typeof e){
                case "object":
                    return e === null ? Ee(349, t) : Array.isArray(e) ? $a(e, t) : Qa(e, t);
                case "string":
                    return gn(e, t);
                case "boolean":
                    return Ya(e, t);
        ...
        function $a(e, t) {
            return t = Ee(104579, t), e.reduce((n, r)=>pn(r, n), t);
        }
        function Qa(e, t) {
            return t = Ee(181387, t), Object.keys(e).sort().reduce((n, r)=>(n = gn(r, n), pn(e[r], n)), t);
        }
        function bn(e, t, n = 32) {
            const r = n - t, i = ~((1 << r) - 1);
            return (e << t | (i & e) >>> r) >>> 0;
        }
        function wr(e, t = 0, n = e.byteLength, r = 0) {
        ...
        function pt(e, t = 32) {
            return e instanceof ArrayBuffer ? Array.from(new Uint8Array(e)).map((n)=>n.toString(16).padStart(2, "0")).join("") : Xa((e >>> 0).toString(16), t / 4);
        }
        class _n {
            constructor(){
            ...
            update(t) {
                ...
                if (n === 0) return;
                const r = this._buff;
                let i = this._buffLen, a = this._leftoverHighSurrogate, s, o;
                for(a !== 0 ? (s = a, o = -1, a = 0) : (s = t.charCodeAt(0), o = 0);;){
                    let l = s;
                    if (fn(s)) {
                        if (o + 1 < n) {
                            const u = t.charCodeAt(o + 1);
                            xt(u) ? (o++, l = mn(s, u)) : l = 65533;
                        } else {
                            a = s;
                            break;
                        }
                    } else xt(s) && (l = 65533);
                    if (i = this._push(r, i, l), o++, o < n) s = t.charCodeAt(o);
                    else break;
                }
            ...
            digest() {
                return this._finished || (this._finished = !0, this._leftoverHighSurrogate && (this._leftoverHighSurrogate = 0, this._buffLen = this._push(this._buff, this._buffLen, 65533)), this._totalLen += this._buffLen, this._wrapUp()), pt(this._h0) + pt(this._h1) + pt(this._h2) + pt(this._h3) + pt(this._h4);
            }
            _wrapUp() {
                this._buff[this._buffLen++] = 128, wr(this._buff, this._buffLen), this._buffLen > 56 && (this._step(), wr(this._buff));
            ...
            _step() {
                const t = _n._bigBlock32, n = this._buffDV;
                for(let h = 0; h < 64; h += 4)t.setUint32(h, n.getUint32(h, !1), !1);
                for(let h = 64; h < 320; h += 4)t.setUint32(h, bn(t.getUint32(h - 12, !1) ^ t.getUint32(h - 32, !1) ^ t.getUint32(h - 56, !1) ^ t.getUint32(h - 64, !1), 1), !1);
                let r = this._h0, i = this._h1, a = this._h2, s = this._h3, o = this._h4, l, u, c;
                for(let h = 0; h < 80; h++)h < 20 ? (l = i & a | ~i & s, u = 1518500249) : h < 40 ? (l = i ^ a ^ s, u = 1859775393) : h < 60 ? (l = i & a | i & s | a & s, u = 2400959708) : (l = i ^ a ^ s, u = 3395469782), c = bn(r, 5) + l + o + u + t.getUint32(h * 4, !1) & 4294967295, o = s, s = a, a = bn(i, 30), i = r, r = c;
                this._h0 = this._h0 + r & 4294967295, this._h1 = this._h1 + i & 4294967295, this._h2 = this._h2 + a & 4294967295, this._h3 = this._h3 + s & 4294967295, this._h4 = this._h4 + o & 4294967295;
            }
        }
        _n._bigBlock32 = new DataView(new ArrayBuffer(320));
        class yr {
            constructor(t){
                this.source = t;
            }
        ...
        function Ja(e, t, n) {
            return new rt(new yr(e), new yr(t)).ComputeDiff(n).changes;
        }
        class tt {
            static Assert(t, n) {
        ...
        class rt {
            constructor(t, n, r = null){
                ...
                const [i, a, s] = rt._getElements(t), [o, l, u] = rt._getElements(n);
            ...
            static _getElements(t) {
                ...
                if (rt._isStringArray(n)) {
                    ...
                    for(let i = 0, a = n.length; i < a; i++)r[i] = gn(n[i], 0);
                    return [
                        n,
                        r,
                        !0
            ...
            _ComputeDiff(t, n, r, i, a) {
                ...
                let o = this.ComputeDiffRecursive(t, n, r, i, s);
            ...
            ComputeDiffRecursive(t, n, r, i, a) {
                ...
                if (t > n || r > i) {
                    let h;
                    return r <= i ? (tt.Assert(t === n + 1, "originalStart should only be one more than originalEnd"), h = [
                        new Ie(t, 0, r, i - r + 1)
                    ]) : t <= n ? (tt.Assert(r === i + 1, "modifiedStart should only be one more than modifiedEnd"), h = [
                        new Ie(t, n - t + 1, r, 0)
                    ]) : (tt.Assert(t === n + 1, "originalStart should only be one more than originalEnd"), tt.Assert(r === i + 1, "modifiedStart should only be one more than modifiedEnd"), h = []), h;
                }
                const s = [
                    0
                ], o = [
                    0
                ], l = this.ComputeRecursionPoint(t, n, r, i, s, o, a), u = s[0], c = o[0];
                if (l !== null) return l;
                if (!a[0]) {
                    const h = this.ComputeDiffRecursive(t, u, r, c, a);
                    let d = [];
                    return a[0] ? d = [
                        new Ie(u + 1, n - (u + 1) + 1, c + 1, i - (c + 1) + 1)
                    ] : d = this.ComputeDiffRecursive(u + 1, n, c + 1, i, a), this.ConcatenateChanges(h, d);
                }
                return [
                    new Ie(t, n - t + 1, r, i - r + 1)
                ];
            }
            WALKTRACE(t, n, r, i, a, s, o, l, u, c, h, d, p, g, _, k, U, v) {
                let m = null, f = null, b = new Tr, C = n, T = r, E = p[0] - k[0] - i, I = -1073741824, z = this.m_forwardHistory.length - 1;
                do {
                    const H = E + t;
                    H === C || H < T && u[H - 1] < u[H + 1] ? (h = u[H + 1], g = h - E - i, h < I && b.MarkNextChange(), I = h, b.AddModifiedElement(h + 1, g), E = H + 1 - t) : (h = u[H - 1] + 1, g = h - E - i, h < I && b.MarkNextChange(), I = h - 1, b.AddOriginalElement(h, g + 1), E = H - 1 - t), z >= 0 && (u = this.m_forwardHistory[z], t = u[0], C = 1, T = u.length - 1);
                }while (--z >= -1);
                if (m = b.getReverseChanges(), v[0]) {
                    let H = p[0] + 1, x = k[0] + 1;
                    if (m !== null && m.length > 0) {
                        const W = m[m.length - 1];
                        H = Math.max(H, W.getOriginalEnd()), x = Math.max(x, W.getModifiedEnd());
                    }
                    f = [
                        new Ie(H, d - H + 1, x, _ - x + 1)
                    ];
                } else {
                    b = new Tr, C = s, T = o, E = p[0] - k[0] - l, I = 1073741824, z = U ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2;
                    do {
                        const H = E + a;
                        H === C || H < T && c[H - 1] >= c[H + 1] ? (h = c[H + 1] - 1, g = h - E - l, h > I && b.MarkNextChange(), I = h + 1, b.AddOriginalElement(h + 1, g + 1), E = H + 1 - a) : (h = c[H - 1], g = h - E - l, h > I && b.MarkNextChange(), I = h, b.AddModifiedElement(h + 1, g + 1), E = H - 1 - a), z >= 0 && (c = this.m_reverseHistory[z], a = c[0], C = 1, T = c.length - 1);
                    }while (--z >= -1);
                    f = b.getChanges();
                }
                return this.ConcatenateChanges(m, f);
            }
            ComputeRecursionPoint(t, n, r, i, a, s, o) {
                let l = 0, u = 0, c = 0, h = 0, d = 0, p = 0;
                t--, r--, a[0] = 0, s[0] = 0, this.m_forwardHistory = [], this.m_reverseHistory = [];
                const g = n - t + (i - r), _ = g + 1, k = new Int32Array(_), U = new Int32Array(_), v = i - r, m = n - t, f = t - r, b = n - i, T = (m - v) % 2 == 0;
                k[v] = t, U[m] = n, o[0] = !1;
                for(let E = 1; E <= g / 2 + 1; E++){
                    let I = 0, z = 0;
                    c = this.ClipDiagonalBound(v - E, E, v, _), h = this.ClipDiagonalBound(v + E, E, v, _);
                    for(let x = c; x <= h; x += 2){
                        x === c || x < h && k[x - 1] < k[x + 1] ? l = k[x + 1] : l = k[x - 1] + 1, u = l - (x - v) - f;
                        const W = l;
                        for(; l < n && u < i && this.ElementsAreEqual(l + 1, u + 1);)l++, u++;
                        if (k[x] = l, l + u > I + z && (I = l, z = u), !T && Math.abs(x - m) <= E - 1 && l >= U[x]) return a[0] = l, s[0] = u, W <= U[x] && true && E <= 1448 ? this.WALKTRACE(v, c, h, f, m, d, p, b, k, U, l, n, a, u, i, s, T, o) : null;
                    }
                    const H = (I - t + (z - r) - E) / 2;
                    if (this.ContinueProcessingPredicate !== null && !this.ContinueProcessingPredicate(I, H)) return o[0] = !0, a[0] = I, s[0] = z, H > 0 && true && E <= 1448 ? this.WALKTRACE(v, c, h, f, m, d, p, b, k, U, l, n, a, u, i, s, T, o) : (t++, r++, [
                        new Ie(t, n - t + 1, r, i - r + 1)
                    ]);
                    d = this.ClipDiagonalBound(m - E, E, m, _), p = this.ClipDiagonalBound(m + E, E, m, _);
                    for(let x = d; x <= p; x += 2){
                        x === d || x < p && U[x - 1] >= U[x + 1] ? l = U[x + 1] - 1 : l = U[x - 1], u = l - (x - m) - b;
                        const W = l;
                        for(; l > t && u > r && this.ElementsAreEqual(l, u);)l--, u--;
                        if (U[x] = l, T && Math.abs(x - v) <= E && l <= k[x]) return a[0] = l, s[0] = u, W >= k[x] && true && E <= 1448 ? this.WALKTRACE(v, c, h, f, m, d, p, b, k, U, l, n, a, u, i, s, T, o) : null;
                    }
                    if (E <= 1447) {
                        let x = new Int32Array(h - c + 2);
                        x[0] = v - c + 1, nt.Copy2(k, c, x, 1, h - c + 1), this.m_forwardHistory.push(x), x = new Int32Array(p - d + 2), x[0] = m - d + 1, nt.Copy2(U, d, x, 1, p - d + 1), this.m_reverseHistory.push(x);
                    }
                }
                return this.WALKTRACE(v, c, h, f, m, d, p, b, k, U, l, n, a, u, i, s, T, o);
            }
            PrettifyChanges(t) {
                for(let n = 0; n < t.length; n++){
                    const r = t[n], i = n < t.length - 1 ? t[n + 1].originalStart : this._originalElementsOrHash.length, a = n < t.length - 1 ? t[n + 1].modifiedStart : this._modifiedElementsOrHash.length, s = r.originalLength > 0, o = r.modifiedLength > 0;
                    for(; r.originalStart + r.originalLength < i && r.modifiedStart + r.modifiedLength < a && (!s || this.OriginalElementsAreEqual(r.originalStart, r.originalStart + r.originalLength)) && (!o || this.ModifiedElementsAreEqual(r.modifiedStart, r.modifiedStart + r.modifiedLength));)r.originalStart++, r.modifiedStart++;
                    let l = [
                        null
                    ];
                ...
                for(let n = t.length - 1; n >= 0; n--){
                    ...
                    if (n > 0) {
                        const c = t[n - 1];
                        c.originalLength > 0 && (i = c.originalStart + c.originalLength), c.modifiedLength > 0 && (a = c.modifiedStart + c.modifiedLength);
                    }
                    const s = r.originalLength > 0, o = r.modifiedLength > 0;
                    let l = 0, u = this._boundaryScore(r.originalStart, r.originalLength, r.modifiedStart, r.modifiedLength);
                    for(let c = 1;; c++){
                        const h = r.originalStart - c, d = r.modifiedStart - c;
                        if (h < i || d < a || s && !this.OriginalElementsAreEqual(h, h + r.originalLength) || o && !this.ModifiedElementsAreEqual(d, d + r.modifiedLength)) break;
                        const p = this._boundaryScore(h, r.originalLength, d, r.modifiedLength);
                        p > u && (u = p, l = c);
                    }
                    r.originalStart -= l, r.modifiedStart -= l;
                }
                if (this._hasStrings) for(let n = 1, r = t.length; n < r; n++){
                    const i = t[n - 1], a = t[n], s = a.originalStart - i.originalStart - i.originalLength, o = i.originalStart, l = a.originalStart + a.originalLength, u = l - o, c = i.modifiedStart, h = a.modifiedStart + a.modifiedLength, d = h - c;
                    if (s < 5 && u < 20 && d < 20) {
                        const p = this._findBetterContiguousSequence(o, u, c, d, s);
                        if (p) {
                            const [g, _] = p;
                            (g !== i.originalStart + i.originalLength || _ !== i.modifiedStart + i.modifiedLength) && (i.originalLength = g - i.originalStart, i.modifiedLength = _ - i.modifiedStart, a.originalStart = g + s, a.modifiedStart = _ + s, a.originalLength = l - a.originalStart, a.modifiedLength = h - a.modifiedStart);
                        }
                    }
                }
                return t;
            ...
            _findBetterContiguousSequence(t, n, r, i, a) {
                ...
                const s = t + n - a + 1, o = r + i - a + 1;
                let l = 0, u = 0, c = 0;
                for(let h = t; h < s; h++)for(let d = r; d < o; d++){
                    const p = this._contiguousSequenceScore(h, d, a);
                    p > 0 && p > l && (l = p, u = h, c = d);
                }
                return l > 0 ? [
                    u,
            ...
            _boundaryScore(t, n, r, i) {
                const a = this._OriginalRegionIsBoundary(t, n) ? 1 : 0, s = this._ModifiedRegionIsBoundary(r, i) ? 1 : 0;
                return a + s;
            }
            ConcatenateChanges(t, n) {
                ...
                if (this.ChangesOverlap(t[t.length - 1], n[0], r)) {
                    ...
                    return nt.Copy(t, 0, i, 0, t.length - 1), i[t.length - 1] = r[0], nt.Copy(n, 1, i, t.length, n.length - 1), i;
                } else {
                    const i = new Array(t.length + n.length);
                    return nt.Copy(t, 0, i, 0, t.length), nt.Copy(n, 0, i, t.length, n.length), i;
                }
            }
            ChangesOverlap(t, n, r) {
                if (tt.Assert(t.originalStart <= n.originalStart, "Left change is not less than or equal to right change"), tt.Assert(t.modifiedStart <= n.modifiedStart, "Left change is not less than or equal to right change"), t.originalStart + t.originalLength >= n.originalStart || t.modifiedStart + t.modifiedLength >= n.modifiedStart) {
                    const i = t.originalStart;
                    let a = t.originalLength;
                    const s = t.modifiedStart;
                    let o = t.modifiedLength;
                    return t.originalStart + t.originalLength >= n.originalStart && (a = n.originalStart + n.originalLength - t.originalStart), t.modifiedStart + t.modifiedLength >= n.modifiedStart && (o = n.modifiedStart + n.modifiedLength - t.modifiedStart), r[0] = new Ie(i, a, s, o), !0;
                } else return r[0] = null, !1;
            }
            ClipDiagonalBound(t, n, r, i) {
                if (t >= 0 && t < i) return t;
                const a = r, s = i - r - 1, o = n % 2 == 0;
                if (t < 0) {
                    const l = a % 2 == 0;
                    return o === l ? 0 : 1;
                } else {
        ...
        var kr = Oe("./node_modules/process/browser.js");
        let it;
        typeof kr != "undefined" ? it = kr : typeof re.vscode != "undefined" ? it = {
            get platform () {
                return re.vscode.process.platform;
            },
            get env () {
                return re.vscode.process.env;
            },
            nextTick (e) {
                return ir(e);
            },
            cwd () {
                return re.vscode.process.env.VSCODE_CWD || re.vscode.process.execPath.substr(0, re.vscode.process.execPath.lastIndexOf(re.vscode.process.platform === "win32" ? "\\" : "/"));
            }
        } : it = {
            get platform () {
                return mt ? "win32" : Aa ? "darwin" : "linux";
            },
            nextTick (e) {
                return ir(e);
            },
        ...
        const vn = it.cwd, Za = it.env, $e = it.platform, Ka = 65, es = 97, ts = 90, ns = 122, He = 46, ie = 47, ue = 92, ze = 58, rs = 63;
        class Sr extends Error {
            constructor(t, n, r){
                let i;
                typeof n == "string" && n.indexOf("not ") === 0 ? (i = "must not be", n = n.replace(/^not /, "")) : i = "must be";
                const a = t.indexOf(".") !== -1 ? "property" : "argument";
                let s = `The "${t}" ${a} ${i} of type ${n}`;
        ...
        function ee(e, t) {
            if (typeof e != "string") throw new Sr(t, "string", e);
        }
        function q(e) {
            return e === ie || e === ue;
        }
        ...
        function Et(e, t, n, r) {
            ...
            for(let u = 0; u <= e.length; ++u){
                ...
                if (r(l)) {
                    if (!(s === u - 1 || o === 1)) {
                        if (o === 2) {
                            if (i.length < 2 || a !== 2 || i.charCodeAt(i.length - 1) !== He || i.charCodeAt(i.length - 2) !== He) {
                                if (i.length > 2) {
        ...
        function Ar(e, t) {
            if (t === null || typeof t != "object") throw new Sr("pathObject", "Object", t);
        ...
        const le = {
            resolve (...e) {
                ...
                for(let i = e.length - 1; i >= -1; i--){
                    let a;
                    if (i >= 0) {
                        if (a = e[i], ee(a, "path"), a.length === 0) continue;
                    } else t.length === 0 ? a = vn() : (a = Za[`=${t}`] || vn(), (a === void 0 || a.slice(0, 2).toLowerCase() !== t.toLowerCase() && a.charCodeAt(2) === ue) && (a = `${t}\\`));
                    const s = a.length;
                    let o = 0, l = "", u = !1;
                    const c = a.charCodeAt(0);
                    if (s === 1) q(c) && (o = 1, u = !0);
                    else if (q(c)) {
                        if (u = !0, q(a.charCodeAt(1))) {
                            let h = 2, d = h;
                            for(; h < s && !q(a.charCodeAt(h));)h++;
                            if (h < s && h !== d) {
                                const p = a.slice(d, h);
                                for(d = h; h < s && q(a.charCodeAt(h));)h++;
                                if (h < s && h !== d) {
                                    for(d = h; h < s && !q(a.charCodeAt(h));)h++;
                                    (h === s || h !== d) && (l = `\\\\${p}\\${a.slice(d, h)}`, o = h);
                                }
                            }
                        } else o = 1;
                    } else We(c) && a.charCodeAt(1) === ze && (l = a.slice(0, 2), o = 2, s > 2 && q(a.charCodeAt(2)) && (u = !0, o = 3));
                    if (l.length > 0) {
                        if (t.length > 0) {
            ...
            normalize (e) {
                ...
                if (t === 1) return wn(a) ? "\\" : e;
                if (q(a)) {
                    if (i = !0, q(e.charCodeAt(1))) {
                        let o = 2, l = o;
                        for(; o < t && !q(e.charCodeAt(o));)o++;
                        if (o < t && o !== l) {
                            const u = e.slice(l, o);
                            for(l = o; o < t && q(e.charCodeAt(o));)o++;
                            if (o < t && o !== l) {
                                for(l = o; o < t && !q(e.charCodeAt(o));)o++;
                ...
                } else We(a) && e.charCodeAt(1) === ze && (r = e.slice(0, 2), n = 2, t > 2 && q(e.charCodeAt(2)) && (i = !0, n = 3));
                let s = n < t ? Et(e.slice(n), !i, "\\", q) : "";
                return s.length === 0 && !i && (s = "."), s.length > 0 && q(e.charCodeAt(t - 1)) && (s += "\\"), r === void 0 ? i ? `\\${s}` : s : i ? `${r}\\${s}` : `${r}${s}`;
            },
            isAbsolute (e) {
                ee(e, "path");
                const t = e.length;
                ...
                return q(n) || t > 2 && We(n) && e.charCodeAt(1) === ze && q(e.charCodeAt(2));
            },
            join (...e) {
                ...
                for(let a = 0; a < e.length; ++a){
                    const s = e[a];
                    ee(s, "path"), s.length > 0 && (t === void 0 ? t = n = s : t += `\\${s}`);
                }
                if (t === void 0) return ".";
                let r = !0, i = 0;
                if (typeof n == "string" && q(n.charCodeAt(0))) {
                    ++i;
                    const a = n.length;
                    a > 1 && q(n.charCodeAt(1)) && (++i, a > 2 && (q(n.charCodeAt(2)) ? ++i : r = !1));
                }
                if (r) {
                    for(; i < t.length && q(t.charCodeAt(i));)i++;
                    i >= 2 && (t = `\\${t.slice(i)}`);
                }
            ...
            relative (e, t) {
                ...
                let i = 0;
                for(; i < e.length && e.charCodeAt(i) === ue;)i++;
                let a = e.length;
                for(; a - 1 > i && e.charCodeAt(a - 1) === ue;)a--;
                const s = a - i;
                let o = 0;
                for(; o < t.length && t.charCodeAt(o) === ue;)o++;
                let l = t.length;
                for(; l - 1 > o && t.charCodeAt(l - 1) === ue;)l--;
                ...
                if (d !== c) {
                    ...
                    if (u > c) {
                        if (t.charCodeAt(o + d) === ue) return r.slice(o + d + 1);
                        if (d === 2) return r.slice(o + d);
                    }
                    s > c && (e.charCodeAt(i + d) === ue ? h = d : d === 2 && (h = 3)), h === -1 && (h = 0);
                }
                let p = "";
                for(d = i + h + 1; d <= a; ++d)(d === a || e.charCodeAt(d) === ue) && (p += p.length === 0 ? ".." : "\\..");
                return o += h, p.length > 0 ? `${p}${r.slice(o, l)}` : (r.charCodeAt(o) === ue && ++o, r.slice(o, l));
            },
            toNamespacedPath (e) {
                ...
                if (t.charCodeAt(0) === ue) {
                    if (t.charCodeAt(1) === ue) {
                        ...
                        if (n !== rs && n !== He) return `\\\\?\\UNC\\${t.slice(2)}`;
                    }
                } else if (We(t.charCodeAt(0)) && t.charCodeAt(1) === ze && t.charCodeAt(2) === ue) return `\\\\?\\${t}`;
                return e;
            },
            dirname (e) {
                ee(e, "path");
                ...
                } else We(i) && e.charCodeAt(1) === ze && (n = t > 2 && q(e.charCodeAt(2)) ? 3 : 2, r = n);
                let a = -1, s = !0;
                for(let o = t - 1; o >= r; --o)if (q(e.charCodeAt(o))) {
                    if (!s) {
                        a = o;
                        break;
                    }
            ...
            basename (e, t) {
                ...
                let n = 0, r = -1, i = !0, a;
                if (e.length >= 2 && We(e.charCodeAt(0)) && e.charCodeAt(1) === ze && (n = 2), t !== void 0 && t.length > 0 && t.length <= e.length) {
                    if (t === e) return "";
            ...
            extname (e) {
                ...
                e.length >= 2 && e.charCodeAt(1) === ze && We(e.charCodeAt(0)) && (t = r = 2);
                for(let o = e.length - 1; o >= t; --o){
                    ...
                    i === -1 && (a = !1, i = o + 1), l === He ? n === -1 ? n = o : s !== 1 && (s = 1) : n !== -1 && (s = -1);
                }
            ...
            parse (e) {
                ...
                if (n === 1) return q(i) ? (t.root = t.dir = e, t) : (t.base = t.name = e, t);
                if (q(i)) {
                    if (r = 1, q(e.charCodeAt(1))) {
                        let h = 2, d = h;
                        for(; h < n && !q(e.charCodeAt(h));)h++;
                        if (h < n && h !== d) {
                            for(d = h; h < n && q(e.charCodeAt(h));)h++;
                            if (h < n && h !== d) {
                                for(d = h; h < n && !q(e.charCodeAt(h));)h++;
                                h === n ? r = h : h !== d && (r = h + 1);
                            }
                ...
                } else if (We(i) && e.charCodeAt(1) === ze) {
                ...
                for(; u >= r; --u){
                    ...
                    o === -1 && (l = !1, o = u + 1), i === He ? a === -1 ? a = u : c !== 1 && (c = 1) : a !== -1 && (c = -1);
                }
            ...
            resolve (...e) {
                ...
                for(let r = e.length - 1; r >= -1 && !n; r--){
                    const i = r >= 0 ? e[r] : vn();
                    ee(i, "path"), i.length !== 0 && (t = `${i}/${t}`, n = i.charCodeAt(0) === ie);
                }
                return t = Et(t, !n, "/", wn), n ? `/${t}` : t.length > 0 ? t : ".";
            },
            normalize (e) {
                if (ee(e, "path"), e.length === 0) return ".";
                const t = e.charCodeAt(0) === ie, n = e.charCodeAt(e.length - 1) === ie;
                return e = Et(e, !t, "/", wn), e.length === 0 ? t ? "/" : n ? "./" : "." : (n && (e += "/"), t ? `/${e}` : e);
            },
            isAbsolute (e) {
                return ee(e, "path"), e.length > 0 && e.charCodeAt(0) === ie;
            },
            join (...e) {
                if (e.length === 0) return ".";
                let t;
                for(let n = 0; n < e.length; ++n){
                    const r = e[n];
                    ee(r, "path"), r.length > 0 && (t === void 0 ? t = r : t += `/${r}`);
                }
                return t === void 0 ? "." : ce.normalize(t);
            },
            relative (e, t) {
                if (ee(e, "from"), ee(t, "to"), e === t || (e = ce.resolve(e), t = ce.resolve(t), e === t)) return "";
                const n = 1, r = e.length, i = r - n, a = 1, s = t.length - a, o = i < s ? i : s;
                let l = -1, u = 0;
                for(; u < o; u++){
                    const h = e.charCodeAt(n + u);
                    if (h !== t.charCodeAt(a + u)) break;
                    h === ie && (l = u);
                }
                if (u === o) {
                    if (s > o) {
                        if (t.charCodeAt(a + u) === ie) return t.slice(a + u + 1);
                        if (u === 0) return t.slice(a + u);
                    } else i > o && (e.charCodeAt(n + u) === ie ? l = u : u === 0 && (l = 0));
                }
                let c = "";
                for(u = n + l + 1; u <= r; ++u)(u === r || e.charCodeAt(u) === ie) && (c += c.length === 0 ? ".." : "/..");
            ...
            dirname (e) {
                if (ee(e, "path"), e.length === 0) return ".";
                const t = e.charCodeAt(0) === ie;
                let n = -1, r = !0;
                for(let i = e.length - 1; i >= 1; --i)if (e.charCodeAt(i) === ie) {
                    if (!r) {
                        n = i;
                        break;
                    }
            ...
            basename (e, t) {
                ...
                for(a = e.length - 1; a >= 0; --a)if (e.charCodeAt(a) === ie) {
                    if (!i) {
                        n = a + 1;
                        break;
                    }
            ...
            extname (e) {
                ...
                for(let s = e.length - 1; s >= 0; --s){
                    ...
                    r === -1 && (i = !1, r = s + 1), o === He ? t === -1 ? t = s : a !== 1 && (a = 1) : t !== -1 && (a = -1);
                }
            ...
            parse (e) {
                ...
                for(; l >= r; --l){
                    ...
                    s === -1 && (o = !1, s = l + 1), c === He ? i === -1 ? i = l : u !== 1 && (u = 1) : i !== -1 && (u = -1);
                }
                if (s !== -1) {
                    const c = a === 0 && n ? 1 : a;
        ...
        ce.win32 = le.win32 = le, ce.posix = le.posix = ce;
        const Au = $e === "win32" ? le.normalize : ce.normalize, Cu = $e === "win32" ? le.resolve : ce.resolve, Lu = $e === "win32" ? le.relative : ce.relative, Du = $e === "win32" ? le.dirname : ce.dirname, xu = $e === "win32" ? le.basename : ce.basename, Eu = $e === "win32" ? le.extname : ce.extname, Mu = $e === "win32" ? le.sep : ce.sep, is = /^\w[\w\d+.-]*$/, as = /^\//, ss = /^\/\//;
        function os(e, t) {
            ...
            if (e.scheme && !is.test(e.scheme)) throw new Error("[UriError]: Scheme contains illegal characters.");
            if (e.path) {
                if (e.authority) {
                    if (!as.test(e.path)) throw new Error('[UriError]: If a URI contains an authority component, then the path component must either be empty or begin with a slash ("/") character');
                } else if (ss.test(e.path)) throw new Error('[UriError]: If a URI does not contain an authority component, then the path cannot begin with two slash characters ("//")');
            }
        }
        function ls(e, t) {
            return !e && !t ? "file" : e;
        ...
        class Qe {
            constructor(t, n, r, i, a, s = !1){
                typeof t == "object" ? (this.scheme = t.scheme || $, this.authority = t.authority || $, this.path = t.path || $, this.query = t.query || $, this.fragment = t.fragment || $) : (this.scheme = ls(t, s), this.authority = n || $, this.path = us(this.scheme, r || $), this.query = i || $, this.fragment = a || $, os(this, s));
            }
            static isUri(t) {
                return t instanceof Qe ? !0 : t ? typeof t.authority == "string" && typeof t.fragment == "string" && typeof t.path == "string" && typeof t.query == "string" && typeof t.scheme == "string" && typeof t.fsPath == "string" && typeof t.with == "function" && typeof t.toString == "function" : !1;
            }
            get fsPath() {
                return yn(this, !1);
            }
            with(t) {
                ...
                return n === void 0 ? n = this.scheme : n === null && (n = $), r === void 0 ? r = this.authority : r === null && (r = $), i === void 0 ? i = this.path : i === null && (i = $), a === void 0 ? a = this.query : a === null && (a = $), s === void 0 ? s = this.fragment : s === null && (s = $), n === this.scheme && r === this.authority && i === this.path && a === this.query && s === this.fragment ? this : new at(n, r, i, a, s);
            }
            static parse(t, n = !1) {
                const r = cs.exec(t);
                return r ? new at(r[2] || $, Mt(r[4] || $), Mt(r[5] || $), Mt(r[7] || $), Mt(r[9] || $), n) : new at($, $, $, $, $);
            }
            static file(t) {
                let n = $;
                if (mt && (t = t.replace(/\\/g, ye)), t[0] === ye && t[1] === ye) {
                    const r = t.indexOf(ye, 2);
                    r === -1 ? (n = t.substring(2), t = ye) : (n = t.substring(2, r), t = t.substring(r) || ye);
                }
                return new at("file", n, t, $, $);
            }
            static from(t) {
                return new at(t.scheme, t.authority, t.path, t.query, t.fragment);
            }
            static joinPath(t, ...n) {
                if (!t.path) throw new Error("[UriError]: cannot call joinPath on URI without path");
                let r;
                return mt && t.scheme === "file" ? r = Qe.file(le.join(yn(t, !0), ...n)).path : r = ce.join(t.path, ...n), t.with({
                    path: r
                });
            }
            toString(t = !1) {
            ...
            static revive(t) {
                if (t) {
                    ...
                    {
                        const n = new at(t);
                        return n._formatted = t.external, n._fsPath = t._sep === Cr ? t.fsPath : null, n;
                    }
                } else return t;
            }
        }
        const Cr = mt ? 1 : void 0;
        class at extends Qe {
            constructor(){
                super(...arguments);
            ...
            toString(t = !1) {
                return t ? Tn(this, !0) : (this._formatted || (this._formatted = Tn(this, !1)), this._formatted);
            }
            toJSON() {
                const t = {
                    $mid: 1
                };
                return this._fsPath && (t.fsPath = this._fsPath, t._sep = Cr), this._formatted && (t.external = this._formatted), this.path && (t.path = this.path), this.scheme && (t.scheme = this.scheme), this.authority && (t.authority = this.authority), this.query && (t.query = this.query), this.fragment && (t.fragment = this.fragment), t;
            }
        }
        const Lr = {
            [58]: "%3A",
        ...
        function Dr(e, t) {
            ...
            for(let i = 0; i < e.length; i++){
                ...
                if (a >= 97 && a <= 122 || a >= 65 && a <= 90 || a >= 48 && a <= 57 || a === 45 || a === 46 || a === 95 || a === 126 || t && a === 47) r !== -1 && (n += encodeURIComponent(e.substring(r, i)), r = -1), n !== void 0 && (n += e.charAt(i));
                else {
                    n === void 0 && (n = e.substr(0, i));
                    const s = Lr[a];
                    s !== void 0 ? (r !== -1 && (n += encodeURIComponent(e.substring(r, i)), r = -1), n += s) : r === -1 && (r = i);
                }
            }
        ...
        function hs(e) {
            ...
            for(let n = 0; n < e.length; n++){
                const r = e.charCodeAt(n);
                r === 35 || r === 63 ? (t === void 0 && (t = e.substr(0, n)), t += Lr[r]) : t !== void 0 && (t += e[n]);
            }
            return t !== void 0 ? t : e;
        }
        function yn(e, t) {
        ...
        function Tn(e, t) {
            const n = t ? hs : Dr;
            let r = "", { scheme: i, authority: a, path: s, query: o, fragment: l } = e;
            if (i && (r += i, r += ":"), (a || i === "file") && (r += ye, r += ye), a) {
                let u = a.indexOf("@");
                if (u !== -1) {
                    const c = a.substr(0, u);
                    a = a.substr(u + 1), u = c.indexOf(":"), u === -1 ? r += n(c, !1) : (r += n(c.substr(0, u), !1), r += ":", r += n(c.substr(u + 1), !1)), r += "@";
                }
                a = a.toLowerCase(), u = a.indexOf(":"), u === -1 ? r += n(a, !1) : (r += n(a.substr(0, u), !1), r += a.substr(u));
            }
            if (s) {
            ...
            return o && (r += "?", r += n(o, !1)), l && (r += "#", r += t ? l : Dr(l, !1)), r;
        }
        function xr(e) {
            try {
        ...
        const Er = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
        function Mt(e) {
            return e.match(Er) ? e.replace(Er, (t)=>xr(t)) : e;
        }
        class fe {
            constructor(t, n){
        ...
        class J {
            ...
            static intersectRanges(t, n) {
                ...
                return r < o ? (r = o, i = l) : r === o && (i = Math.max(i, l)), a > u ? (a = u, s = c) : a === u && (s = Math.min(s, c)), r > a || r === a && i > s ? null : new J(r, i, a, s);
            }
            equalsRange(t) {
            ...
            static getEndPosition(t) {
                return new fe(t.endLineNumber, t.endColumn);
            }
            getStartPosition() {
                return J.getStartPosition(this);
            }
            static getStartPosition(t) {
                return new fe(t.startLineNumber, t.startColumn);
            }
            toString() {
        ...
        class Rr {
            constructor(t){
                const n = [], r = [];
                for(let i = 0, a = t.length; i < a; i++)n[i] = kn(t[i], 1), r[i] = Sn(t[i], 1);
                this.lines = t, this._startColumns = n, this._endColumns = r;
            }
            getElements() {
                const t = [];
                for(let n = 0, r = this.lines.length; n < r; n++)t[n] = this.lines[n].substring(this._startColumns[n] - 1, this._endColumns[n] - 1);
                return t;
            }
            ...
            createCharSequence(t, n, r) {
                ...
                for(let l = n; l <= r; l++){
                    ...
                    for(let d = c; d < h; d++)i[o] = u.charCodeAt(d - 1), a[o] = l + 1, s[o] = d, o++;
                }
                return new fs(i, a, s);
            }
        }
        ...
        class gt {
            ...
            static createFromDiffChange(t, n, r) {
                let i, a, s, o, l, u, c, h;
                return t.originalLength === 0 ? (i = 0, a = 0, s = 0, o = 0) : (i = n.getStartLineNumber(t.originalStart), a = n.getStartColumn(t.originalStart), s = n.getEndLineNumber(t.originalStart + t.originalLength - 1), o = n.getEndColumn(t.originalStart + t.originalLength - 1)), t.modifiedLength === 0 ? (l = 0, u = 0, c = 0, h = 0) : (l = r.getStartLineNumber(t.modifiedStart), u = r.getStartColumn(t.modifiedStart), c = r.getEndLineNumber(t.modifiedStart + t.modifiedLength - 1), h = r.getEndColumn(t.modifiedStart + t.modifiedLength - 1)), new gt(i, a, s, o, l, u, c, h);
            }
        }
        function ms(e) {
            ...
            for(let r = 1, i = e.length; r < i; r++){
                const a = e[r], s = a.originalStart - (n.originalStart + n.originalLength), o = a.modifiedStart - (n.modifiedStart + n.modifiedLength);
                Math.min(s, o) < ds ? (n.originalLength = a.originalStart + a.originalLength - n.originalStart, n.modifiedLength = a.modifiedStart + a.modifiedLength - n.modifiedStart) : (t.push(a), n = a);
            }
            return t;
        }
        class bt {
            ...
            static createFromDiffResult(t, n, r, i, a, s, o) {
                ...
                if (n.originalLength === 0 ? (l = r.getStartLineNumber(n.originalStart) - 1, u = 0) : (l = r.getStartLineNumber(n.originalStart), u = r.getEndLineNumber(n.originalStart + n.originalLength - 1)), n.modifiedLength === 0 ? (c = i.getStartLineNumber(n.modifiedStart) - 1, h = 0) : (c = i.getStartLineNumber(n.modifiedStart), h = i.getEndLineNumber(n.modifiedStart + n.modifiedLength - 1)), s && n.originalLength > 0 && n.originalLength < 20 && n.modifiedLength > 0 && n.modifiedLength < 20 && a()) {
                    ...
                    let _ = Mr(p, g, a, !0).changes;
                    o && (_ = ms(_)), d = [];
                    for(let k = 0, U = _.length; k < U; k++)d.push(gt.createFromDiffChange(_[k], p, g));
                }
                return new bt(l, u, c, h, d);
            }
        }
        class ps {
            constructor(t, n, r){
                this.shouldComputeCharChanges = r.shouldComputeCharChanges, this.shouldPostProcessCharChanges = r.shouldPostProcessCharChanges, this.shouldIgnoreTrimWhitespace = r.shouldIgnoreTrimWhitespace, this.shouldMakePrettyDiff = r.shouldMakePrettyDiff, this.originalLines = t, this.modifiedLines = n, this.original = new Rr(t), this.modified = new Rr(n), this.continueLineDiff = Nr(r.maxComputationTime), this.continueCharDiff = Nr(r.maxComputationTime === 0 ? 0 : Math.min(r.maxComputationTime, 5e3));
            }
            computeDiff() {
                ...
                const t = Mr(this.original, this.modified, this.continueLineDiff, this.shouldMakePrettyDiff), n = t.changes, r = t.quitEarly;
                if (this.shouldIgnoreTrimWhitespace) {
                    const o = [];
                    for(let l = 0, u = n.length; l < u; l++)o.push(bt.createFromDiffResult(this.shouldIgnoreTrimWhitespace, n[l], this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges));
                    return {
                        quitEarly: r,
                        changes: o
                    };
                ...
                for(let o = -1, l = n.length; o < l; o++){
                    const u = o + 1 < l ? n[o + 1] : null, c = u ? u.originalStart : this.originalLines.length, h = u ? u.modifiedStart : this.modifiedLines.length;
                    for(; a < c && s < h;){
                        const d = this.originalLines[a], p = this.modifiedLines[s];
                        if (d !== p) {
                            {
                                let g = kn(d, 1), _ = kn(p, 1);
                                for(; g > 1 && _ > 1;){
                                    const k = d.charCodeAt(g - 2), U = p.charCodeAt(_ - 2);
                                    if (k !== U) break;
                                    g--, _--;
                                }
                                (g > 1 || _ > 1) && this._pushTrimWhitespaceCharChange(i, a + 1, 1, g, s + 1, 1, _);
                            }
                            {
                                let g = Sn(d, 1), _ = Sn(p, 1);
                                const k = d.length + 1, U = p.length + 1;
                                for(; g < k && _ < U;){
                                    const v = d.charCodeAt(g - 1), m = d.charCodeAt(_ - 1);
                                    if (v !== m) break;
                                    g++, _++;
                                }
                                (g < k || _ < U) && this._pushTrimWhitespaceCharChange(i, a + 1, g, k, s + 1, _, U);
                            }
                        }
                        a++, s++;
                    }
                    u && (i.push(bt.createFromDiffResult(this.shouldIgnoreTrimWhitespace, u, this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges)), a += u.originalLength, s += u.modifiedLength);
                }
                return {
                    quitEarly: r,
                    changes: i
            ...
            _pushTrimWhitespaceCharChange(t, n, r, i, a, s, o) {
                if (this._mergeTrimWhitespaceCharChange(t, n, r, i, a, s, o)) return;
                let l;
                this.shouldComputeCharChanges && (l = [
                    new gt(n, r, n, i, a, s, a, o)
                ]), t.push(new bt(n, n, a, a, l));
            }
            _mergeTrimWhitespaceCharChange(t, n, r, i, a, s, o) {
                const l = t.length;
                if (l === 0) return !1;
                const u = t[l - 1];
                return u.originalEndLineNumber === 0 || u.modifiedEndLineNumber === 0 ? !1 : u.originalEndLineNumber + 1 === n && u.modifiedEndLineNumber + 1 === a ? (u.originalEndLineNumber = n, u.modifiedEndLineNumber = a, this.shouldComputeCharChanges && u.charChanges && u.charChanges.push(new gt(n, r, n, i, a, s, a, o)), !0) : !1;
            }
        }
        function kn(e, t) {
            const n = za(e);
        ...
        class bs {
            ...
            getIndexOf(t) {
                ...
                let n = 0, r = this.values.length - 1, i = 0, a = 0, s = 0;
                for(; n <= r;)if (i = n + (r - n) / 2 | 0, a = this.prefixSum[i], s = a - this.values[i], t < s) r = i - 1;
                else if (t >= a) n = i + 1;
                else break;
                return new gs(i, t - s);
            }
        ...
        class _s {
            ...
            onEvents(t) {
                ...
                const n = t.changes;
                for (const r of n)this._acceptDeleteRange(r.range), this._acceptInsertText(new fe(r.range.startLineNumber, r.range.startColumn), r.text);
            ...
            _ensureLineStarts() {
                if (!this._lineStarts) {
                    ...
                    this._lineStarts = new bs(r);
                }
            }
            _setLineText(t, n) {
                this._lines[t] = n, this._lineStarts && this._lineStarts.changeValue(t, this._lines[t].length + this._eol.length);
            }
            ...
            _acceptInsertText(t, n) {
                ...
                for(let a = 1; a < r.length; a++)this._lines.splice(t.lineNumber + a - 1, 0, r[a]), i[a - 1] = r[a].length + this._eol.length;
        ...
        function ws(e = "") {
            let t = "(-?\\d*\\.\\d\\w*)|([^";
            for (const n of vs)e.indexOf(n) >= 0 || (t += "\\" + n);
        ...
        function Ir(e, t, n, r, i = ks) {
            if (n.length > i.maxLen) {
                let u = e - i.maxLen / 2;
                return u < 0 ? u = 0 : r += u, n = n.substring(u, e + i.maxLen / 2), Ir(e, t, n, r, i);
            }
            const a = Date.now(), s = e - 1 - r;
            let o = -1, l = null;
            for(let u = 1; !(Date.now() - a >= i.timeBudget); u++){
                const c = s - i.windowSize * u;
        ...
        class Rt {
            constructor(t){
                let n = Ur(t);
                this._defaultValue = n, this._asciiMap = Rt._createAsciiMap(n), this._map = new Map;
            }
        ...
        function Ds() {
            if (_t === null) {
                _t = new Rt(0);
                const e = ` 	<>'"\u3001\u3002\uFF61\uFF64\uFF0C\uFF0E\uFF1A\uFF1B\u2018\u201C\u3008\u300A\u300C\u300E\u3010\u3014\uFF08\uFF3B\uFF5B\uFF62\uFF63\uFF5D\uFF3D\uFF09\u3015\u3011\u300F\u300D\u300B\u3009\u201D\u2019\uFF40\uFF5E\u2026`;
                for(let n = 0; n < e.length; n++)_t.set(e.charCodeAt(n), 1);
                const t = ".,;";
                for(let n = 0; n < t.length; n++)_t.set(t.charCodeAt(n), 2);
            }
            return _t;
        }
        class Nt {
            static _createLink(t, n, r, i, a) {
                ...
                if (i > 0) {
                    const o = n.charCodeAt(i - 1), l = n.charCodeAt(s);
                ...
                return {
                    ...
                    url: n.substring(i, s + 1)
                };
            }
            static computeLinks(t, n = Ls()) {
                const r = Ds();
                let i = [];
                for(let a = 1, s = t.getLineCount(); a <= s; a++){
                    const o = t.getLineContent(a), l = o.length;
                    let u = 0, c = 0, h = 0, d = 1, p = !1, g = !1, _ = !1, k = !1;
                    for(; u < l;){
                        let U = !1;
                        ...
                        if (d === 13) {
                            ...
                            m === 1 && (i.push(Nt._createLink(r, o, a, c, u)), U = !0);
                        } else if (d === 12) {
                            let m;
                            v === 91 ? (g = !0, m = 0) : m = r.get(v), m === 1 ? U = !0 : d = 13;
                        } else d = n.nextState(d, v), d === 0 && (U = !0);
                        U && (d = 1, p = !1, g = !1, k = !1, c = u + 1, h = v), u++;
                    }
                    d === 13 && i.push(Nt._createLink(r, o, a, c, l));
                }
                return i;
            }
        }
        function xs(e) {
            return !e || typeof e.getLineCount != "function" || typeof e.getLineContent != "function" ? [] : Nt.computeLinks(e);
        }
        class Cn {
            constructor(){
        ...
        class Hr {
            ...
            _insert(t, n) {
                const r = new Q(t);
                if (this._first === Q.Undefined) this._first = r, this._last = r;
                else if (n) {
                    const a = this._last;
            ...
            _remove(t) {
                ...
                } else t.prev === Q.Undefined && t.next === Q.Undefined ? (this._first = Q.Undefined, this._last = Q.Undefined) : t.next === Q.Undefined ? (this._last = this._last.prev, this._last.next = Q.Undefined) : t.prev === Q.Undefined && (this._first = this._first.next, this._first.prev = Q.Undefined);
                this._size -= 1;
            }
            *[Symbol.iterator]() {
                let t = this._first;
        ...
        const Es = re.performance && typeof re.performance.now == "function";
        class Ut {
            constructor(t){
                this._highResolution = Es && t, this._startTime = this._now(), this._stopTime = -1;
            }
            static create(t = !0) {
                return new Ut(t);
            }
        ...
        (function(e) {
            ...
            function t(m) {
                return (f, b = null, C)=>{
                    let T = !1, E;
                    return E = m((I)=>{
                        if (!T) return E ? E.dispose() : T = !0, f.call(b, I);
                    }, null, C), T && E.dispose(), E;
                };
            }
            e.once = t;
            function n(m, f) {
                return l((b, C = null, T)=>m((E)=>b.call(C, f(E)), null, T));
            }
            e.map = n;
            function r(m, f) {
                return l((b, C = null, T)=>m((E)=>{
                        f(E), b.call(C, E);
                    }, null, T));
            }
            e.forEach = r;
            function i(m, f) {
                return l((b, C = null, T)=>m((E)=>f(E) && b.call(C, E), null, T));
            }
            e.filter = i;
            function a(m) {
                return m;
            ...
            e.signal = a;
            function s(...m) {
                return (f, b = null, C)=>Ue(...m.map((T)=>T((E)=>f.call(b, E), null, C)));
            }
            e.any = s;
            function o(m, f, b) {
                let C = b;
                return n(m, (T)=>(C = f(C, T), C));
            }
            e.reduce = o;
            function l(m) {
                let f;
            ...
            e.snapshot = l;
            function u(m, f, b = 100, C = !1, T) {
                let E, I, z, H = 0;
                const x = new ge({
                    leakWarningThreshold: T,
                    onFirstListenerAdd () {
                        E = m((W)=>{
                            H++, I = f(I, W), C && !z && (x.fire(I), I = void 0), clearTimeout(z), z = setTimeout(()=>{
                                const B = I;
                                I = void 0, z = void 0, (!C || H > 1) && x.fire(B), H = 0;
                            }, b);
                        });
                    },
                    onLastListenerRemove () {
            ...
            function c(m) {
                ...
                return n(t(m), (b)=>new Date().getTime() - f);
            }
            e.stopwatch = c;
            function h(m) {
                let f = !0, b;
            ...
            class p {
                ...
                forEach(f) {
                    return new p(r(this.event, f));
                }
                filter(f) {
                    return new p(i(this.event, f));
                }
                reduce(f, b) {
                    return new p(o(this.event, f, b));
                }
                latch() {
                    return new p(h(this.event));
                }
                debounce(f, b = 100, C = !1, T) {
                    return new p(u(this.event, f, b, C, T));
                }
                on(f, b, C) {
                    return this.event(f, b, C);
                }
                once(f, b, C) {
                    return t(this.event)(f, b, C);
                }
            }
            function g(m) {
                return new p(m);
            ...
            e.chain = g;
            function _(m, f, b = (C)=>C) {
                const C = (...z)=>I.fire(b(...z)), T = ()=>m.on(f, C), E = ()=>m.removeListener(f, C), I = new ge({
                    onFirstListenerAdd: T,
                    onLastListenerRemove: E
                });
                return I.event;
            }
            e.fromNodeEventEmitter = _;
            function k(m, f, b = (C)=>C) {
                const C = (...z)=>I.fire(b(...z)), T = ()=>m.addEventListener(f, C), E = ()=>m.removeEventListener(f, C), I = new ge({
                    onFirstListenerAdd: T,
                    onLastListenerRemove: E
                });
                return I.event;
            ...
            function U(m) {
                const f = new ge;
                let b = !1;
                return m.then(void 0, ()=>null).then(()=>{
                    b ? f.fire(void 0) : setTimeout(()=>f.fire(void 0), 0);
                }), b = !0, f.event;
            }
            e.fromPromise = U;
            function v(m) {
                return new Promise((f)=>t(m)(f));
            }
            e.toPromise = v;
        })(It || (It = {}));
        class Ht {
            constructor(t){
                this._listenerCount = 0, this._invocationCount = 0, this._elapsedOverall = 0, this._name = `${t}_${Ht._idPool++}`;
            }
            start(t) {
                this._stopWatch = new Ut(!0), this._listenerCount = t;
            }
            stop() {
                if (this._stopWatch) {
        ...
        class Ms {
            constructor(t, n = Math.random().toString(18).slice(2, 5)){
                this.customThreshold = t, this.name = n, this._warnCountdown = 0;
            }
            dispose() {
            ...
            check(t) {
                let n = zr;
                if (typeof this.customThreshold == "number" && (n = this.customThreshold), n <= 0 || t < n) return;
...
`), i = this._stacks.get(r) || 0;
                if (this._stacks.set(r, i + 1), this._warnCountdown -= 1, this._warnCountdown <= 0) {
                    ...
                    let a, s = 0;
                    for (const [o, l] of this._stacks)(!a || s < l) && (a = o, s = l);
                    console.warn(`[${this.name}] potential listener LEAK detected, having ${t} listeners already. MOST frequent listener (${s}):`), console.warn(a);
                }
                return ()=>{
                    const a = this._stacks.get(r) || 0;
                    this._stacks.set(r, a - 1);
                };
            }
        }
        class ge {
            constructor(t){
                var n;
                this._disposed = !1, this._options = t, this._leakageMon = zr > 0 ? new Ms(this._options && this._options.leakWarningThreshold) : void 0, this._perfMon = ((n = this._options) === null || n === void 0 ? void 0 : n._profName) ? new Ht(this._options._profName) : void 0;
            }
            get event() {
                return this._event || (this._event = (t, n, r)=>{
                    var i;
                    this._listeners || (this._listeners = new Hr);
                    const a = this._listeners.isEmpty();
                    a && this._options && this._options.onFirstListenerAdd && this._options.onFirstListenerAdd(this);
                    const s = this._listeners.push(n ? [
                        t,
                        n
                    ] : t);
                    a && this._options && this._options.onFirstListenerDidAdd && this._options.onFirstListenerDidAdd(this), this._options && this._options.onListenerDidAdd && this._options.onListenerDidAdd(this, t, n);
                    const o = (i = this._leakageMon) === null || i === void 0 ? void 0 : i.check(this._listeners.size);
                    let l;
                    return l = {
                        dispose: ()=>{
                            o && o(), l.dispose = ge._noop, this._disposed || (s(), this._options && this._options.onLastListenerRemove && (this._listeners && !this._listeners.isEmpty() || this._options.onLastListenerRemove(this)));
                        }
                    }, r instanceof ht ? r.add(l) : Array.isArray(r) && r.push(l), l;
                }), this._event;
            }
            fire(t) {
                var n, r;
                if (this._listeners) {
                    ...
                    for (let i of this._listeners)this._deliveryQueue.push([
                        i,
                        t
                    ]);
            ...
            dispose() {
                var t, n, r;
                (t = this._listeners) === null || t === void 0 || t.clear(), (n = this._deliveryQueue) === null || n === void 0 || n.clear(), (r = this._leakageMon) === null || r === void 0 || r.dispose(), this._disposed = !0;
            }
        }
        ge._noop = function() {};
        class Nu extends null {
            constructor(t){
                super(t);
                this._isPaused = 0, this._eventQueue = new LinkedList, this._mergeFn = t == null ? void 0 : t.merge;
            }
            pause() {
                this._isPaused++;
            }
        ...
        class Uu {
            ...
            wrapEvent(t) {
                return (n, r, i)=>t((a)=>{
                        ...
                        s ? s.push(()=>n.call(r, a)) : n.call(r, a);
                    }, void 0, i);
            }
            bufferEvents(t) {
                const n = [];
                this.buffers.push(n);
                const r = t();
                return this.buffers.pop(), n.forEach((i)=>i()), r;
            }
        }
        class Iu {
            constructor(){
                this.listening = !1, this.inputEvent = It.None, this.inputEventListener = Disposable.None, this.emitter = new ge({
                    onFirstListenerDidAdd: ()=>{
        ...
        class Wt {
            ...
            get onCancellationRequested() {
                return this._isCancelled ? Wr : (this._emitter || (this._emitter = new ge), this._emitter.event);
            }
            dispose() {
        ...
        class Rs {
            ...
            cancel() {
                this._token ? this._token instanceof Wt && this._token.cancel() : this._token = zt.Cancelled;
            }
            dispose(t = !1) {
                t && this.cancel(), this._parentListener && this._parentListener.dispose(), this._token ? this._token instanceof Wt && this._token.dispose() : this._token = zt.None;
            }
        }
        class Ln {
            constructor(){
        ...
        const Dn = new Ln, xn = new Ln, En = new Ln;
        (function() {
            function e(t, n, r = n, i = r) {
                Dn.define(t, n), xn.define(t, r), En.define(t, i);
            }
        ...
        (function(e) {
            function t(s) {
                return Dn.keyCodeToStr(s);
            }
            e.toString = t;
            function n(s) {
                return Dn.strToKeyCode(s);
            }
            e.fromString = n;
            function r(s) {
                return xn.keyCodeToStr(s);
            }
            e.toUserSettingsUS = r;
            function i(s) {
                return En.keyCodeToStr(s);
            }
            e.toUserSettingsGeneral = i;
            function a(s) {
                return xn.strToKeyCode(s) || En.strToKeyCode(s);
            }
        ...
        function Hu(e, t) {
            if (e === 0) return null;
            const n = (e & 65535) >>> 0, r = (e & 4294901760) >>> 16;
            return r !== 0 ? new Rn([
                Mn(n, t),
                Mn(r, t)
            ]) : new Rn([
        ...
        function Mn(e, t) {
            const n = !!(e & 2048), r = !!(e & 256), i = t === 2 ? r : n, a = !!(e & 1024), s = !!(e & 512), o = t === 2 ? n : r, l = e & 255;
            return new Us(i, a, s, o, l);
        }
        class Us {
            constructor(t, n, r, i, a){
                this.ctrlKey = t, this.shiftKey = n, this.altKey = r, this.metaKey = i, this.keyCode = a;
            }
            equals(t) {
                return this.ctrlKey === t.ctrlKey && this.shiftKey === t.shiftKey && this.altKey === t.altKey && this.metaKey === t.metaKey && this.keyCode === t.keyCode;
            }
            isModifierKey() {
        ...
        class Rn {
            constructor(t){
                if (t.length === 0) throw illegalArgument("parts");
                this.parts = t;
            }
        }
        class zu {
            constructor(t, n, r, i, a, s){
                this.ctrlKey = t, this.shiftKey = n, this.altKey = r, this.metaKey = i, this.keyLabel = a, this.keyAriaLabel = s;
            }
        }
        class Wu {
        }
        class Te extends J {
            constructor(t, n, r, i){
                super(t, n, r, i);
                this.selectionStartLineNumber = t, this.selectionStartColumn = n, this.positionLineNumber = r, this.positionColumn = i;
            }
            toString() {
            ...
            static liftSelection(t) {
                return new Te(t.selectionStartLineNumber, t.selectionStartColumn, t.positionLineNumber, t.positionColumn);
            }
            ...
            static createWithDirection(t, n, r, i, a) {
                return a === 0 ? new Te(t, n, r, i) : new Te(r, i, t, n);
            }
        }
        class Is {
            constructor(t, n, r){
                this.offset = t | 0, this.type = n, this.language = r;
            }
            toString() {
        ...
        class zs extends _s {
            ...
            getWordAtPosition(t, n) {
                let r = Ir(t.column, Ts(n), this._lines[t.lineNumber - 1], 0);
                ...
                return {
                    *[Symbol.iterator] () {
                        for(;;)if (s < o.length) {
                            ...
                            s += 1, yield l;
                        } else if (i < n.length) a = n[i], o = r(a, t), s = 0, i += 1;
                        else break;
                    }
                };
            }
            getLineWords(t, n) {
                let r = this._lines[t - 1], i = this._wordenize(r, n), a = [];
                for (const s of i)a.push({
            ...
            _wordenize(t, n) {
                const r = [];
                let i;
                for(n.lastIndex = 0; (i = n.exec(t)) && i[0].length !== 0;)r.push({
                    start: i.index,
            ...
            getValueInRange(t) {
                if (t = this._validateRange(t), t.startLineNumber === t.endLineNumber) return this._lines[t.startLineNumber - 1].substring(t.startColumn - 1, t.endColumn - 1);
                let n = this._eol, r = t.startLineNumber - 1, i = t.endLineNumber - 1, a = [];
                a.push(this._lines[r].substring(t.startColumn - 1));
                for(let s = r + 1; s < i; s++)a.push(this._lines[s]);
                return a.push(this._lines[i].substring(0, t.endColumn - 1)), a.join(n);
            }
            offsetAt(t) {
                return t = this._validatePosition(t), this._ensureLineStarts(), this._lineStarts.getAccumulatedValue(t.lineNumber - 2) + (t.column - 1);
            }
            positionAt(t) {
                t = Math.floor(t), t = Math.max(0, t), this._ensureLineStarts();
                let n = this._lineStarts.getIndexOf(t), r = this._lines[n.index].length;
                return {
            ...
            _validatePosition(t) {
                if (!fe.isIPosition(t)) throw new Error("bad position");
        ...
        class Xe {
            constructor(t, n){
                this._host = t, this._models = Object.create(null), this._foreignModuleFactory = n, this._foreignModule = null;
            }
            dispose() {
            ...
            acceptNewModel(t) {
                this._models[t.url] = new zs(Qe.parse(t.url), t.lines, t.EOL, t.versionId);
            }
            ...
            computeDiff(t, n, r, i) {
                return ot(this, void 0, void 0, function*() {
                    ...
                    if (!a || !s) return null;
                    const o = a.getLinesContent(), l = s.getLinesContent(), c = new ps(o, l, {
                        shouldComputeCharChanges: !0,
                        shouldPostProcessCharChanges: !0,
                        shouldIgnoreTrimWhitespace: r,
                        shouldMakePrettyDiff: !0,
                        maxComputationTime: i
                    }).computeDiff(), h = c.changes.length > 0 ? !1 : this._modelsAreIdentical(a, s);
                    return {
            ...
            computeMoreMinimalEdits(t, n) {
                return ot(this, void 0, void 0, function*() {
                    ...
                    let a;
                    n = mr(n, (s, o)=>{
                        if (s.range && o.range) return J.compareRangesUsingStarts(s.range, o.range);
                        let l = s.range ? 0 : 1, u = o.range ? 0 : 1;
                        return l - u;
                    });
                    for (let { range: s, text: o, eol: l } of n){
                        if (typeof l == "number" && (a = l), J.isEmpty(s) && !o) continue;
                        const u = r.getValueInRange(s);
                        if (o = o.replace(/\r\n|\n|\r/g, r.eol), u === o) continue;
                        if (Math.max(o.length, u.length) > Xe._diffLimit) {
                            i.push({
                                range: s,
                                text: o
                            });
                        ...
                        const c = Ja(u, o, !1), h = r.offsetAt(J.lift(s).getStartPosition());
                        for (const d of c){
                            const p = r.positionAt(h + d.originalStart), g = r.positionAt(h + d.originalStart + d.originalLength), _ = {
                            ...
                            r.getValueInRange(_.range) !== _.text && i.push(_);
                        }
                    }
            ...
            textualSuggest(t, n, r, i) {
                return ot(this, void 0, void 0, function*() {
                    const a = new Ut(!0), s = new RegExp(r, i), o = new Set;
                    e: for (let l of t){
                        const u = this._getModel(l);
                        if (!!u) {
                            for (let c of u.words(s))if (!(c === n || !isNaN(Number(c))) && (o.add(c), o.size > Xe._suggestionsLimit)) break e;
                        }
                    }
                    return {
                        words: Array.from(o),
            ...
            computeWordRanges(t, n, r, i) {
                return ot(this, void 0, void 0, function*() {
                    ...
                    const s = new RegExp(r, i), o = Object.create(null);
            ...
            navigateValueSet(t, n, r, i, a) {
                return ot(this, void 0, void 0, function*() {
                    ...
                    let l = s.getValueInRange(n), u = s.getWordAtPosition({
                        lineNumber: n.startLineNumber,
                        column: n.startColumn
                    }, o);
                    if (!u) return null;
                    let c = s.getValueInRange(u);
                    return Cn.INSTANCE.navigateValueSet(n, l, u, c, r);
                });
            }
            loadForeignModule(t, n, r) {
                let s = {
                    host: lr(r, (o, l)=>this._host.fhr(o, l)),
                    getMirrorModels: ()=>this._getModels()
                };
                return this._foreignModuleFactory ? (this._foreignModule = this._foreignModuleFactory(s, n), Promise.resolve(un(this._foreignModule))) : Promise.reject(new Error("Unexpected usage"));
            }
            fmr(t, n) {
        ...
        typeof importScripts == "function" && (re.monaco = Hs());
        let zn = !1;
        function gi(e) {
            if (zn) return;
            zn = !0;
        ...
        (function(e) {
            function t(r, i) {
                return r === Number.MAX_VALUE && (r = Pt.MAX_VALUE), i === Number.MAX_VALUE && (i = Pt.MAX_VALUE), {
                    line: r,
                    character: i
                };
            }
            ...
            function n(r) {
                var i = r;
                return w.objectLiteral(i) && w.uinteger(i.line) && w.uinteger(i.character);
            }
            e.is = n;
        })(ae || (ae = {}));
        var V;
        (function(e) {
            function t(r, i, a, s) {
                if (w.uinteger(r) && w.uinteger(i) && w.uinteger(a) && w.uinteger(s)) return {
                    start: ae.create(r, i),
                    end: ae.create(a, s)
                };
                if (ae.is(r) && ae.is(i)) return {
                    start: r,
                    end: i
                };
            ...
            function n(r) {
                var i = r;
                return w.objectLiteral(i) && ae.is(i.start) && ae.is(i.end);
            }
            e.is = n;
        })(V || (V = {}));
        var Bt;
        (function(e) {
            ...
            function n(r) {
                var i = r;
                return w.defined(i) && V.is(i.range) && (w.string(i.uri) || w.undefined(i.uri));
            }
            e.is = n;
        })(Bt || (Bt = {}));
        var _i;
        (function(e) {
            ...
            function n(r) {
                var i = r;
                return w.defined(i) && V.is(i.targetRange) && w.string(i.targetUri) && (V.is(i.targetSelectionRange) || w.undefined(i.targetSelectionRange)) && (V.is(i.originSelectionRange) || w.undefined(i.originSelectionRange));
            }
            e.is = n;
        })(_i || (_i = {}));
        var Wn;
        (function(e) {
            ...
            function n(r) {
                var i = r;
                return w.numberRange(i.red, 0, 1) && w.numberRange(i.green, 0, 1) && w.numberRange(i.blue, 0, 1) && w.numberRange(i.alpha, 0, 1);
            }
            e.is = n;
        })(Wn || (Wn = {}));
        var vi;
        (function(e) {
            ...
            function n(r) {
                var i = r;
                return V.is(i.range) && Wn.is(i.color);
            }
            e.is = n;
        })(vi || (vi = {}));
        var wi;
        (function(e) {
            ...
            function n(r) {
                var i = r;
                return w.string(i.label) && (w.undefined(i.textEdit) || ne.is(i)) && (w.undefined(i.additionalTextEdits) || w.typedArray(i.additionalTextEdits, ne.is));
            }
            e.is = n;
        })(wi || (wi = {}));
        var qt;
        ...
        var yi;
        (function(e) {
            function t(r, i, a, s, o) {
                var l = {
                    startLine: r,
                    endLine: i
                };
                return w.defined(a) && (l.startCharacter = a), w.defined(s) && (l.endCharacter = s), w.defined(o) && (l.kind = o), l;
            }
            e.create = t;
            function n(r) {
                var i = r;
                return w.uinteger(i.startLine) && w.uinteger(i.startLine) && (w.undefined(i.startCharacter) || w.uinteger(i.startCharacter)) && (w.undefined(i.endCharacter) || w.uinteger(i.endCharacter)) && (w.undefined(i.kind) || w.string(i.kind));
            }
            e.is = n;
        })(yi || (yi = {}));
        var Fn;
        (function(e) {
            ...
            function n(r) {
                var i = r;
                return w.defined(i) && Bt.is(i.location) && w.string(i.message);
            }
            e.is = n;
        })(Fn || (Fn = {}));
        var Ti;
        ...
        (function(e) {
            function t(r, i, a, s, o, l) {
                ...
                return w.defined(a) && (u.severity = a), w.defined(s) && (u.code = s), w.defined(o) && (u.source = o), w.defined(l) && (u.relatedInformation = l), u;
            }
            e.create = t;
            function n(r) {
                var i, a = r;
                return w.defined(a) && V.is(a.range) && w.string(a.message) && (w.number(a.severity) || w.undefined(a.severity)) && (w.integer(a.code) || w.string(a.code) || w.undefined(a.code)) && (w.undefined(a.codeDescription) || w.string((i = a.codeDescription) === null || i === void 0 ? void 0 : i.href)) && (w.string(a.source) || w.undefined(a.source)) && (w.undefined(a.relatedInformation) || w.typedArray(a.relatedInformation, Fn.is));
            }
            e.is = n;
        })(Ot || (Ot = {}));
        var wt;
        (function(e) {
            function t(r, i) {
                ...
                return w.defined(a) && a.length > 0 && (o.arguments = a), o;
            }
            e.create = t;
            function n(r) {
                var i = r;
                return w.defined(i) && w.string(i.title) && w.string(i.command);
            }
            e.is = n;
        })(wt || (wt = {}));
        var ne;
        (function(e) {
            ...
            function i(a) {
                var s = a;
                return w.objectLiteral(s) && w.string(s.newText) && V.is(s.range);
            }
            e.is = i;
        })(ne || (ne = {}));
        var lt;
        (function(e) {
            ...
            function n(r) {
                var i = r;
                return i !== void 0 && w.objectLiteral(i) && w.string(i.label) && (w.boolean(i.needsConfirmation) || i.needsConfirmation === void 0) && (w.string(i.description) || i.description === void 0);
            }
            e.is = n;
        })(lt || (lt = {}));
        var oe;
        ...
        (function(e) {
            ...
            function i(a) {
                var s = a;
                return ne.is(s) && (lt.is(s.annotationId) || oe.is(s.annotationId));
            }
            e.is = i;
        })(Fe || (Fe = {}));
        var jt;
        (function(e) {
            ...
            function n(r) {
                var i = r;
                return w.defined(i) && Vt.is(i.textDocument) && Array.isArray(i.edits);
            }
            e.is = n;
        })(jt || (jt = {}));
        var yt;
        (function(e) {
            ...
            function n(r) {
                var i = r;
                return i && i.kind === "create" && w.string(i.uri) && (i.options === void 0 || (i.options.overwrite === void 0 || w.boolean(i.options.overwrite)) && (i.options.ignoreIfExists === void 0 || w.boolean(i.options.ignoreIfExists))) && (i.annotationId === void 0 || oe.is(i.annotationId));
            }
            e.is = n;
        })(yt || (yt = {}));
        var Tt;
        (function(e) {
            ...
            function n(r) {
                var i = r;
                return i && i.kind === "rename" && w.string(i.oldUri) && w.string(i.newUri) && (i.options === void 0 || (i.options.overwrite === void 0 || w.boolean(i.options.overwrite)) && (i.options.ignoreIfExists === void 0 || w.boolean(i.options.ignoreIfExists))) && (i.annotationId === void 0 || oe.is(i.annotationId));
            }
            e.is = n;
        })(Tt || (Tt = {}));
        var kt;
        (function(e) {
            ...
            function n(r) {
                var i = r;
                return i && i.kind === "delete" && w.string(i.uri) && (i.options === void 0 || (i.options.recursive === void 0 || w.boolean(i.options.recursive)) && (i.options.ignoreIfNotExists === void 0 || w.boolean(i.options.ignoreIfNotExists))) && (i.annotationId === void 0 || oe.is(i.annotationId));
            }
            e.is = n;
        })(kt || (kt = {}));
        var Pn;
        (function(e) {
            function t(n) {
                ...
                return r && (r.changes !== void 0 || r.documentChanges !== void 0) && (r.documentChanges === void 0 || r.documentChanges.every(function(i) {
                    return w.string(i.kind) ? yt.is(i) || Tt.is(i) || kt.is(i) : jt.is(i);
                }));
            }
            e.is = t;
        })(Pn || (Pn = {}));
        var Gt = function() {
            ...
            return e.prototype.insert = function(t, n, r) {
                var i, a;
                if (r === void 0 ? i = ne.insert(t, n) : oe.is(r) ? (a = r, i = Fe.insert(t, n, r)) : (this.assertChangeAnnotations(this.changeAnnotations), a = this.changeAnnotations.manage(r), i = Fe.insert(t, n, a)), this.edits.push(i), a !== void 0) return a;
            }, e.prototype.replace = function(t, n, r) {
                var i, a;
                if (r === void 0 ? i = ne.replace(t, n) : oe.is(r) ? (a = r, i = Fe.replace(t, n, r)) : (this.assertChangeAnnotations(this.changeAnnotations), a = this.changeAnnotations.manage(r), i = Fe.replace(t, n, a)), this.edits.push(i), a !== void 0) return a;
            }, e.prototype.delete = function(t, n) {
                var r, i;
                if (n === void 0 ? r = ne.del(t) : oe.is(n) ? (i = n, r = Fe.del(t, n)) : (this.assertChangeAnnotations(this.changeAnnotations), i = this.changeAnnotations.manage(n), r = Fe.del(t, i)), this.edits.push(r), i !== void 0) return i;
            ...
            return e.prototype.all = function() {
                ...
                var r;
                if (oe.is(t) ? r = t : (r = this.nextId(), n = t), this._annotations[r] !== void 0) throw new Error("Id " + r + " is already in use.");
            ...
            function e(t) {
                var n = this;
                this._textEditChanges = Object.create(null), t !== void 0 ? (this._workspaceEdit = t, t.documentChanges ? (this._changeAnnotations = new Ai(t.changeAnnotations), t.changeAnnotations = this._changeAnnotations.all(), t.documentChanges.forEach(function(r) {
                    if (jt.is(r)) {
                        var i = new Gt(r.edits, n._changeAnnotations);
                        n._textEditChanges[r.textDocument.uri] = i;
                    }
                })) : t.changes && Object.keys(t.changes).forEach(function(r) {
                    var i = new Gt(t.changes[r]);
            ...
            return Object.defineProperty(e.prototype, "edit", {
                ...
                if (Vt.is(t)) {
                    ...
                    if (!r) {
                        ...
                        this._workspaceEdit.documentChanges.push(a), r = new Gt(i, this._changeAnnotations), this._textEditChanges[n.uri] = r;
                    }
                    return r;
                } else {
                    ...
                    if (!r) {
                        var i = [];
                        this._workspaceEdit.changes[t] = i, r = new Gt(i), this._textEditChanges[t] = r;
                    }
                    return r;
                }
            }, e.prototype.initDocumentChanges = function() {
                this._workspaceEdit.documentChanges === void 0 && this._workspaceEdit.changes === void 0 && (this._changeAnnotations = new Ai, this._workspaceEdit.documentChanges = [], this._workspaceEdit.changeAnnotations = this._changeAnnotations.all());
                ...
                if (this.initDocumentChanges(), this._workspaceEdit.documentChanges === void 0) throw new Error("Workspace edit is not configured for document changes.");
                var i;
                lt.is(n) || oe.is(n) ? i = n : r = n;
                var a, s;
                if (i === void 0 ? a = yt.create(t, r) : (s = oe.is(i) ? i : this._changeAnnotations.manage(i), a = yt.create(t, r, s)), this._workspaceEdit.documentChanges.push(a), s !== void 0) return s;
            }, e.prototype.renameFile = function(t, n, r, i) {
                if (this.initDocumentChanges(), this._workspaceEdit.documentChanges === void 0) throw new Error("Workspace edit is not configured for document changes.");
                var a;
                lt.is(r) || oe.is(r) ? a = r : i = r;
                var s, o;
                if (a === void 0 ? s = Tt.create(t, n, i) : (o = oe.is(a) ? a : this._changeAnnotations.manage(a), s = Tt.create(t, n, i, o)), this._workspaceEdit.documentChanges.push(s), o !== void 0) return o;
            }, e.prototype.deleteFile = function(t, n, r) {
                if (this.initDocumentChanges(), this._workspaceEdit.documentChanges === void 0) throw new Error("Workspace edit is not configured for document changes.");
                var i;
                lt.is(n) || oe.is(n) ? i = n : r = n;
                var a, s;
                if (i === void 0 ? a = kt.create(t, r) : (s = oe.is(i) ? i : this._changeAnnotations.manage(i), a = kt.create(t, r, s)), this._workspaceEdit.documentChanges.push(a), s !== void 0) return s;
            }, e;
        }(), Ci;
        (function(e) {
            function t(r) {
            ...
            function n(r) {
                var i = r;
                return w.defined(i) && w.string(i.uri);
            }
            e.is = n;
        })(Ci || (Ci = {}));
        var Li;
        (function(e) {
            ...
            function n(r) {
                var i = r;
                return w.defined(i) && w.string(i.uri) && w.integer(i.version);
            }
            e.is = n;
        })(Li || (Li = {}));
        var Vt;
        (function(e) {
            ...
            function n(r) {
                var i = r;
                return w.defined(i) && w.string(i.uri) && (i.version === null || w.integer(i.version));
            }
            e.is = n;
        })(Vt || (Vt = {}));
        var Di;
        (function(e) {
            ...
            function n(r) {
                var i = r;
                return w.defined(i) && w.string(i.uri) && w.string(i.languageId) && w.integer(i.version) && w.string(i.text);
            }
            e.is = n;
        })(Di || (Di = {}));
        var ke;
        ...
        (function(e) {
            function t(n) {
                var r = n;
                return w.objectLiteral(n) && ke.is(r.kind) && w.string(r.value);
            }
            e.is = t;
        })(Bn || (Bn = {}));
        var he;
        ...
        (function(e) {
            ...
            function n(r) {
                var i = r;
                return i && w.string(i.newText) && V.is(i.insert) && V.is(i.replace);
            }
            e.is = n;
        })(Ei || (Ei = {}));
        var Mi;
        ...
        (function(e) {
            ...
            function n(r) {
                var i = r;
                return w.string(i) || w.objectLiteral(i) && w.string(i.language) && w.string(i.value);
            }
            e.is = n;
        })(Yt || (Yt = {}));
        var Ui;
        (function(e) {
            function t(n) {
                var r = n;
                return !!r && w.objectLiteral(r) && (Bn.is(r.contents) || Yt.is(r.contents) || w.typedArray(r.contents, Yt.is)) && (n.range === void 0 || V.is(n.range));
            }
            e.is = t;
        })(Ui || (Ui = {}));
        var Ii;
        ...
        (function(e) {
            function t(n, r) {
                ...
                return w.defined(r) && (s.documentation = r), w.defined(i) ? s.parameters = i : s.parameters = [], s;
            }
            e.create = t;
        })(Hi || (Hi = {}));
        var $t;
        ...
        (function(e) {
            ...
            function n(r) {
                var i = r;
                return i && w.string(i.name) && w.number(i.kind) && V.is(i.range) && V.is(i.selectionRange) && (i.detail === void 0 || w.string(i.detail)) && (i.deprecated === void 0 || w.boolean(i.deprecated)) && (i.children === void 0 || Array.isArray(i.children)) && (i.tags === void 0 || Array.isArray(i.tags));
            }
            e.is = n;
        })(Pi || (Pi = {}));
        var Bi;
        ...
        (function(e) {
            function t(r, i) {
                ...
                return i != null && (a.only = i), a;
            }
            e.create = t;
            function n(r) {
                var i = r;
                return w.defined(i) && w.typedArray(i.diagnostics, Ot.is) && (i.only === void 0 || w.typedArray(i.only, w.string));
            }
            e.is = n;
        })(qi || (qi = {}));
        var Oi;
        (function(e) {
            function t(r, i, a) {
                ...
                return typeof i == "string" ? (o = !1, s.kind = i) : wt.is(i) ? s.command = i : s.edit = i, o && a !== void 0 && (s.kind = a), s;
            }
            e.create = t;
            function n(r) {
                var i = r;
                return i && w.string(i.title) && (i.diagnostics === void 0 || w.typedArray(i.diagnostics, Ot.is)) && (i.kind === void 0 || w.string(i.kind)) && (i.edit !== void 0 || i.command !== void 0) && (i.command === void 0 || wt.is(i.command)) && (i.isPreferred === void 0 || w.boolean(i.isPreferred)) && (i.edit === void 0 || Pn.is(i.edit));
            }
            e.is = n;
        })(Oi || (Oi = {}));
        var ji;
        (function(e) {
            function t(r, i) {
                ...
                return w.defined(i) && (a.data = i), a;
            }
            e.create = t;
            function n(r) {
                var i = r;
                return w.defined(i) && V.is(i.range) && (w.undefined(i.command) || wt.is(i.command));
            }
            e.is = n;
        })(ji || (ji = {}));
        var Gi;
        (function(e) {
            ...
            function n(r) {
                var i = r;
                return w.defined(i) && w.uinteger(i.tabSize) && w.boolean(i.insertSpaces);
            }
            e.is = n;
        })(Gi || (Gi = {}));
        var Vi;
        (function(e) {
            ...
            function n(r) {
                var i = r;
                return w.defined(i) && V.is(i.range) && (w.undefined(i.target) || w.string(i.target));
            }
            e.is = n;
        })(Vi || (Vi = {}));
        var Qt;
        (function(e) {
            ...
            function n(r) {
                var i = r;
                return i !== void 0 && V.is(i.range) && (i.parent === void 0 || e.is(i.parent));
            }
            e.is = n;
        })(Qt || (Qt = {}));
        var ju = null, Yi;
        (function(e) {
            function t(a, s, o, l) {
                return new Ps(a, s, o, l);
            }
            e.create = t;
            function n(a) {
                var s = a;
                return !!(w.defined(s) && w.string(s.uri) && (w.undefined(s.languageId) || w.string(s.languageId)) && w.uinteger(s.lineCount) && w.func(s.getText) && w.func(s.positionAt) && w.func(s.offsetAt));
            }
            e.is = n;
            function r(a, s) {
                for(var o = a.getText(), l = i(s, function(g, _) {
                    var k = g.range.start.line - _.range.start.line;
                    return k === 0 ? g.range.start.character - _.range.start.character : k;
                }), u = o.length, c = l.length - 1; c >= 0; c--){
                    var h = l[c], d = a.offsetAt(h.range.start), p = a.offsetAt(h.range.end);
                    if (p <= u) o = o.substring(0, d) + h.newText + o.substring(p, o.length);
            ...
            function i(a, s) {
                ...
                for(; c < l.length;)a[d++] = l[c++];
                for(; h < u.length;)a[d++] = u[h++];
                return a;
            }
        })(Yi || (Yi = {}));
        var Ps = function() {
...
` && i++;
                ...
                if (i === 0) return ae.create(0, t);
                for(; r < i;){
                    var a = Math.floor((r + i) / 2);
                    n[a] > t ? i = a : r = a + 1;
                }
                var s = r - 1;
                return ae.create(s, t - n[s]);
        ...
        (function(e) {
            ...
            e.number = s;
            function o(p, g, _) {
                return t.call(p) === "[object Number]" && g <= p && p <= _;
            }
            e.numberRange = o;
            function l(p) {
            ...
            return Object.defineProperty(e.prototype, "uri", {
                ...
                for(var r = 0, i = t; r < i.length; r++){
                    ...
                    if (e.isIncremental(a)) {
                        var s = Xi(a.range), o = this.offsetAt(s.start), l = this.offsetAt(s.end);
                        this._content = this._content.substring(0, o) + a.text + this._content.substring(l, this._content.length);
                        var u = Math.max(s.start.line, 0), c = Math.max(s.end.line, 0), h = this._lineOffsets, d = Qi(a.text, !1, o);
                        if (c - u === d.length) for(var p = 0, g = d.length; p < g; p++)h[p + u + 1] = d[p];
                        else d.length < 1e4 ? h.splice.apply(h, [
                            u + 1,
                            c - u
                        ].concat(d)) : this._lineOffsets = h = h.slice(0, u + 1).concat(d, h.slice(c + 1));
                        var _ = a.text.length - (l - o);
                        if (_ !== 0) for(var p = u + 1 + d.length, g = h.length; p < g; p++)h[p] = h[p] + _;
                    } else if (e.isFull(a)) this._content = a.text, this._lineOffsets = void 0;
                    else throw new Error("Unknown change event received");
                }
                this._version = n;
            }, e.prototype.getLineOffsets = function() {
                return this._lineOffsets === void 0 && (this._lineOffsets = Qi(this._content, !0)), this._lineOffsets;
            }, e.prototype.positionAt = function(t) {
                t = Math.max(Math.min(t, this._content.length), 0);
                var n = this.getLineOffsets(), r = 0, i = n.length;
                if (i === 0) return {
        ...
        (function(e) {
            function t(i, a, s, o) {
                return new $i(i, a, s, o);
            }
            e.create = t;
            function n(i, a, s) {
                if (i instanceof $i) return i.update(a, s), i;
                throw new Error("TextDocument.update: document must be created by TextDocument.create");
            }
            e.update = n;
            function r(i, a) {
                for(var s = i.getText(), o = jn(a.map(Bs), function(g, _) {
                    var k = g.range.start.line - _.range.start.line;
                    return k === 0 ? g.range.start.character - _.range.start.character : k;
                }), l = 0, u = [], c = 0, h = o; c < h.length; c++){
                    var d = h[c], p = i.offsetAt(d.range.start);
                    if (p < l) throw new Error("Overlapping edit");
                    p > l && u.push(s.substring(l, p)), d.newText.length && u.push(d.newText), l = i.offsetAt(d.range.end);
                }
        ...
        function jn(e, t) {
            if (e.length <= 1) return e;
            var n = e.length / 2 | 0, r = e.slice(0, n), i = e.slice(n);
            jn(r, t), jn(i, t);
            for(var a = 0, s = 0, o = 0; a < r.length && s < i.length;){
                var l = t(r[a], i[s]);
                l <= 0 ? e[o++] = r[a++] : e[o++] = i[s++];
            }
            for(; a < r.length;)e[o++] = r[a++];
            for(; s < i.length;)e[o++] = i[s++];
            return e;
        }
        function Qi(e, t, n) {
            n === void 0 && (n = 0);
            for(var r = t ? [
                ...
                (a === 13 || a === 10) && (a === 13 && i + 1 < e.length && e.charCodeAt(i + 1) === 10 && i++, r.push(n + i + 1));
            }
            return r;
        }
        function Xi(e) {
        ...
        var Pe = Ft(), qs = function() {
            ...
            return e.prototype.eos = function() {
                ...
                var t = this.advanceWhileChar(function(n) {
                    return n === Qs || n === Xs || n === Vs || n === $s || n === Ys;
                });
                return t > 0;
            }, e.prototype.advanceWhileChar = function(t) {
                for(var n = this.position; this.position < this.len && t(this.source.charCodeAt(this.position));)this.position++;
                return this.position - n;
            }, e;
        }(), Zi = "!".charCodeAt(0), ut = "-".charCodeAt(0), Xt = "<".charCodeAt(0), Ce = ">".charCodeAt(0), Vn = "/".charCodeAt(0), Os = "=".charCodeAt(0), js = '"'.charCodeAt(0), Gs = "'".charCodeAt(0), Vs = `
`.charCodeAt(0), Ys = "\r".charCodeAt(0), $s = "\f".charCodeAt(0), Qs = " ".charCodeAt(0), Xs = "	".charCodeAt(0), Js = {
            "text/x-handlebars-template": !0
        };
        function be(e, t, n, r) {
            t === void 0 && (t = 0), n === void 0 && (n = P.WithinContent), r === void 0 && (r = !1);
            var i = new qs(e, t), a = n, s = 0, o = D.Unknown, l, u, c, h, d;
            function p() {
            ...
            function _(v, m, f) {
                return o = m, s = v, l = f, m;
            }
            function k() {
                var v = i.pos(), m = a, f = U();
                return f !== D.EOS && v === i.pos() && !(r && (f === D.StartTagClose || f === D.EndTagClose)) ? (console.log("Scanner.scan has not advanced at offset " + v + ", state before: " + m + " after: " + a), i.advance(1), _(v, D.Unknown)) : f;
            }
            function U() {
                var v = i.pos();
                if (i.eos()) return _(v, D.EOS);
                var m;
                switch(a){
                    case P.WithinComment:
                        return i.advanceIfChars([
                            ut,
                            ut,
                            Ce
                        ]) ? (a = P.WithinContent, _(v, D.EndCommentTag)) : (i.advanceUntilChars([
                            ut,
                            ut,
                            Ce
                        ]), _(v, D.Comment));
                    case P.WithinDoctype:
                        return i.advanceIfChar(Ce) ? (a = P.WithinContent, _(v, D.EndDoctypeTag)) : (i.advanceUntilChar(Ce), _(v, D.Doctype));
                    case P.WithinContent:
                        if (i.advanceIfChar(Xt)) {
                            if (!i.eos() && i.peekChar() === Zi) {
                                if (i.advanceIfChars([
                                    Zi,
                                    ut,
                                    ut
                                ])) return a = P.WithinComment, _(v, D.StartCommentTag);
                                if (i.advanceIfRegExp(/^!doctype/i)) return a = P.WithinDoctype, _(v, D.StartDoctypeTag);
                            }
                            return i.advanceIfChar(Vn) ? (a = P.AfterOpeningEndTag, _(v, D.EndTagOpen)) : (a = P.AfterOpeningStartTag, _(v, D.StartTagOpen));
                        }
                        return i.advanceUntilChar(Xt), _(v, D.Content);
                    case P.AfterOpeningEndTag:
                        var f = p();
                        return f.length > 0 ? (a = P.WithinEndTag, _(v, D.EndTag)) : i.skipWhitespace() ? _(v, D.Whitespace, Pe("error.unexpectedWhitespace", "Tag name must directly follow the open bracket.")) : (a = P.WithinEndTag, i.advanceUntilChar(Ce), v < i.pos() ? _(v, D.Unknown, Pe("error.endTagNameExpected", "End tag name expected.")) : U());
                    case P.WithinEndTag:
                        if (i.skipWhitespace()) return _(v, D.Whitespace);
                        if (i.advanceIfChar(Ce)) return a = P.WithinContent, _(v, D.EndTagClose);
                        if (r && i.peekChar() === Xt) return a = P.WithinContent, _(v, D.EndTagClose, Pe("error.closingBracketMissing", "Closing bracket missing."));
                        m = Pe("error.closingBracketExpected", "Closing bracket expected.");
                        break;
                    case P.AfterOpeningStartTag:
                        return c = p(), d = void 0, h = void 0, c.length > 0 ? (u = !1, a = P.WithinTag, _(v, D.StartTag)) : i.skipWhitespace() ? _(v, D.Whitespace, Pe("error.unexpectedWhitespace", "Tag name must directly follow the open bracket.")) : (a = P.WithinTag, i.advanceUntilChar(Ce), v < i.pos() ? _(v, D.Unknown, Pe("error.startTagNameExpected", "Start tag name expected.")) : U());
                    case P.WithinTag:
                        return i.skipWhitespace() ? (u = !0, _(v, D.Whitespace)) : u && (h = g(), h.length > 0) ? (a = P.AfterAttributeName, u = !1, _(v, D.AttributeName)) : i.advanceIfChars([
                            Vn,
                            Ce
                        ]) ? (a = P.WithinContent, _(v, D.StartTagSelfClose)) : i.advanceIfChar(Ce) ? (c === "script" ? d && Js[d] ? a = P.WithinContent : a = P.WithinScriptContent : c === "style" ? a = P.WithinStyleContent : a = P.WithinContent, _(v, D.StartTagClose)) : r && i.peekChar() === Xt ? (a = P.WithinContent, _(v, D.StartTagClose, Pe("error.closingBracketMissing", "Closing bracket missing."))) : (i.advance(1), _(v, D.Unknown, Pe("error.unexpectedCharacterInTag", "Unexpected character in tag.")));
                    case P.AfterAttributeName:
                        return i.skipWhitespace() ? (u = !0, _(v, D.Whitespace)) : i.advanceIfChar(Os) ? (a = P.BeforeAttributeValue, _(v, D.DelimiterAssign)) : (a = P.WithinTag, U());
                    case P.BeforeAttributeValue:
                        if (i.skipWhitespace()) return _(v, D.Whitespace);
                        var b = i.advanceIfRegExp(/^[^\s"'`=<>]+/);
                        if (b.length > 0) return i.peekChar() === Ce && i.peekChar(-1) === Vn && (i.goBack(1), b = b.substr(0, b.length - 1)), h === "type" && (d = b), a = P.WithinTag, u = !1, _(v, D.AttributeValue);
                        var C = i.peekChar();
                        return C === Gs || C === js ? (i.advance(1), i.advanceUntilChar(C) && i.advance(1), h === "type" && (d = i.getSource().substring(v + 1, i.pos() - 1)), a = P.WithinTag, u = !1, _(v, D.AttributeValue)) : (a = P.WithinTag, u = !1, U());
                    case P.WithinScriptContent:
                        for(var T = 1; !i.eos();){
                            var E = i.advanceIfRegExp(/<!--|-->|<\/?script\s*\/?>?/i);
                            if (E.length === 0) return i.goToEnd(), _(v, D.Script);
                            if (E === "<!--") T === 1 && (T = 2);
                            else if (E === "-->") T = 1;
                            else if (E[1] !== "/") T === 2 && (T = 3);
                            else if (T === 3) T = 2;
                        ...
                        return a = P.WithinContent, v < i.pos() ? _(v, D.Script) : U();
                    case P.WithinStyleContent:
                        return i.advanceUntilRegExp(/<\/style/i), a = P.WithinContent, v < i.pos() ? _(v, D.Styles) : U();
                }
                return i.advance(1), a = P.WithinContent, _(v, D.Unknown, m);
            }
            return {
                scan: k,
                ...
                getTokenText: function() {
                    return i.getSource().substring(s, i.pos());
                },
        ...
        function Jt(e) {
            return !!e && Zs(Ks, e.toLowerCase(), function(t, n) {
        ...
        var ea = function() {
            ...
            return Object.defineProperty(e.prototype, "attributeNames", {
                ...
                var n = Ki(this.children, function(a) {
                    return t <= a.start;
                }) - 1;
                if (n >= 0) {
                ...
                var n = Ki(this.children, function(i) {
                    return t <= i.start;
                }) - 1;
                if (n >= 0) {
                    var r = this.children[n];
        ...
        function ta(e) {
            for(var t = be(e, void 0, void 0, !0), n = new ea(0, e.length, [], void 0), r = n, i = -1, a = void 0, s = null, o = t.scan(); o !== D.EOS;){
                switch(o){
                    case D.StartTagOpen:
                        var l = new ea(t.getTokenOffset(), e.length, [], r);
                        r.children.push(l), r = l;
                        break;
                    case D.StartTag:
                        r.tag = t.getTokenText();
                        break;
                    case D.StartTagClose:
                        r.parent && (r.end = t.getTokenEnd(), t.getTokenLength() ? (r.startTagEnd = t.getTokenEnd(), r.tag && Jt(r.tag) && (r.closed = !0, r = r.parent)) : r = r.parent);
                        break;
                    case D.StartTagSelfClose:
                    ...
                    case D.EndTagClose:
                        ...
                        break;
                    case D.AttributeName:
                        s = t.getTokenText();
                        var c = r.attributes;
                        c || (r.attributes = c = {}), c[s] = null;
                        break;
                    case D.AttributeValue:
                        var h = t.getTokenText(), c = r.attributes;
                        c && s && (c[s] = h, s = null);
                        break;
                }
                o = t.scan();
...
`,
        ...
        function na(e, t) {
            for(var n = ""; t > 0;)(t & 1) == 1 && (n += e), e += e, t = t >>> 1;
            return n;
        }
        var to = "a".charCodeAt(0), no = "z".charCodeAt(0), ro = "A".charCodeAt(0), io = "Z".charCodeAt(0), ao = "0".charCodeAt(0), so = "9".charCodeAt(0);
        function At(e, t) {
            var n = e.charCodeAt(t);
            return to <= n && n <= no || ro <= n && n <= io || ao <= n && n <= so;
        }
        function Zt(e) {
            return typeof e != "undefined";
        }
                ...
                var a = function(o) {
                    o.forEach(function(l) {
                        l.name.toLowerCase() === n && (l.values && l.values.forEach(function(u) {
                            i.push(u);
                        }), l.valueSet && r._valueSetMap[l.valueSet] && r._valueSetMap[l.valueSet].forEach(function(u) {
                            i.push(u);
                        }));
                    });
                }, s = this._tagMap[t.toLowerCase()];
                return s ? (a(s.attributes), a(this._globalAttributes), i) : [];
            }, e;
        }();
        function Je(e, t, n) {
            t === void 0 && (t = {});
...
`)), r.value !== "") return r;
        ...
        var ra = function(e, t, n, r) {
            ...
            return e.prototype.onHtmlAttributeValue = function(t) {
                        ...
                        switch(p.label){
                            case 0:
                                r = {
                                    items: [],
                                    isIncomplete: !1
                                }, i = 0, a = this.atributeCompletions, p.label = 1;
                            case 1:
                                return i < a.length ? (s = a[i], o = ho(t.getText(s.range)), fo(o) ? o === "." || o === ".." ? (r.isIncomplete = !0, [
                                    3,
                                    4
                                ]) : [
                                    3,
                            ...
                            case 2:
                                return l = po(s.value, o, s.range), [
                                    4,
                                    this.providePathSuggestions(s.value, l, t, n)
                                ];
                            case 3:
                                for(u = p.sent(), c = 0, h = u; c < h.length; c++)d = h[c], r.items.push(d);
                                p.label = 4;
                            case 4:
                                return i++, [
                                    3,
                ...
                return ra(this, void 0, void 0, function() {
                    var a, s, o, l, u, c, h, d, p, g;
                    return ia(this, function(_) {
                        switch(_.label){
                            case 0:
                                if (a = t.substring(0, t.lastIndexOf("/") + 1), s = i.resolveReference(a || ".", r.uri), !s) return [
                                    3,
                                    4
                                ];
                                _.label = 1;
                            ...
                            case 2:
                                for(l = _.sent(), u = 0, c = l; u < c.length; u++)h = c[u], d = h[0], p = h[1], d.charCodeAt(0) !== co && o.push(go(d, p === Gn.Directory, n));
                                return [
                                    2,
                                    o
                                ];
        ...
        function ho(e) {
            return Be(e, "'") || Be(e, '"') ? e.slice(1, -1) : e;
        }
        function fo(e) {
            return !(Be(e, "http") || Be(e, "https") || Be(e, "//"));
        }
        function mo(e, t) {
            var n = _o[e];
        ...
        function po(e, t, n) {
            ...
            if (i === -1) r = bo(n, 1, -1);
                ...
                var a = t.slice(i + 1), s = Ct(n.end, -1 - a.length), o = a.indexOf(" "), l = void 0;
                o !== -1 ? l = Ct(s, o) : l = Ct(n.end, -1), r = V.create(s, l);
            }
            return r;
        }
        function go(e, t, n) {
        ...
        function Ct(e, t) {
            return ae.create(e.line, e.character + t);
        }
        function bo(e, t, n) {
            var r = Ct(e.start, t), i = Ct(e.end, n);
            return V.create(r, i);
        }
        var _o = {
            a: "href",
            ...
            return e.prototype.setCompletionParticipants = function(t) {
                ...
                return vo(this, void 0, void 0, function() {
                    var s, o, l, u;
                    return wo(this, function(c) {
                        switch(c.label){
                            case 0:
                                if (!this.lsOptions.fileSystemProvider || !this.lsOptions.fileSystemProvider.readDirectory) return [
                                    2,
                                    this.doComplete(t, n, r, a)
                                ];
                                s = new uo(this.lsOptions.fileSystemProvider.readDirectory), o = this.completionParticipants, this.completionParticipants = [
                                    s
                                ].concat(o), l = this.doComplete(t, n, r, a), c.label = 1;
                            case 1:
                                return c.trys.push([
                                    1,
                                    ,
                ...
                var a = {
                    isIncomplete: !1,
                    items: []
                }, s = this.completionParticipants, o = this.dataManager.getDataProviders().filter(function(R) {
                    return R.isApplicable(t.languageId) && (!i || i[R.getId()] !== !1);
                }), l = this.doesSupportMarkdown(), u = t.getText(), c = t.offsetAt(n), h = r.findNodeBefore(c);
                if (!h) return a;
                var d = be(u, h.start), p = "", g;
                function _(R, L) {
                    return L === void 0 && (L = c), R > c && (R = c), {
                        start: t.positionAt(R),
                        end: t.positionAt(L)
                    };
                }
                function k(R, L) {
                    ...
                    return o.forEach(function(F) {
                        F.provideTags().forEach(function(O) {
                            a.items.push({
                                label: O.name,
                                kind: he.Property,
                                documentation: Je(O, void 0, l),
                                textEdit: ne.replace(N, O.name),
                ...
                function U(R) {
                    for(var L = R; L > 0;){
                        var N = u.charAt(L - 1);
                        if (`
\r`.indexOf(N) >= 0) return u.substring(L, R);
                        if (!Kt(N)) return null;
                        L--;
                    }
                ...
                function v(R, L, N) {
                    N === void 0 && (N = c);
                    var F = _(R, N), O = aa(u, N, P.WithinEndTag, D.EndTagClose) ? "" : ">", G = h;
                    for(L && (G = G.parent); G;){
                        var X = G.tag;
                        if (X && (!G.closed || G.endTagStart && G.endTagStart > c)) {
                            var te = {
                                label: "/" + X,
                                kind: he.Property,
                                filterText: "/" + X,
                                textEdit: ne.replace(F, "/" + X + O),
                                insertTextFormat: Se.PlainText
                            }, Me = U(G.start), Re = U(R - 1);
                            if (Me !== null && Re !== null && Me !== Re) {
                                var Jn = Me + "</" + X + O;
                                te.textEdit = ne.replace(_(R - 1 - Re.length), Jn), te.filterText = Re + "</" + X;
                            }
                            return a.items.push(te), a;
                        }
                        G = G.parent;
                    }
                    return L || o.forEach(function(Zn) {
                        Zn.provideTags().forEach(function(qe) {
                            a.items.push({
                                label: "/" + qe.name,
                                kind: he.Property,
                                documentation: Je(qe, void 0, l),
                                filterText: "/" + qe.name + O,
                                textEdit: ne.replace(F, "/" + qe.name + O),
                                insertTextFormat: Se.PlainText
                            });
                        });
                    }), a;
                ...
                function m(R, L) {
                    ...
                    if (!Jt(L)) {
                        var N = t.positionAt(R);
                        a.items.push({
                            label: "</" + L + ">",
                            kind: he.Property,
                            filterText: "</" + L + ">",
                            textEdit: ne.insert(N, "$0</" + L + ">"),
                ...
                function f(R, L) {
                    return k(R, L), v(R, !0, L), a;
                }
                function b(R, L) {
                    L === void 0 && (L = c);
                    for(var N = c; N < L && u[N] !== "<";)N++;
                    var F = _(R, N), O = aa(u, L, P.AfterAttributeName, D.DelimiterAssign) ? "" : '="$1"', G = Object.create(null);
                    return o.forEach(function(X) {
                        X.provideAttributes(p).forEach(function(te) {
                            if (!G[te.name]) {
                                G[te.name] = !0;
                                var Me = te.name, Re;
                                te.valueSet !== "v" && O.length && (Me = Me + O, (te.valueSet || te.name === "style") && (Re = {
                                    title: "Suggest",
                                    command: "editor.action.triggerSuggest"
                                })), a.items.push({
                                    label: te.name,
                                    kind: te.valueSet === "handler" ? he.Function : he.Value,
                                    documentation: Je(te, void 0, l),
                                    textEdit: ne.replace(F, Me),
                                    insertTextFormat: Se.Snippet,
                                    command: Re
                                });
                            }
                ...
                function C(R, L) {
                    ...
                    F[N] = N + '$1="$2"';
                    function O(G) {
                        G.attributeNames.forEach(function(X) {
                            Be(X, N) && !F[X] && !L[X] && (F[X] = X + '="$1"');
                        }), G.children.forEach(function(X) {
                            return O(X);
                        });
                    }
                    r && r.roots.forEach(function(G) {
                        return O(G);
                    }), Object.keys(F).forEach(function(G) {
                        return a.items.push({
                            label: G,
                            kind: he.Value,
                            textEdit: ne.replace(R, F[G]),
                            insertTextFormat: Se.Snippet
                        });
                    });
                }
                function T(R, L) {
                    ...
                    if (c > R && c <= L && ko(u[R])) {
                        var G = R + 1, X = L;
                        L > R && u[L - 1] === u[R] && X--;
                        var te = So(u, c, G), Me = Ao(u, c, X);
                        N = _(te, Me), O = c >= G && c <= X ? u.substring(G, c) : "", F = !1;
                    } else N = _(R, L), O = u.substring(R, c), F = !0;
                    if (s.length > 0) for(var Re = p.toLowerCase(), Jn = g.toLowerCase(), Zn = _(R, L), qe = 0, pa = s; qe < pa.length; qe++){
                        var ga = pa[qe];
                        ga.onHtmlAttributeValue && ga.onHtmlAttributeValue({
                            document: t,
                            position: n,
                            tag: Re,
                            attribute: Jn,
                    ...
                    return o.forEach(function(sl) {
                        sl.provideValues(p, g).forEach(function(tn) {
                            var ba = F ? '"' + tn.name + '"' : tn.name;
                            a.items.push({
                                label: tn.name,
                                filterText: ba,
                                kind: he.Unit,
                                documentation: Je(tn, void 0, l),
                                textEdit: ne.replace(N, ba),
                                insertTextFormat: Se.PlainText
                            });
                        });
                    }), z(), a;
                ...
                function E(R) {
                    return c === d.getTokenEnd() && (x = d.scan(), x === R && d.getTokenOffset() === c) ? d.getTokenEnd() : c;
                }
                function I() {
                ...
                function z() {
                    for(var R = c - 1, L = n.character; R >= 0 && At(u, R);)R--, L--;
                    if (R >= 0 && u[R] === "&") {
                        var N = V.create(ae.create(n.line, L - 1), n);
                        for(var F in St)if (eo(F, ";")) {
                            var O = "&" + F;
                            a.items.push({
                                label: O,
                                kind: he.Keyword,
                                documentation: yo("entity.propose", "Character entity representing '" + St[F] + "'"),
                                textEdit: ne.replace(N, O),
                                insertTextFormat: Se.PlainText
                            });
                        }
                    }
                ...
                function H(R, L) {
                    ...
                    a.items.push({
                        ...
                        textEdit: ne.replace(N, "!DOCTYPE html>"),
                        insertTextFormat: Se.PlainText
                    });
                }
                for(var x = d.scan(); x !== D.EOS && d.getTokenOffset() <= c;){
                    switch(x){
                        case D.StartTagOpen:
                            if (d.getTokenEnd() === c) {
                                var W = E(D.StartTag);
                                return n.line === 0 && H(c, W), f(c, W);
                            }
                            break;
                        case D.StartTag:
                            if (d.getTokenOffset() <= c && c <= d.getTokenEnd()) return k(d.getTokenOffset(), d.getTokenEnd());
                            p = d.getTokenText();
                            break;
                        case D.AttributeName:
                            if (d.getTokenOffset() <= c && c <= d.getTokenEnd()) return b(d.getTokenOffset(), d.getTokenEnd());
                            g = d.getTokenText();
                            break;
                        case D.DelimiterAssign:
                            if (d.getTokenEnd() === c) {
                                var W = E(D.AttributeValue);
                                return T(c, W);
                            }
                            break;
                        case D.AttributeValue:
                            if (d.getTokenOffset() <= c && c <= d.getTokenEnd()) return T(d.getTokenOffset(), d.getTokenEnd());
                            break;
                        case D.Whitespace:
                            if (c <= d.getTokenEnd()) switch(d.getScannerState()){
                                case P.AfterOpeningStartTag:
                                    var B = d.getTokenOffset(), j = E(D.StartTag);
                                    return f(B, j);
                                case P.WithinTag:
                                case P.AfterAttributeName:
                                    return b(d.getTokenEnd());
                                case P.BeforeAttributeValue:
                                    return T(d.getTokenEnd());
                                case P.AfterOpeningEndTag:
                                    return v(d.getTokenOffset() - 1, !1);
                                case P.WithinContent:
                                    return I();
                            }
                            break;
                        case D.EndTagOpen:
                            if (c <= d.getTokenEnd()) {
                                var S = d.getTokenOffset() + 1, y = E(D.EndTag);
                                return v(S, !1, y);
                            }
                            break;
                        case D.EndTag:
                            if (c <= d.getTokenEnd()) for(var A = d.getTokenOffset() - 1; A >= 0;){
                                var M = u.charAt(A);
                                if (M === "/") return v(A, !1, d.getTokenEnd());
                                if (!Kt(M)) break;
                                A--;
                            }
                            break;
                        case D.StartTagClose:
                            if (c <= d.getTokenEnd() && p) return m(d.getTokenEnd(), p);
                            break;
                        case D.Content:
                            if (c <= d.getTokenEnd()) return I();
                            break;
                        default:
                            if (c <= d.getTokenEnd()) return a;
                            break;
                    }
                    x = d.scan();
                }
                ...
                if (a === ">") {
                    var s = r.findNodeBefore(i);
                    if (s && s.tag && !Jt(s.tag) && s.start < i && (!s.endTagStart || s.endTagStart > i)) for(var o = be(t.getText(), s.start), l = o.scan(); l !== D.EOS && o.getTokenEnd() <= i;){
                        if (l === D.StartTagClose && o.getTokenEnd() === i) return "$0</" + s.tag + ">";
                        l = o.scan();
                    }
                } else if (a === "/") {
                    for(var s = r.findNodeBefore(i); s && s.closed;)s = s.parent;
                    if (s && s.tag) for(var o = be(t.getText(), s.start), l = o.scan(); l !== D.EOS && o.getTokenEnd() <= i;){
                        if (l === D.EndTagOpen && o.getTokenEnd() === i) return s.tag + ">";
                        l = o.scan();
                    }
                }
                return null;
                ...
                if (!Zt(this.supportsMarkdown)) {
                    if (!Zt(this.lsOptions.clientCapabilities)) return this.supportsMarkdown = !0, this.supportsMarkdown;
                    ...
                    this.supportsMarkdown = Array.isArray(i) && i.indexOf(ke.Markdown) !== -1;
                }
        ...
        function aa(e, t, n, r) {
            for(var i = be(e, t, n), a = i.scan(); a === D.Whitespace;)a = i.scan();
            return a === r;
        }
        function So(e, t, n) {
            for(; t > n && !Kt(e[t - 1]);)t--;
        ...
        var Co = Ft(), Lo = function() {
            function e(t, n) {
                this.lsOptions = t, this.dataManager = n;
            }
            return e.prototype.doHover = function(t, n, r, i) {
                var a = this.convertContents.bind(this), s = this.doesSupportMarkdown(), o = t.offsetAt(n), l = r.findNodeAt(o), u = t.getText();
                if (!l || !l.tag) return null;
                var c = this.dataManager.getDataProviders().filter(function(x) {
                    return x.isApplicable(t.languageId);
                });
                function h(x, W, B) {
                    for(var j = function(R) {
                        var L = null;
                        if (R.provideTags().forEach(function(N) {
                        ...
                        }), L) return L.contents = a(L.contents), {
                            value: L
                        };
                    }, S = 0, y = c; S < y.length; S++){
                        var A = y[S], M = j(A);
                ...
                function d(x, W, B) {
                    for(var j = function(R) {
                        var L = null;
                        if (R.provideAttributes(x).forEach(function(N) {
                ...
                function p(x, W, B, j) {
                    for(var S = function(L) {
                        var N = null;
                        if (L.provideValues(x, W).forEach(function(F) {
                        ...
                        }), N) return N.contents = a(N.contents), {
                            value: N
                        };
                    }, y = 0, A = c; y < A.length; y++){
                        var M = A[y], R = S(M);
                ...
                function g(x, W) {
                    ...
                    for(var j in St){
                        var S = null, y = "&" + j;
                        if (B === y) {
                            var A = St[j].charCodeAt(0).toString(16).toUpperCase(), M = "U+";
                            if (A.length < 4) for(var R = 4 - A.length, L = 0; L < R;)M += "0", L += 1;
                            M += A;
                            var N = Co("entity.propose", "Character entity representing '" + St[j] + "', unicode equivalent '" + M + "'");
                            N ? S = {
                                contents: N,
                                range: W
                            } : S = null;
                        }
                        if (S) return S.contents = a(S.contents), S;
                    }
                    return null;
                }
                function _(x, W) {
                    for(var B = be(t.getText(), W), j = B.scan(); j !== D.EOS && (B.getTokenEnd() < o || B.getTokenEnd() === o && j !== x);)j = B.scan();
                    return j === x && o <= B.getTokenEnd() ? {
                        start: t.positionAt(B.getTokenOffset()),
                        end: t.positionAt(B.getTokenEnd())
                    } : null;
                }
                function k() {
                    for(var x = o - 1, W = n.character; x >= 0 && At(u, x);)x--, W--;
                    for(var B = x + 1, j = W; At(u, B);)B++, j++;
                    if (x >= 0 && u[x] === "&") {
                        var S = null;
                        return u[B] === ";" ? S = V.create(ae.create(n.line, W), ae.create(n.line, j + 1)) : S = V.create(ae.create(n.line, W), ae.create(n.line, j)), S;
                    }
                    return null;
                }
                function U(x) {
                    for(var W = o - 1, B = "&"; W >= 0 && At(x, W);)W--;
                    for(W = W + 1; At(x, W);)B += x[W], W += 1;
                    return B += ";", B;
                }
                if (l.endTagStart && o >= l.endTagStart) {
                    var v = _(D.EndTag, l.endTagStart);
                    return v ? h(l.tag, v, !1) : null;
                }
                var m = _(D.StartTag, l.start);
                if (m) return h(l.tag, m, !0);
                var f = _(D.AttributeName, l.start);
                if (f) {
                    var b = l.tag, C = t.getText(f);
                    return d(b, C, f);
                }
                var T = k();
                if (T) return g(u, T);
                function E(x, W) {
                    for(var B = be(t.getText(), x), j = B.scan(), S = void 0; j !== D.EOS && B.getTokenEnd() <= W;)j = B.scan(), j === D.AttributeName && (S = B.getTokenText());
                    return S;
                }
                var I = _(D.AttributeValue, l.start);
                if (I) {
                    var b = l.tag, z = Do(t.getText(I)), H = E(l.start, t.offsetAt(I.start));
                    if (H) return p(b, H, z, I);
                }
                return null;
                ...
                if (!this.doesSupportMarkdown()) {
                    ...
                    if (Array.isArray(t)) t.map(function(n) {
        ...
        var Eo = function(e) {
            ...
            return n.m = e, n.c = t, n.d = function(r, i, a) {
                ...
                if (i & 1 && (r = n(r)), i & 8 || i & 4 && typeof r == "object" && r && r.__esModule) return r;
                var a = Object.create(null);
                if (n.r(a), Object.defineProperty(a, "default", {
                    enumerable: !0,
                    value: r
                }), i & 2 && typeof r != "string") for(var s in r)n.d(a, s, (function(o) {
                    return r[o];
                }).bind(null, s));
                return a;
            }, n.n = function(r) {
            ...
            function(e, t, n) {
                ...
                r.prototype.clone_empty = function() {
                    var s = new r(this.__parent);
                    return s.set_indent(this.__indent_count, this.__alignment_count), s;
                }, r.prototype.item = function(s) {
                    return s < 0 ? this.__items[this.__items.length + s] : this.__items[s];
                }, r.prototype.has_match = function(s) {
                    for(var o = this.__items.length - 1; o >= 0; o--)if (this.__items[o].match(s)) return !0;
                    return !1;
                }, r.prototype.set_indent = function(s, o) {
                    this.is_empty() && (this.__indent_count = s || 0, this.__alignment_count = o || 0, this.__character_count = this.__parent.get_indent_size(this.__indent_count, this.__alignment_count));
                    ...
                    var o = s.lastIndexOf(`
`);
                    o !== -1 ? this.__character_count = s.length - o : this.__character_count += s.length;
                ...
                function i(s, o) {
                    this.__cache = [
                        ""
                    ], this.__indent_size = s.indent_size, this.__indent_string = s.indent_char, s.indent_with_tabs || (this.__indent_string = new Array(s.indent_size + 1).join(s.indent_char)), o = o || "", s.indent_level > 0 && (o = new Array(s.indent_level + 1).join(this.__indent_string)), this.__base_string = o, this.__base_string_length = o.length;
                }
                i.prototype.get_indent_size = function(s, o) {
                    var l = this.__base_string_length;
                    return o = o || 0, s < 0 && (l = 0), l += s * this.__indent_size, l += o, l;
                }, i.prototype.get_indent_string = function(s, o) {
                    var l = this.__base_string;
                    return o = o || 0, s < 0 && (s = 0, l = ""), o += s * this.__indent_size, this.__ensure_cache(o), l += this.__cache[o], l;
                }, i.prototype.__ensure_cache = function(s) {
                    for(; s >= this.__cache.length;)this.__add_column();
                }, i.prototype.__add_column = function() {
                    var s = this.__cache.length, o = 0, l = "";
                    this.__indent_size && s >= this.__indent_size && (o = Math.floor(s / this.__indent_size), s -= o * this.__indent_size, l = new Array(o + 1).join(this.__indent_string)), s && (l += new Array(s + 1).join(" ")), this.__cache.push(l);
                };
                function a(s, o) {
                    this.__indent_cache = new i(s, o), this.raw = !1, this._end_with_newline = s.end_with_newline, this.indent_size = s.indent_size, this.wrap_line_length = s.wrap_line_length, this.indent_empty_lines = s.indent_empty_lines, this.__lines = [], this.previous_line = null, this.current_line = null, this.next_line = new r(this), this.space_before_token = !1, this.non_breaking_space = !1, this.previous_token_wrapped = !1, this.__add_outputline();
                }
                a.prototype.__add_outputline = function() {
                    this.previous_line = this.current_line, this.current_line = this.next_line.clone_empty(), this.__lines.push(this.current_line);
                }, a.prototype.get_line_number = function() {
                    return this.__lines.length;
                }, a.prototype.get_indent_string = function(s, o) {
                    return this.__indent_cache.get_indent_string(s, o);
                }, a.prototype.get_indent_size = function(s, o) {
                    return this.__indent_cache.get_indent_size(s, o);
                }, a.prototype.is_empty = function() {
                    return !this.previous_line && this.current_line.is_empty();
                }, a.prototype.add_new_line = function(s) {
                    return this.is_empty() || !s && this.just_added_newline() ? !1 : (this.raw || this.__add_outputline(), !0);
                }, a.prototype.get_code = function(s) {
                    this.trim(!0);
...
` && (l = l.replace(/[\n]/g, s)), l;
                ...
                }, a.prototype.set_indent = function(s, o) {
                    return s = s || 0, o = o || 0, this.next_line.set_indent(s, o), this.__lines.length > 1 ? (this.current_line.set_indent(s, o), !0) : (this.current_line.set_indent(), !1);
                }, a.prototype.add_raw_token = function(s) {
                    for(var o = 0; o < s.newlines; o++)this.__add_outputline();
                ...
                }, a.prototype.add_token = function(s) {
                ...
                }, a.prototype.remove_indent = function(s) {
                    for(var o = this.__lines.length; s < o;)this.__lines[s]._remove_indent(), s++;
                    this.current_line._remove_wrap_indent();
                }, a.prototype.trim = function(s) {
                    for(s = s === void 0 ? !1 : s, this.current_line.trim(); s && this.__lines.length > 1 && this.current_line.is_empty();)this.__lines.pop(), this.current_line = this.__lines[this.__lines.length - 1], this.current_line.trim();
                    this.previous_line = this.__lines.length > 1 ? this.__lines[this.__lines.length - 2] : null;
                }, a.prototype.just_added_newline = function() {
                    return this.current_line.is_empty();
                }, a.prototype.just_added_blankline = function() {
                    return this.is_empty() || this.current_line.is_empty() && this.previous_line.is_empty();
                }, a.prototype.ensure_empty_line_above = function(s, o) {
                    for(var l = this.__lines.length - 2; l >= 0;){
                        var u = this.__lines[l];
                        if (u.is_empty()) break;
                        if (u.item(0).indexOf(s) !== 0 && u.item(-1) !== o) {
                            this.__lines.splice(l + 1, 0, new r(this)), this.previous_line = this.__lines[this.__lines.length - 2];
                            break;
                        }
                        l--;
                    }
            ...
            function(e, t, n) {
                ...
                r.prototype._get_array = function(s, o) {
                    var l = this.raw_options[s], u = o || [];
                    return typeof l == "object" ? l !== null && typeof l.concat == "function" && (u = l.concat()) : typeof l == "string" && (u = l.split(/[^a-zA-Z0-9_\/\-]+/)), u;
                }, r.prototype._get_boolean = function(s, o) {
                    var l = this.raw_options[s], u = l === void 0 ? !!o : !!l;
                    return u;
                }, r.prototype._get_characters = function(s, o) {
                    var l = this.raw_options[s], u = o || "";
                    return typeof l == "string" && (u = l.replace(/\\r/, "\r").replace(/\\n/, `
`).replace(/\\t/, "	")), u;
                }, r.prototype._get_number = function(s, o) {
                    var l = this.raw_options[s];
                    o = parseInt(o, 10), isNaN(o) && (o = 0);
                    var u = parseInt(l, 10);
                    return isNaN(u) && (u = o), u;
                }, r.prototype._get_selection = function(s, o, l) {
                    var u = this._get_selection_list(s, o, l);
                    if (u.length !== 1) throw new Error("Invalid Option Value: The option '" + s + `' can only be one of the following values:
` + o + `
You passed in: '` + this.raw_options[s] + "'");
                    return u[0];
                }, r.prototype._get_selection_list = function(s, o, l) {
                    if (!o || o.length === 0) throw new Error("Selection list cannot be empty.");
                    if (l = l || [
                        o[0]
                    ], !this._is_valid_selection(l, o)) throw new Error("Invalid Default Value!");
                    var u = this._get_array(s, l);
                    if (!this._is_valid_selection(u, o)) throw new Error("Invalid Option Value: The option '" + s + `' can contain only the following values:
` + o + `
You passed in: '` + this.raw_options[s] + "'");
                    return u;
                }, r.prototype._is_valid_selection = function(s, o) {
                    return s.length && o.length && !s.some(function(l) {
                ...
                function i(s, o) {
                    ...
                    s = a(s);
                    var u;
                    for(u in s)u !== o && (l[u] = s[u]);
                    if (o && s[o]) for(u in s[o])l[u] = s[o][u];
                    return l;
                }
                function a(s) {
                    var o = {}, l;
            ...
            function(e, t, n) {
                ...
                i.prototype.restart = function() {
                    ...
                    var s = null;
                    return a = a || 0, a += this.__position, a >= 0 && a < this.__input_length && (s = this.__input.charAt(a)), s;
                }, i.prototype.__match = function(a, s) {
                    a.lastIndex = s;
                    var o = a.exec(this.__input);
                    return o && !(r && a.sticky) && o.index !== s && (o = null), o;
                }, i.prototype.test = function(a, s) {
                    return s = s || 0, s += this.__position, s >= 0 && s < this.__input_length ? !!this.__match(a, s) : !1;
                }, i.prototype.testChar = function(a, s) {
                    var o = this.peek(s);
                    return a.lastIndex = 0, o !== null && a.test(o);
                }, i.prototype.match = function(a) {
                    var s = this.__match(a, this.__position);
                    return s ? this.__position += s[0].length : s = null, s;
                }, i.prototype.read = function(a, s, o) {
                    var l = "", u;
                    return a && (u = this.match(a), u && (l += u[0])), s && (u || !a) && (l += this.readUntil(s, o)), l;
                }, i.prototype.readUntil = function(a, s) {
                    var o = "", l = this.__position;
                    a.lastIndex = this.__position;
                    var u = a.exec(this.__input);
                    return u ? (l = u.index, s && (l += u[0].length)) : l = this.__input_length, o = this.__input.substring(this.__position, l), this.__position = l, o;
                }, i.prototype.readUntilAfter = function(a) {
                    return this.readUntil(a, !0);
                }, i.prototype.get_regexp = function(a, s) {
                    var o = null, l = "g";
                    return s && r && (l = "y"), typeof a == "string" && a !== "" ? o = new RegExp(a, l) : a && (o = new RegExp(a.source, l)), o;
                }, i.prototype.get_literal_regexp = function(a) {
                    return RegExp(a.replace(/[-\/\\^$*+?.()|[\]{}]/g, "\\$&"));
                }, i.prototype.peekUntilAfter = function(a) {
                    var s = this.__position, o = this.readUntilAfter(a);
                    return this.__position = s, o;
                }, i.prototype.lookBack = function(a) {
                    var s = this.__position - 1;
                    return s >= a.length && this.__input.substring(s - a.length, s).toLowerCase() === a;
            ...
            function(e, t, n) {
                ...
                r.prototype.get_directives = function(i) {
                    if (!i.match(this.__directives_block_pattern)) return null;
                    var a = {};
                    this.__directive_pattern.lastIndex = 0;
                    for(var s = this.__directive_pattern.exec(i); s;)a[s[1]] = s[2], s = this.__directive_pattern.exec(i);
                    return a;
                }, r.prototype.readIgnored = function(i) {
            ...
            function(e, t, n) {
                ...
                e.exports = a, e.exports.defaultOptions = function() {
                    return new i;
                };
            },
            function(e, t, n) {
                "use strict";
                var r = n(17).Options, i = n(2).Output, a = n(8).InputScanner, s = n(13).Directives, o = new s(/\/\*/, /\*\//), l = /\r\n|[\r\n]/, u = /\r\n|[\r\n]/g, c = /\s/, h = /(?:\s|\n)+/g, d = /\/\*(?:[\s\S]*?)((?:\*\/)|$)/g, p = /\/\/(?:[^\n\r\u2028\u2029]*)/g;
                function g(_, k) {
                    this._source_text = _ || "", this._options = new r(k), this._ch = null, this._input = null, this.NESTED_AT_RULE = {
                        "@page": !0,
                        "@font-face": !0,
                        "@keyframes": !0,
                        "@media": !0,
                ...
                g.prototype.eatString = function(_) {
                    var k = "";
                    for(this._ch = this._input.next(); this._ch;){
                        if (k += this._ch, this._ch === "\\") k += this._input.next();
...
`) break;
                    ...
                    for(var k = c.test(this._input.peek()), U = 0; c.test(this._input.peek());)this._ch = this._input.next(), _ && this._ch === `
` && (U === 0 || U < this._options.max_preserve_newlines) && (U++, this._output.add_new_line(!0));
                    return k;
                }, g.prototype.foundNestedPseudoClass = function() {
                    for(var _ = 0, k = 1, U = this._input.peek(k); U;){
                        if (U === "{") return !0;
                        if (U === "(") _ += 1;
                        else if (U === ")") {
                            if (_ === 0) return !1;
                    ...
                    var _ = this._source_text, k = this._options.eol;
                    k === "auto" && (k = `
`, _ && l.test(_ || "") && (k = _.match(l)[0])), _ = _.replace(u, `
`);
                    var U = _.match(/^[\t ]*/)[0];
                    this._output = new i(this._options, U), this._input = new a(_), this._indentLevel = 0, this._nestedLevel = 0, this._ch = null;
                    for(var v = 0, m = !1, f = !1, b = !1, C = !1, T = !1, E = this._ch, I, z, H; I = this._input.read(h), z = I !== "", H = E, this._ch = this._input.next(), this._ch === "\\" && this._input.hasNext() && (this._ch += this._input.next()), E = this._ch, this._ch;)if (this._ch === "/" && this._input.peek() === "*") {
                        this._output.add_new_line(), this._input.back();
                        var x = this._input.read(d), W = o.get_directives(x);
                        W && W.ignore === "start" && (x += o.readIgnored(this._input)), this.print_string(x), this.eatWhitespace(!0), this._output.add_new_line();
                        ...
                        if (this.preserveSingleSpace(z), this._input.peek() === "{") this.print_string(this._ch + this.eatString("}"));
                        else {
                            this.print_string(this._ch);
                            var B = this._input.peekUntilAfter(/[: ,;{}()[\]\/='"]/g);
                            B.match(/[ :]$/) && (B = this.eatString(": ").replace(/\s$/, ""), this.print_string(B), this._output.space_before_token = !0), B = B.replace(/\s$/, ""), B === "extend" ? C = !0 : B === "import" && (T = !0), B in this.NESTED_AT_RULE ? (this._nestedLevel += 1, B in this.CONDITIONAL_GROUP_RULE && (b = !0)) : !m && v === 0 && B.indexOf(":") !== -1 && (f = !0, this.indent());
                        }
                    } else this._ch === "#" && this._input.peek() === "{" ? (this.preserveSingleSpace(z), this.print_string(this._ch + this.eatString("}"))) : this._ch === "{" ? (f && (f = !1, this.outdent()), b ? (b = !1, m = this._indentLevel >= this._nestedLevel) : m = this._indentLevel >= this._nestedLevel - 1, this._options.newline_between_rules && m && this._output.previous_line && this._output.previous_line.item(-1) !== "{" && this._output.ensure_empty_line_above("/", ","), this._output.space_before_token = !0, this._options.brace_style === "expand" ? (this._output.add_new_line(), this.print_string(this._ch), this.indent(), this._output.set_indent(this._indentLevel)) : (this.indent(), this.print_string(this._ch)), this.eatWhitespace(!0), this._output.add_new_line()) : this._ch === "}" ? (this.outdent(), this._output.add_new_line(), H === "{" && this._output.trim(!0), T = !1, C = !1, f && (this.outdent(), f = !1), this.print_string(this._ch), m = !1, this._nestedLevel && this._nestedLevel--, this.eatWhitespace(!0), this._output.add_new_line(), this._options.newline_between_rules && !this._output.just_added_blankline() && this._input.peek() !== "}" && this._output.add_new_line(!0)) : this._ch === ":" ? (m || b) && !(this._input.lookBack("&") || this.foundNestedPseudoClass()) && !this._input.lookBack("(") && !C && v === 0 ? (this.print_string(":"), f || (f = !0, this._output.space_before_token = !0, this.eatWhitespace(!0), this.indent())) : (this._input.lookBack(" ") && (this._output.space_before_token = !0), this._input.peek() === ":" ? (this._ch = this._input.next(), this.print_string("::")) : this.print_string(":")) : this._ch === '"' || this._ch === "'" ? (this.preserveSingleSpace(z), this.print_string(this._ch + this.eatString(this._ch)), this.eatWhitespace(!0)) : this._ch === ";" ? v === 0 ? (f && (this.outdent(), f = !1), C = !1, T = !1, this.print_string(this._ch), this.eatWhitespace(!0), this._input.peek() !== "/" && this._output.add_new_line()) : (this.print_string(this._ch), this.eatWhitespace(!0), this._output.space_before_token = !0) : this._ch === "(" ? this._input.lookBack("url") ? (this.print_string(this._ch), this.eatWhitespace(), v++, this.indent(), this._ch = this._input.next(), this._ch === ")" || this._ch === '"' || this._ch === "'" ? this._input.back() : this._ch && (this.print_string(this._ch + this.eatString(")")), v && (v--, this.outdent()))) : (this.preserveSingleSpace(z), this.print_string(this._ch), this.eatWhitespace(), v++, this.indent()) : this._ch === ")" ? (v && (v--, this.outdent()), this.print_string(this._ch)) : this._ch === "," ? (this.print_string(this._ch), this.eatWhitespace(!0), this._options.selector_separator_newline && !f && v === 0 && !T ? this._output.add_new_line() : this._output.space_before_token = !0) : (this._ch === ">" || this._ch === "+" || this._ch === "~") && !f && v === 0 ? this._options.space_around_combinator ? (this._output.space_before_token = !0, this.print_string(this._ch), this._output.space_before_token = !0) : (this.print_string(this._ch), this.eatWhitespace(), this._ch && c.test(this._ch) && (this._ch = "")) : this._ch === "]" ? this.print_string(this._ch) : this._ch === "[" ? (this.preserveSingleSpace(z), this.print_string(this._ch)) : this._ch === "=" ? (this.eatWhitespace(), this.print_string("="), c.test(this._ch) && (this._ch = "")) : this._ch === "!" && !this._input.lookBack("\\") ? (this.print_string(" "), this.print_string(this._ch)) : (this.preserveSingleSpace(z), this.print_string(this._ch));
                    var j = this._output.get_code(k);
                    return j;
                }, e.exports.Beautifier = g;
            },
            function(e, t, n) {
                "use strict";
                var r = n(6).Options;
                function i(a) {
                    r.call(this, a, "css"), this.selector_separator_newline = this._get_boolean("selector_separator_newline", !0), this.newline_between_rules = this._get_boolean("newline_between_rules", !0);
                    ...
                    for(var l = 0; l < o.length; l++)o[l] !== "expand" ? this.brace_style = "collapse" : this.brace_style = o[l];
                }
...
` && (l = l.replace(/[\n]/g, s)), l;
            ...
            function(e, t, n) {
                "use strict";
                function r(i, a, s, o) {
                    this.type = i, this.text = a, this.comments_before = null, this.newlines = s || 0, this.whitespace_before = o || "", this.parent = null, this.next = null, this.previous = null, this.opened = null, this.closed = null, this.directives = null;
                }
                e.exports.Token = r;
            },
            ,
...
You passed in: '` + this.raw_options[s] + "'");
            ...
            function(e, t, n) {
                "use strict";
                var r = n(8).InputScanner, i = n(3).Token, a = n(10).TokenStream, s = n(11).WhitespacePattern, o = {
                    START: "TK_START",
                    RAW: "TK_RAW",
                    EOF: "TK_EOF"
                }, l = function(u, c) {
                    this._input = new r(u), this._options = c || {}, this.__tokens = null, this._patterns = {}, this._patterns.whitespace = new s(this._input);
                };
                l.prototype.tokenize = function() {
                    this._input.restart(), this.__tokens = new a, this._reset();
                    for(var u, c = new i(o.START, ""), h = null, d = [], p = new a; c.type !== o.EOF;){
                        for(u = this._get_next_token(c, h); this._is_comment(u);)p.add(u), u = this._get_next_token(c, h);
                        p.isEmpty() || (u.comments_before = p, p = new a), u.parent = h, this._is_opening(u) ? (d.push(h), h = u) : h && this._is_closing(u, h) && (u.opened = h, h.closed = u, h = d.pop(), u.parent = h), u.previous = c, c.next = u, this.__tokens.add(u), c = u;
                    }
                    return this.__tokens;
                }, l.prototype._is_first_token = function() {
                    return this.__tokens.isEmpty();
                }, l.prototype._reset = function() {}, l.prototype._get_next_token = function(u, c) {
                    this._readWhitespace();
                    var h = this._input.read(/.+/g);
                    return h ? this._create_token(o.RAW, h) : this._create_token(o.EOF, "");
                }, l.prototype._is_comment = function(u) {
                    return !1;
                }, l.prototype._is_opening = function(u) {
                    return !1;
                }, l.prototype._is_closing = function(u, c) {
                    return !1;
                }, l.prototype._create_token = function(u, c) {
                    var h = new i(u, c, this._patterns.whitespace.newline_count, this._patterns.whitespace.whitespace_before_token);
                    return h;
                }, l.prototype._readWhitespace = function() {
                    return this._patterns.whitespace.read();
                }, e.exports.Tokenizer = l, e.exports.TOKEN = o;
            },
            function(e, t, n) {
                "use strict";
                function r(i) {
            ...
            function(e, t, n) {
                ...
                var r = n(12).Pattern;
                function i(a, s) {
                    r.call(this, a, s), s ? this._line_regexp = this._input.get_regexp(s._line_regexp) : this.__set_whitespace_patterns("", ""), this.newline_count = 0, this.whitespace_before_token = "";
                }
                i.prototype = new r, i.prototype.__set_whitespace_patterns = function(a, s) {
                    ...
                    if (a === " ") this.whitespace_before_token = " ";
                    else if (a) {
                        var s = this.__split(this._newline_regexp, a);
                        this.newline_count = s.length - 1, this.whitespace_before_token = s[this.newline_count];
                    }
                    return a;
                }, i.prototype.matching = function(a, s) {
                    var o = this._create();
                    return o.__set_whitespace_patterns(a, s), o._update(), o;
                }, i.prototype._create = function() {
                    return new i(this._input, this);
                }, i.prototype.__split = function(a, s) {
                    a.lastIndex = 0;
                    for(var o = 0, l = [], u = a.exec(s); u;)l.push(s.substring(o, u.index)), o = u.index + u[0].length, u = a.exec(s);
                    return o < s.length ? l.push(s.substring(o, s.length)) : l.push(""), l;
            ...
            function(e, t, n) {
                ...
                function a(s, o) {
                    r.call(this, s, o), this.__template_pattern = null, this._disabled = Object.assign({}, i), this._excluded = Object.assign({}, i), o && (this.__template_pattern = this._input.get_regexp(o.__template_pattern), this._excluded = Object.assign(this._excluded, o._excluded), this._disabled = Object.assign(this._disabled, o._disabled));
                    var l = new r(s);
                    this.__patterns = {
                ...
                a.prototype = new r, a.prototype._create = function() {
                ...
                }, a.prototype.disable = function(s) {
                    var o = this._create();
                    return o._disabled[s] = !0, o._update(), o;
                }, a.prototype.read_options = function(s) {
                    var o = this._create();
                    for(var l in i)o._disabled[l] = s.templating.indexOf(l) === -1;
                    return o._update(), o;
                }, a.prototype.exclude = function(s) {
                    var o = this._create();
                    return o._excluded[s] = !0, o._update(), o;
                    ...
                    for(var o = this._read_template(); o;)this._match_pattern ? o += this._input.read(this._match_pattern) : o += this._input.readUntil(this.__template_pattern), s += o, o = this._read_template();
                    ...
                    var s = "", o = this._input.peek();
                    if (o === "<") {
                        var l = this._input.peek(1);
                        !this._disabled.php && !this._excluded.php && l === "?" && (s = s || this.__patterns.php.read()), !this._disabled.erb && !this._excluded.erb && l === "%" && (s = s || this.__patterns.erb.read());
                    } else o === "{" && (!this._disabled.handlebars && !this._excluded.handlebars && (s = s || this.__patterns.handlebars_comment.read(), s = s || this.__patterns.handlebars_unescaped.read(), s = s || this.__patterns.handlebars.read()), this._disabled.django || (!this._excluded.django && !this._excluded.handlebars && (s = s || this.__patterns.django_value.read()), this._excluded.django || (s = s || this.__patterns.django_comment.read(), s = s || this.__patterns.django.read())), this._disabled.smarty || this._disabled.django && this._disabled.handlebars && (s = s || this.__patterns.smarty_comment.read(), s = s || this.__patterns.smarty_literal.read(), s = s || this.__patterns.smarty.read()));
                    return s;
            ...
            function(e, t, n) {
                "use strict";
                var r = n(20).Options, i = n(2).Output, a = n(21).Tokenizer, s = n(21).TOKEN, o = /\r\n|[\r\n]/, l = /\r\n|[\r\n]/g, u = function(m, f) {
                    this.indent_level = 0, this.alignment_size = 0, this.max_preserve_newlines = m.max_preserve_newlines, this.preserve_newlines = m.preserve_newlines, this._output = new i(m, f);
                };
                u.prototype.current_line_has_match = function(m) {
                    return this._output.current_line.has_match(m);
                }, u.prototype.set_space_before_token = function(m, f) {
                    this._output.space_before_token = m, this._output.non_breaking_space = f;
                }, u.prototype.set_wrap_point = function() {
                    this._output.set_indent(this.indent_level, this.alignment_size), this._output.set_wrap_point();
                }, u.prototype.add_raw_token = function(m) {
                    this._output.add_raw_token(m);
                }, u.prototype.print_preserved_newlines = function(m) {
                    var f = 0;
                    m.type !== s.TEXT && m.previous.type !== s.TEXT && (f = m.newlines ? 1 : 0), this.preserve_newlines && (f = m.newlines < this.max_preserve_newlines + 1 ? m.newlines : this.max_preserve_newlines + 1);
                    for(var b = 0; b < f; b++)this.print_newline(b > 0);
                    return f !== 0;
                }, u.prototype.traverse_whitespace = function(m) {
                ...
                }, u.prototype.print_newline = function(m) {
                    this._output.add_new_line(m);
                }, u.prototype.print_token = function(m) {
                    ...
                    this.indent_level++;
                }, u.prototype.get_full_indent = function(m) {
                    return m = this.indent_level + (m || 0), m < 1 ? "" : this._output.get_indent_string(m);
                };
                var c = function(m) {
                    for(var f = null, b = m.next; b.type !== s.EOF && m.closed !== b;){
                        if (b.type === s.ATTRIBUTE && b.text === "type") {
                            b.next && b.next.type === s.EQUALS && b.next.next && b.next.next.type === s.VALUE && (f = b.next.next.text);
                            break;
                        }
                        b = b.next;
                    }
                    ...
                    var b = null, C = null;
                    return f.closed ? (m === "script" ? b = "text/javascript" : m === "style" && (b = "text/css"), b = c(f) || b, b.search("text/css") > -1 ? C = "css" : b.search(/module|((text|application|dojo)\/(x-)?(javascript|ecmascript|jscript|livescript|(ld\+)?json|method|aspect))/) > -1 ? C = "javascript" : b.search(/(text|application|dojo)\/(x-)?(html)/) > -1 ? C = "html" : b.search(/test\/null/) > -1 && (C = "null"), C) : null;
                };
                function d(m, f) {
                    return f.indexOf(m) !== -1;
                }
                function p(m, f, b) {
                    this.parent = m || null, this.tag = f ? f.tag_name : "", this.indent_level = b || 0, this.parser_token = f || null;
                }
                function g(m) {
                ...
                g.prototype.get_parser_token = function() {
                ...
                }, g.prototype.record_tag = function(m) {
                    var f = new p(this._current_frame, m, this._printer.indent_level);
                    this._current_frame = f;
                }, g.prototype._try_pop_frame = function(m) {
                    var f = null;
                    return m && (f = m.parser_token, this._printer.indent_level = m.indent_level, this._current_frame = m.parent), f;
                }, g.prototype._get_frame = function(m, f) {
                    for(var b = this._current_frame; b && m.indexOf(b.tag) === -1;){
                    ...
                    return b;
                }, g.prototype.try_pop = function(m, f) {
                    var b = this._get_frame([
                        m
                    ], f);
                    return this._try_pop_frame(b);
                }, g.prototype.indent_to_tag = function(m) {
                    var f = this._get_frame(m);
                    f && (this._printer.indent_level = f.indent_level);
                };
                function _(m, f, b, C) {
                    this._source_text = m || "", f = f || {}, this._js_beautify = b, this._css_beautify = C, this._tag_stack = null;
                    var T = new r(f, "html");
                ...
                _.prototype.beautify = function() {
                    if (this._options.disabled) return this._source_text;
                    var m = this._source_text, f = this._options.eol;
                    this._options.eol === "auto" && (f = `
`, m && o.test(m) && (f = m.match(o)[0])), m = m.replace(l, `
`);
                    var b = m.match(/^[\t ]*/)[0], C = {
                        text: "",
                        type: ""
                    }, T = new k, E = new u(this._options, b), I = new a(m, this._options).tokenize();
                    this._tag_stack = new g(E);
                    for(var z = null, H = I.next(); H.type !== s.EOF;)H.type === s.TAG_OPEN || H.type === s.COMMENT ? (z = this._handle_tag_open(E, H, T, C), T = z) : H.type === s.ATTRIBUTE || H.type === s.EQUALS || H.type === s.VALUE || H.type === s.TEXT && !T.tag_complete ? z = this._handle_inside_tag(E, H, T, I) : H.type === s.TAG_CLOSE ? z = this._handle_tag_close(E, H, T) : H.type === s.TEXT ? z = this._handle_text(E, H, T) : E.add_raw_token(H), C = z, H = I.next();
                    var x = E._output.get_code(f);
                    return x;
                }, _.prototype._handle_tag_close = function(m, f, b) {
                    var C = {
                        text: f.text,
                        type: f.type
                    };
                    return m.alignment_size = 0, b.tag_complete = !0, m.set_space_before_token(f.newlines || f.whitespace_before !== "", !0), b.is_unformatted ? m.add_raw_token(f) : (b.tag_start_char === "<" && (m.set_space_before_token(f.text[0] === "/", !0), this._is_wrap_attributes_force_expand_multiline && b.has_wrapped_attrs && m.print_newline(!1)), m.print_token(f)), b.indent_content && !(b.is_unformatted || b.is_content_unformatted) && (m.indent(), b.indent_content = !1), !b.is_inline_element && !(b.is_unformatted || b.is_content_unformatted) && m.set_wrap_point(), C;
                }, _.prototype._handle_inside_tag = function(m, f, b, C) {
                    var T = b.has_wrapped_attrs, E = {
                        text: f.text,
                        type: f.type
                    };
                    if (m.set_space_before_token(f.newlines || f.whitespace_before !== "", !0), b.is_unformatted) m.add_raw_token(f);
                    else if (b.tag_start_char === "{" && f.type === s.TEXT) m.print_preserved_newlines(f) ? (f.newlines = 0, m.add_raw_token(f)) : m.print_token(f);
                    else {
                        if (f.type === s.ATTRIBUTE ? (m.set_space_before_token(!0), b.attr_count += 1) : (f.type === s.EQUALS || f.type === s.VALUE && f.previous.type === s.EQUALS) && m.set_space_before_token(!1), f.type === s.ATTRIBUTE && b.tag_start_char === "<" && ((this._is_wrap_attributes_preserve || this._is_wrap_attributes_preserve_aligned) && (m.traverse_whitespace(f), T = T || f.newlines !== 0), this._is_wrap_attributes_force)) {
                            var I = b.attr_count > 1;
                            if (this._is_wrap_attributes_force_expand_multiline && b.attr_count === 1) {
                                var z = !0, H = 0, x;
                                do {
                                    if (x = C.peek(H), x.type === s.ATTRIBUTE) {
                                        z = !1;
                                        break;
                                    }
                                    H += 1;
                                }while (H < 4 && x.type !== s.EOF && x.type !== s.TAG_CLOSE);
                                I = !z;
                            }
                            I && (m.print_newline(!1), T = !0);
                        }
                        m.print_token(f), T = T || m.previous_token_wrapped(), b.has_wrapped_attrs = T;
                    }
                    return E;
                }, _.prototype._handle_text = function(m, f, b) {
                    var C = {
                        text: f.text,
                        type: "TK_CONTENT"
                    };
                    return b.custom_beautifier_name ? this._print_custom_beatifier_text(m, f, b) : b.is_unformatted || b.is_content_unformatted ? m.add_raw_token(f) : (m.traverse_whitespace(f), m.print_token(f)), C;
                }, _.prototype._print_custom_beatifier_text = function(m, f, b) {
                    var C = this;
                    if (f.text !== "") {
                        var T = f.text, E, I = 1, z = "", H = "";
                        b.custom_beautifier_name === "javascript" && typeof this._js_beautify == "function" ? E = this._js_beautify : b.custom_beautifier_name === "css" && typeof this._css_beautify == "function" ? E = this._css_beautify : b.custom_beautifier_name === "html" && (E = function(y, A) {
                            var M = new _(y, A, C._js_beautify, C._css_beautify);
                            return M.beautify();
                        }), this._options.indent_scripts === "keep" ? I = 0 : this._options.indent_scripts === "separate" && (I = -m.indent_level);
                        var x = m.get_full_indent(I);
                        if (T = T.replace(/\n[ \t]*$/, ""), b.custom_beautifier_name !== "html" && T[0] === "<" && T.match(/^(<!--|<!\[CDATA\[)/)) {
                            ...
                            z = x + W[1] + `
`, T = W[4], W[5] && (H = x + W[5]), T = T.replace(/\n[ \t]*$/, ""), (W[2] || W[3].indexOf(`
`) !== -1) && (W = W[3].match(/[ \t]+$/), W && (f.whitespace_before = W[0]));
                        }
                        if (T) {
                            if (E) {
                                var B = function() {
...
`;
                                ...
                                var S = f.whitespace_before;
                                S && (T = T.replace(new RegExp(`
(` + S + ")?", "g"), `
`)), T = x + T.replace(/\n/g, `
` + x);
                            }
                        ...
                        z && (T ? T = z + T + `
` + H : T = z + H), m.print_newline(!1), T && (f.text = T, f.whitespace_before = "", f.newlines = 0, m.add_raw_token(f), m.print_newline(!0));
                    }
                }, _.prototype._handle_tag_open = function(m, f, b, C) {
                    var T = this._get_tag_open_token(f);
                    return (b.is_unformatted || b.is_content_unformatted) && !b.is_empty_element && f.type === s.TAG_OPEN && f.text.indexOf("</") === 0 ? (m.add_raw_token(f), T.start_tag_token = this._tag_stack.try_pop(T.tag_name)) : (m.traverse_whitespace(f), this._set_tag_position(m, f, T, b, C), T.is_inline_element || m.set_wrap_point(), m.print_token(f)), (this._is_wrap_attributes_force_aligned || this._is_wrap_attributes_aligned_multiple || this._is_wrap_attributes_preserve_aligned) && (T.alignment_size = f.text.length + 1), !T.tag_complete && !T.is_unformatted && (m.alignment_size = T.alignment_size), T;
                };
                var k = function(m, f) {
                    if (this.parent = m || null, this.text = "", this.type = "TK_TAG_OPEN", this.tag_name = "", this.is_inline_element = !1, this.is_unformatted = !1, this.is_content_unformatted = !1, this.is_empty_element = !1, this.is_start_tag = !1, this.is_end_tag = !1, this.indent_content = !1, this.multiline_content = !1, this.custom_beautifier_name = null, this.start_tag_token = null, this.attr_count = 0, this.has_wrapped_attrs = !1, this.alignment_size = 0, this.tag_complete = !1, this.tag_start_char = "", this.tag_check = "", !f) this.tag_complete = !0;
                        ...
                        var b;
                        this.tag_start_char = f.text[0], this.text = f.text, this.tag_start_char === "<" ? (b = f.text.match(/^<([^\s>]*)/), this.tag_check = b ? b[1] : "") : (b = f.text.match(/^{{(?:[\^]|#\*?)?([^\s}]+)/), this.tag_check = b ? b[1] : "", f.text === "{{#>" && this.tag_check === ">" && f.next !== null && (this.tag_check = f.next.text)), this.tag_check = this.tag_check.toLowerCase(), f.type === s.COMMENT && (this.tag_complete = !0), this.is_start_tag = this.tag_check.charAt(0) !== "/", this.tag_name = this.is_start_tag ? this.tag_check : this.tag_check.substr(1), this.is_end_tag = !this.is_start_tag || f.closed && f.closed.text === "/>", this.is_end_tag = this.is_end_tag || this.tag_start_char === "{" && (this.text.length < 3 || /[^#\^]/.test(this.text.charAt(2)));
                    }
                };
                _.prototype._get_tag_open_token = function(m) {
                    var f = new k(this._tag_stack.get_parser_token(), m);
                    return f.alignment_size = this._options.wrap_attributes_indent_size, f.is_end_tag = f.is_end_tag || d(f.tag_check, this._options.void_elements), f.is_empty_element = f.tag_complete || f.is_start_tag && f.is_end_tag, f.is_unformatted = !f.tag_complete && d(f.tag_check, this._options.unformatted), f.is_content_unformatted = !f.is_empty_element && d(f.tag_check, this._options.content_unformatted), f.is_inline_element = d(f.tag_name, this._options.inline) || f.tag_start_char === "{", f;
                }, _.prototype._set_tag_position = function(m, f, b, C, T) {
                    if (b.is_empty_element || (b.is_end_tag ? b.start_tag_token = this._tag_stack.try_pop(b.tag_name) : (this._do_optional_end_element(b) && (b.is_inline_element || m.print_newline(!1)), this._tag_stack.record_tag(b), (b.tag_name === "script" || b.tag_name === "style") && !(b.is_unformatted || b.is_content_unformatted) && (b.custom_beautifier_name = h(b.tag_check, f)))), d(b.tag_check, this._options.extra_liners) && (m.print_newline(!1), m._output.just_added_blankline() || m.print_newline(!0)), b.is_empty_element) {
                        ...
                        b.tag_name === "!--" && T.type === s.TAG_CLOSE && C.is_end_tag && b.text.indexOf(`
`) === -1 || (b.is_inline_element || b.is_unformatted || m.print_newline(!1), this._calcluate_parent_multiline(m, b));
                    } else if (b.is_end_tag) {
                        var I = !1;
                        I = b.start_tag_token && b.start_tag_token.multiline_content, I = I || !b.is_inline_element && !(C.is_inline_element || C.is_unformatted) && !(T.type === s.TAG_CLOSE && b.start_tag_token === C) && T.type !== "TK_CONTENT", (b.is_content_unformatted || b.is_unformatted) && (I = !1), I && m.print_newline(!1);
                    } else b.indent_content = !b.custom_beautifier_name, b.tag_start_char === "<" && (b.tag_name === "html" ? b.indent_content = this._options.indent_inner_html : b.tag_name === "head" ? b.indent_content = this._options.indent_head_inner_html : b.tag_name === "body" && (b.indent_content = this._options.indent_body_inner_html)), !(b.is_inline_element || b.is_unformatted) && (T.type !== "TK_CONTENT" || b.is_content_unformatted) && m.print_newline(!1), this._calcluate_parent_multiline(m, b);
                }, _.prototype._calcluate_parent_multiline = function(m, f) {
                    f.parent && m._output.just_added_newline() && !((f.is_inline_element || f.is_unformatted) && f.parent.is_inline_element) && (f.parent.multiline_content = !0);
                };
                var U = [
                    "address",
                    "article",
                ...
                _.prototype._do_optional_end_element = function(m) {
                    var f = null;
                    if (!(m.is_empty_element || !m.is_start_tag || !m.parent)) {
                        if (m.tag_name === "body") f = f || this._tag_stack.try_pop("head");
                        else if (m.tag_name === "li") f = f || this._tag_stack.try_pop("li", [
                            "ol",
                            "ul"
                        ]);
                        else if (m.tag_name === "dd" || m.tag_name === "dt") f = f || this._tag_stack.try_pop("dt", [
                            "dl"
                        ]), f = f || this._tag_stack.try_pop("dd", [
                            "dl"
                        ]);
                        else if (m.parent.tag_name === "p" && U.indexOf(m.tag_name) !== -1) {
                            var b = m.parent.parent;
                            (!b || v.indexOf(b.tag_name) === -1) && (f = f || this._tag_stack.try_pop("p"));
                        } else m.tag_name === "rp" || m.tag_name === "rt" ? (f = f || this._tag_stack.try_pop("rt", [
                            "ruby",
                            "rtc"
                        ]), f = f || this._tag_stack.try_pop("rp", [
                            "ruby",
                            "rtc"
                        ])) : m.tag_name === "optgroup" ? f = f || this._tag_stack.try_pop("optgroup", [
                            "select"
                        ]) : m.tag_name === "option" ? f = f || this._tag_stack.try_pop("option", [
                            "select",
                            "datalist",
                            "optgroup"
                        ]) : m.tag_name === "colgroup" ? f = f || this._tag_stack.try_pop("caption", [
                            "table"
                        ]) : m.tag_name === "thead" ? (f = f || this._tag_stack.try_pop("caption", [
                            "table"
                        ]), f = f || this._tag_stack.try_pop("colgroup", [
                            "table"
                        ])) : m.tag_name === "tbody" || m.tag_name === "tfoot" ? (f = f || this._tag_stack.try_pop("caption", [
                            "table"
                        ]), f = f || this._tag_stack.try_pop("colgroup", [
                            "table"
                        ]), f = f || this._tag_stack.try_pop("thead", [
                            "table"
                        ]), f = f || this._tag_stack.try_pop("tbody", [
                            "table"
                        ])) : m.tag_name === "tr" ? (f = f || this._tag_stack.try_pop("caption", [
                            "table"
                        ]), f = f || this._tag_stack.try_pop("colgroup", [
                            "table"
                        ]), f = f || this._tag_stack.try_pop("tr", [
                            "table",
                            "thead",
                            "tbody",
                            "tfoot"
                        ])) : (m.tag_name === "th" || m.tag_name === "td") && (f = f || this._tag_stack.try_pop("td", [
                            "table",
                            "thead",
                            "tbody",
                            "tfoot",
                        ...
                        return m.parent = this._tag_stack.get_parser_token(), f;
                    }
            ...
            function(e, t, n) {
                ...
                var r = n(6).Options;
                function i(a) {
                    r.call(this, a, "html"), this.templating.length === 1 && this.templating[0] === "auto" && (this.templating = [
                        "django",
                        "erb",
                        "handlebars",
                        "php"
            ...
            function(e, t, n) {
                "use strict";
                var r = n(9).Tokenizer, i = n(9).TOKEN, a = n(13).Directives, s = n(14).TemplatablePattern, o = n(12).Pattern, l = {
                    ...
                    RAW: i.RAW,
                    EOF: i.EOF
                }, u = new a(/<\!--/, /-->/), c = function(h, d) {
                    r.call(this, h, d), this._current_tag_name = "";
                    var p = new s(this._input).read_options(this._options), g = new o(this._input);
                    if (this.__patterns = {
                        word: p.until(/[\n\r\t <]/),
                ...
                c.prototype = new r, c.prototype._is_comment = function(h) {
                    return !1;
                }, c.prototype._is_opening = function(h) {
                    return h.type === l.TAG_OPEN;
                }, c.prototype._is_closing = function(h, d) {
                    return h.type === l.TAG_CLOSE && d && ((h.text === ">" || h.text === "/>") && d.text[0] === "<" || h.text === "}}" && d.text[0] === "{" && d.text[1] === "{");
                }, c.prototype._reset = function() {
                    this._current_tag_name = "";
                }, c.prototype._get_next_token = function(h, d) {
                    var p = null;
                    this._readWhitespace();
                    var g = this._input.peek();
                    return g === null ? this._create_token(l.EOF, "") : (p = p || this._read_open_handlebars(g, d), p = p || this._read_attribute(g, h, d), p = p || this._read_close(g, d), p = p || this._read_raw_content(g, h, d), p = p || this._read_content_word(g), p = p || this._read_comment_or_cdata(g), p = p || this._read_processing(g), p = p || this._read_open(g, d), p = p || this._create_token(l.UNKNOWN, this._input.next()), p);
                }, c.prototype._read_comment_or_cdata = function(h) {
                    var d = null, p = null, g = null;
                    if (h === "<") {
                        var _ = this._input.peek(1);
                        _ === "!" && (p = this.__patterns.comment.read(), p ? (g = u.get_directives(p), g && g.ignore === "start" && (p += u.readIgnored(this._input))) : p = this.__patterns.cdata.read()), p && (d = this._create_token(l.COMMENT, p), d.directives = g);
                    }
                    return d;
                }, c.prototype._read_processing = function(h) {
                    var d = null, p = null, g = null;
                    if (h === "<") {
                        var _ = this._input.peek(1);
                        (_ === "!" || _ === "?") && (p = this.__patterns.conditional_comment.read(), p = p || this.__patterns.processing.read()), p && (d = this._create_token(l.COMMENT, p), d.directives = g);
                    }
                    return d;
                }, c.prototype._read_open = function(h, d) {
                    var p = null, g = null;
                    return d || h === "<" && (p = this._input.next(), this._input.peek() === "/" && (p += this._input.next()), p += this.__patterns.element_name.read(), g = this._create_token(l.TAG_OPEN, p)), g;
                }, c.prototype._read_open_handlebars = function(h, d) {
                    var p = null, g = null;
                    return d || this._options.indent_handlebars && h === "{" && this._input.peek(1) === "{" && (this._input.peek(2) === "!" ? (p = this.__patterns.handlebars_comment.read(), p = p || this.__patterns.handlebars.read(), g = this._create_token(l.COMMENT, p)) : (p = this.__patterns.handlebars_open.read(), g = this._create_token(l.TAG_OPEN, p))), g;
                }, c.prototype._read_close = function(h, d) {
                    var p = null, g = null;
                    return d && (d.text[0] === "<" && (h === ">" || h === "/" && this._input.peek(1) === ">") ? (p = this._input.next(), h === "/" && (p += this._input.next()), g = this._create_token(l.TAG_CLOSE, p)) : d.text[0] === "{" && h === "}" && this._input.peek(1) === "}" && (this._input.next(), this._input.next(), g = this._create_token(l.TAG_CLOSE, "}}"))), g;
                }, c.prototype._read_attribute = function(h, d, p) {
                    var g = null, _ = "";
                    if (p && p.text[0] === "<") {
                        if (h === "=") g = this._create_token(l.EQUALS, this._input.next());
                        else if (h === '"' || h === "'") {
                            var k = this._input.next();
                            h === '"' ? k += this.__patterns.double_quote.read() : k += this.__patterns.single_quote.read(), g = this._create_token(l.VALUE, k);
                        } else _ = this.__patterns.attribute.read(), _ && (d.type === l.EQUALS ? g = this._create_token(l.VALUE, _) : g = this._create_token(l.ATTRIBUTE, _));
                    }
                    return g;
                }, c.prototype._is_content_unformatted = function(h) {
                ...
                }, c.prototype._read_raw_content = function(h, d, p) {
                    var g = "";
                    if (p && p.text[0] === "{") g = this.__patterns.handlebars_raw_close.read();
                    else if (d.type === l.TAG_CLOSE && d.opened.text[0] === "<" && d.text[0] !== "/") {
                        var _ = d.opened.text.substr(1).toLowerCase();
                        if (_ === "script" || _ === "style") {
                            var k = this._read_comment_or_cdata(h);
                            if (k) return k.type = l.TEXT, k;
                            g = this._input.readUntil(new RegExp("</" + _ + "[\\n\\r\\t ]*?>", "ig"));
                        } else this._is_content_unformatted(_) && (g = this._input.readUntil(new RegExp("</" + _ + "[\\n\\r\\t ]*?>", "ig")));
                    }
                    return g ? this._create_token(l.TEXT, g) : null;
                }, c.prototype._read_content_word = function(h) {
                    var d = "";
                    if (this._options.unformatted_content_delimiter && h === this._options.unformatted_content_delimiter[0] && (d = this.__patterns.unformatted_content_delimiter.read()), d || (d = this.__patterns.word.read()), d) return this._create_token(l.TEXT, d);
        ...
        function Uo(e, t, n) {
            var r = e.getText(), i = !0, a = 0, s = n.tabSize || 4;
            if (t) {
                for(var o = e.offsetAt(t.start), l = o; l > 0 && sa(r, l - 1);)l--;
                l === 0 || $n(r, l - 1) ? o = l : l < o && (o = l + 1);
                for(var u = e.offsetAt(t.end), c = u; c < r.length && sa(r, c);)c++;
                (c === r.length || $n(r, c)) && (u = c), t = V.create(e.positionAt(o), e.positionAt(u));
                var h = r.substring(0, o);
                if (new RegExp(/.*[<][^>]*$/).test(h)) return r = r.substring(o, u), [
                    {
                        range: t,
                        newText: r
                    }
                ];
                if (i = u === r.length, r = r.substring(o, u), o !== 0) {
                    var d = e.offsetAt(ae.create(t.start.line, 0));
                    a = zo(e.getText(), d, n);
                }
            } else t = V.create(ae.create(0, 0), e.positionAt(r.length));
            var p = {
                indent_size: s,
...
`,
            ...
            if (a > 0) {
                var _ = n.insertSpaces ? na(" ", s * a) : na("	", a);
                g = g.split(`
`).join(`
` + _), t.start.character === 0 && (g = _ + g);
            }
            return [
                {
                    range: t,
        ...
        function Vu(e) {
            var t = e.getText();
            if (e.lineCount > 1) {
                for(var n = e.offsetAt(Position.create(1, 0)), r = n; r > 0 && $n(t, r - 1);)r--;
...
`.indexOf(e.charAt(t)) !== -1;
        ...
        var Qn = Oe("./node_modules/process/browser.js"), oa;
        oa = (()=>{
            "use strict";
            var e = {
                470: (r)=>{
                    ...
                    function a(o, l) {
                        for(var u, c = "", h = 0, d = -1, p = 0, g = 0; g <= o.length; ++g){
                            if (g < o.length) u = o.charCodeAt(g);
                            else {
                                if (u === 47) break;
                                u = 47;
                            }
                            if (u === 47) {
                                if (!(d === g - 1 || p === 1)) {
                                    if (d !== g - 1 && p === 2) {
                                        if (c.length < 2 || h !== 2 || c.charCodeAt(c.length - 1) !== 46 || c.charCodeAt(c.length - 2) !== 46) {
                                            if (c.length > 2) {
                                                var _ = c.lastIndexOf("/");
                                                if (_ !== c.length - 1) {
                                                    _ === -1 ? (c = "", h = 0) : h = (c = c.slice(0, _)).length - 1 - c.lastIndexOf("/"), d = g, p = 0;
                                                    continue;
                                                }
                                    ...
                                    } else c.length > 0 ? c += "/" + o.slice(d + 1, g) : c = o.slice(d + 1, g), h = g - d - 1;
                                }
                                d = g, p = 0;
                            } else u === 46 && p !== -1 ? ++p : p = -1;
                        }
                    ...
                    var s = {
                        resolve: function() {
                            for(var o, l = "", u = !1, c = arguments.length - 1; c >= -1 && !u; c--){
                                var h;
                                c >= 0 ? h = arguments[c] : (o === void 0 && (o = Qn.cwd()), h = o), i(h), h.length !== 0 && (l = h + "/" + l, u = h.charCodeAt(0) === 47);
                            }
                        ...
                        relative: function(o, l) {
                            if (i(o), i(l), o === l || (o = s.resolve(o)) === (l = s.resolve(l))) return "";
                            for(var u = 1; u < o.length && o.charCodeAt(u) === 47; ++u);
                            for(var c = o.length, h = c - u, d = 1; d < l.length && l.charCodeAt(d) === 47; ++d);
                            for(var p = l.length - d, g = h < p ? h : p, _ = -1, k = 0; k <= g; ++k){
                                if (k === g) {
                                    if (p > g) {
                                        if (l.charCodeAt(d + k) === 47) return l.slice(d + k + 1);
                                        if (k === 0) return l.slice(d + k);
                                    } else h > g && (o.charCodeAt(u + k) === 47 ? _ = k : k === 0 && (_ = 0));
                                    break;
                                }
                                var U = o.charCodeAt(u + k);
                                if (U !== l.charCodeAt(d + k)) break;
                                U === 47 && (_ = k);
                            }
                            var v = "";
                            for(k = u + _ + 1; k <= c; ++k)k !== c && o.charCodeAt(k) !== 47 || (v.length === 0 ? v += ".." : v += "/..");
                            return v.length > 0 ? v + l.slice(d + _) : (d += _, l.charCodeAt(d) === 47 && ++d, l.slice(d));
                        },
                        ...
                        dirname: function(o) {
                            if (i(o), o.length === 0) return ".";
                            for(var l = o.charCodeAt(0), u = l === 47, c = -1, h = !0, d = o.length - 1; d >= 1; --d)if ((l = o.charCodeAt(d)) === 47) {
                                if (!h) {
                                    c = d;
                                    break;
                                }
                        ...
                        basename: function(o, l) {
                            ...
                            if (l !== void 0 && l.length > 0 && l.length <= o.length) {
                                ...
                                for(u = o.length - 1; u >= 0; --u){
                                    ...
                                    } else g === -1 && (d = !1, g = u + 1), p >= 0 && (_ === l.charCodeAt(p) ? --p == -1 && (h = u) : (p = -1, h = g));
                                }
                                return c === h ? h = g : h === -1 && (h = o.length), o.slice(c, h);
                            }
                            for(u = o.length - 1; u >= 0; --u)if (o.charCodeAt(u) === 47) {
                                if (!d) {
                                    c = u + 1;
                                    break;
                                }
                        ...
                        extname: function(o) {
                            i(o);
                            for(var l = -1, u = 0, c = -1, h = !0, d = 0, p = o.length - 1; p >= 0; --p){
                                var g = o.charCodeAt(p);
                                if (g !== 47) c === -1 && (h = !1, c = p + 1), g === 46 ? l === -1 ? l = p : d !== 1 && (d = 1) : l !== -1 && (d = -1);
                                else if (!h) {
                                    u = p + 1;
                                    break;
                                }
                        ...
                        parse: function(o) {
                            ...
                            h ? (l.root = "/", u = 1) : u = 0;
                            for(var d = -1, p = 0, g = -1, _ = !0, k = o.length - 1, U = 0; k >= u; --k)if ((c = o.charCodeAt(k)) !== 47) g === -1 && (_ = !1, g = k + 1), c === 46 ? d === -1 ? d = k : U !== 1 && (U = 1) : d !== -1 && (U = -1);
                            else if (!_) {
                                p = k + 1;
                                break;
                            }
                            return d === -1 || g === -1 || U === 0 || U === 1 && d === g - 1 && d === p + 1 ? g !== -1 && (l.base = l.name = p === 0 && h ? o.slice(1, g) : o.slice(p, g)) : (p === 0 && h ? (l.name = o.slice(1, d), l.base = o.slice(1, g)) : (l.name = o.slice(p, d), l.base = o.slice(p, g)), l.ext = o.slice(d, g)), p > 0 ? l.dir = o.slice(0, p - 1) : h && (l.dir = "/"), l;
                        },
                        sep: "/",
                        delimiter: ":",
                        win32: null,
                ...
                447: (r, i, a)=>{
                    ...
                    if (a.r(i), a.d(i, {
                        URI: ()=>U,
                        Utils: ()=>x
                    }), typeof Qn == "object") s = Qn.platform === "win32";
                    else if (typeof navigator == "object") {
                        var o = navigator.userAgent;
                        s = o.indexOf("Windows") >= 0;
                    }
                    var l, u, c = (l = function(S, y) {
                        return (l = Object.setPrototypeOf || ({
                            __proto__: []
                        }) instanceof Array && function(A, M) {
                            A.__proto__ = M;
                        } || function(A, M) {
                            for(var R in M)Object.prototype.hasOwnProperty.call(M, R) && (A[R] = M[R]);
                        })(S, y);
                    }, function(S, y) {
                        function A() {
                            this.constructor = S;
                        }
                        l(S, y), S.prototype = y === null ? Object.create(y) : (A.prototype = y.prototype, new A);
                    }), h = /^\w[\w\d+.-]*$/, d = /^\//, p = /^\/\//, g = "", _ = "/", k = /^(([^:/?#]+?):)?(\/\/([^/?#]*))?([^?#]*)(\?([^#]*))?(#(.*))?/, U = function() {
                        function S(y, A, M, R, L, N) {
                            N === void 0 && (N = !1), typeof y == "object" ? (this.scheme = y.scheme || g, this.authority = y.authority || g, this.path = y.path || g, this.query = y.query || g, this.fragment = y.fragment || g) : (this.scheme = function(F, O) {
                                return F || O ? F : "file";
                            }(y, N), this.authority = A || g, this.path = function(F, O) {
                                switch(F){
                                    case "https":
                                    case "http":
                                    case "file":
                                ...
                                return O;
                            }(this.scheme, M || g), this.query = R || g, this.fragment = L || g, function(F, O) {
                                if (!F.scheme && O) throw new Error('[UriError]: Scheme is missing: {scheme: "", authority: "' + F.authority + '", path: "' + F.path + '", query: "' + F.query + '", fragment: "' + F.fragment + '"}');
                                if (F.scheme && !h.test(F.scheme)) throw new Error("[UriError]: Scheme contains illegal characters.");
                                if (F.path) {
                                    if (F.authority) {
                                        if (!d.test(F.path)) throw new Error('[UriError]: If a URI contains an authority component, then the path component must either be empty or begin with a slash ("/") character');
                                    } else if (p.test(F.path)) throw new Error('[UriError]: If a URI does not contain an authority component, then the path cannot begin with two slash characters ("//")');
                                }
                            }(this, N));
                        }
                        return S.isUri = function(y) {
                            return y instanceof S || !!y && typeof y.authority == "string" && typeof y.fragment == "string" && typeof y.path == "string" && typeof y.query == "string" && typeof y.scheme == "string" && typeof y.fsPath == "function" && typeof y.with == "function" && typeof y.toString == "function";
                            ...
                            enumerable: !1,
                            configurable: !0
                        }), S.prototype.with = function(y) {
                            if (!y) return this;
                            var A = y.scheme, M = y.authority, R = y.path, L = y.query, N = y.fragment;
                            return A === void 0 ? A = this.scheme : A === null && (A = g), M === void 0 ? M = this.authority : M === null && (M = g), R === void 0 ? R = this.path : R === null && (R = g), L === void 0 ? L = this.query : L === null && (L = g), N === void 0 ? N = this.fragment : N === null && (N = g), A === this.scheme && M === this.authority && R === this.path && L === this.query && N === this.fragment ? this : new m(A, M, R, L, N);
                        }, S.parse = function(y, A) {
                            A === void 0 && (A = !1);
                            var M = k.exec(y);
                            return M ? new m(M[2] || g, H(M[4] || g), H(M[5] || g), H(M[7] || g), H(M[9] || g), A) : new m(g, g, g, g, g);
                        }, S.file = function(y) {
                            var A = g;
                            if (s && (y = y.replace(/\\/g, _)), y[0] === _ && y[1] === _) {
                                var M = y.indexOf(_, 2);
                                M === -1 ? (A = y.substring(2), y = _) : (A = y.substring(2, M), y = y.substring(M) || _);
                            }
                            return new m("file", A, y, g, g);
                        }, S.from = function(y) {
                            return new m(y.scheme, y.authority, y.path, y.query, y.fragment);
                        }, S.prototype.toString = function(y) {
                            return y === void 0 && (y = !1), E(this, y);
                        }, S.prototype.toJSON = function() {
                            return this;
                        }, S.revive = function(y) {
                            if (y) {
                                if (y instanceof S) return y;
                                var A = new m(y);
                                return A._formatted = y.external, A._fsPath = y._sep === v ? y.fsPath : null, A;
                            }
                            return y;
                        }, S;
                    }(), v = s ? 1 : void 0, m = function(S) {
                        function y() {
                            var A = S !== null && S.apply(this, arguments) || this;
                            return A._formatted = null, A._fsPath = null, A;
                        }
                        return c(y, S), Object.defineProperty(y.prototype, "fsPath", {
                            get: function() {
                            ...
                            return A === void 0 && (A = !1), A ? E(this, !0) : (this._formatted || (this._formatted = E(this, !1)), this._formatted);
                    ...
                    }(U), f = ((u = {})[58] = "%3A", u[47] = "%2F", u[63] = "%3F", u[35] = "%23", u[91] = "%5B", u[93] = "%5D", u[64] = "%40", u[33] = "%21", u[36] = "%24", u[38] = "%26", u[39] = "%27", u[40] = "%28", u[41] = "%29", u[42] = "%2A", u[43] = "%2B", u[44] = "%2C", u[59] = "%3B", u[61] = "%3D", u[32] = "%20", u);
                    function b(S, y) {
                        for(var A = void 0, M = -1, R = 0; R < S.length; R++){
                            var L = S.charCodeAt(R);
                            if (L >= 97 && L <= 122 || L >= 65 && L <= 90 || L >= 48 && L <= 57 || L === 45 || L === 46 || L === 95 || L === 126 || y && L === 47) M !== -1 && (A += encodeURIComponent(S.substring(M, R)), M = -1), A !== void 0 && (A += S.charAt(R));
                            else {
                                A === void 0 && (A = S.substr(0, R));
                                var N = f[L];
                                N !== void 0 ? (M !== -1 && (A += encodeURIComponent(S.substring(M, R)), M = -1), A += N) : M === -1 && (M = R);
                            }
                        }
                        return M !== -1 && (A += encodeURIComponent(S.substring(M))), A !== void 0 ? A : S;
                    }
                    function C(S) {
                        for(var y = void 0, A = 0; A < S.length; A++){
                            var M = S.charCodeAt(A);
                            M === 35 || M === 63 ? (y === void 0 && (y = S.substr(0, A)), y += f[M]) : y !== void 0 && (y += S[A]);
                        }
                        return y !== void 0 ? y : S;
                    }
                    function T(S, y) {
                        var A;
                        return A = S.authority && S.path.length > 1 && S.scheme === "file" ? "//" + S.authority + S.path : S.path.charCodeAt(0) === 47 && (S.path.charCodeAt(1) >= 65 && S.path.charCodeAt(1) <= 90 || S.path.charCodeAt(1) >= 97 && S.path.charCodeAt(1) <= 122) && S.path.charCodeAt(2) === 58 ? y ? S.path.substr(1) : S.path[1].toLowerCase() + S.path.substr(2) : S.path, s && (A = A.replace(/\//g, "\\")), A;
                    }
                    function E(S, y) {
                        var A = y ? C : b, M = "", R = S.scheme, L = S.authority, N = S.path, F = S.query, O = S.fragment;
                        if (R && (M += R, M += ":"), (L || R === "file") && (M += _, M += _), L) {
                            var G = L.indexOf("@");
                            if (G !== -1) {
                                var X = L.substr(0, G);
                                L = L.substr(G + 1), (G = X.indexOf(":")) === -1 ? M += A(X, !1) : (M += A(X.substr(0, G), !1), M += ":", M += A(X.substr(G + 1), !1)), M += "@";
                            }
                            (G = (L = L.toLowerCase()).indexOf(":")) === -1 ? M += A(L, !1) : (M += A(L.substr(0, G), !1), M += L.substr(G));
                        }
                        if (N) {
                            if (N.length >= 3 && N.charCodeAt(0) === 47 && N.charCodeAt(2) === 58) (te = N.charCodeAt(1)) >= 65 && te <= 90 && (N = "/" + String.fromCharCode(te + 32) + ":" + N.substr(3));
                            else if (N.length >= 2 && N.charCodeAt(1) === 58) {
                                var te;
                                (te = N.charCodeAt(0)) >= 65 && te <= 90 && (N = String.fromCharCode(te + 32) + ":" + N.substr(2));
                            }
                            M += A(N, !0);
                        }
                        return F && (M += "?", M += A(F, !1)), O && (M += "#", M += y ? O : b(O, !1)), M;
                    }
                    function I(S) {
                        try {
                    ...
                    function H(S) {
                        return S.match(z) ? S.replace(z, function(y) {
                            return I(y);
                        }) : S;
                    }
                    var x, W = a(470), B = function() {
                        for(var S = 0, y = 0, A = arguments.length; y < A; y++)S += arguments[y].length;
                        var M = Array(S), R = 0;
                        for(y = 0; y < A; y++)for(var L = arguments[y], N = 0, F = L.length; N < F; N++, R++)M[R] = L[N];
                        return M;
                    }, j = W.posix || W;
                    (function(S) {
                        S.joinPath = function(y) {
                            for(var A = [], M = 1; M < arguments.length; M++)A[M - 1] = arguments[M];
                            return y.with({
                                path: j.join.apply(j, B([
                                    y.path
                                ], A))
                            });
                        }, S.resolvePath = function(y) {
                            for(var A = [], M = 1; M < arguments.length; M++)A[M - 1] = arguments[M];
                            var R = y.path || "/";
                            return y.with({
                                path: j.resolve.apply(j, B([
                                    R
                                ], A))
                            });
                        }, S.dirname = function(y) {
                            var A = j.dirname(y.path);
                            return A.length === 1 && A.charCodeAt(0) === 46 ? y : y.with({
                                path: A
                            });
                        }, S.basename = function(y) {
                            return j.basename(y.path);
                        }, S.extname = function(y) {
                            return j.extname(y.path);
                        };
                    })(x || (x = {}));
                }
            }, t = {};
            ...
            return n.d = (r, i)=>{
                for(var a in i)n.o(i, a) && !n.o(r, a) && Object.defineProperty(r, a, {
                    enumerable: !0,
                    get: i[a]
                });
        ...
        function Bo(e, t, n, r, i, a) {
            var s = Xn(n);
            if (!!Fo(s, e.languageId)) {
                s.length < n.length && (r++, i--);
                var o = Po(e.uri, s, t, a);
                if (!(!o || !qo(o))) return {
        ...
        function Oo(e, t) {
            for(var n = [], r = be(e.getText(), 0), i = r.scan(), a = void 0, s = !1, o = void 0, l = {}; i !== D.EOS;){
                switch(i){
                    case D.StartTag:
                        if (!o) {
                            var u = r.getTokenText().toLowerCase();
                            s = u === "base";
                        }
                        break;
                    case D.AttributeName:
                    ...
                    case D.AttributeValue:
                        if (a === "src" || a === "href") {
                            ...
                            if (!s) {
                                var h = Bo(e, t, c, r.getTokenOffset(), r.getTokenEnd(), o);
                                h && n.push(h);
                            }
                            s && typeof o == "undefined" && (o = Xn(c), o && t && (o = t.resolveReference(o, e.uri))), s = !1, a = void 0;
                        } else if (a === "id") {
                            var d = Xn(r.getTokenText());
                            l[d] = r.getTokenOffset();
                        }
                        break;
                }
                i = r.scan();
            ...
            for(var p = 0, g = n; p < g.length; p++){
                var h = g[p], _ = e.uri + "#";
                if (h.target && Be(h.target, _)) {
                    var k = h.target.substr(_.length), U = l[k];
                    if (U !== void 0) {
                        var v = e.positionAt(U);
                        h.target = "" + _ + (v.line + 1) + "," + (v.character + 1);
                    }
                }
            }
            return n;
        ...
        function jo(e, t, n) {
            ...
            if (!i.tag) return [];
            var a = [], s = ca(D.StartTag, e, i.start), o = typeof i.endTagStart == "number" && ca(D.EndTag, e, i.endTagStart);
            return (s && ua(s, t) || o && ua(o, t)) && (s && a.push({
                kind: $t.Read,
                range: s
            }), o && a.push({
                kind: $t.Read,
        ...
        function ua(e, t) {
            return la(e.start, t) && la(t, e.end);
        }
        function ca(e, t, n) {
            for(var r = be(t.getText(), n), i = r.scan(); i !== D.EOS && i !== e;)i = r.scan();
            return i !== D.EOS ? {
        ...
        function ha(e, t, n, r) {
            var i = Vo(t), a = Bt.create(e.uri, V.create(e.positionAt(t.start), e.positionAt(t.end))), s = {
                name: i,
                location: a,
                containerName: n,
                kind: qn.Field
            };
            r.push(s), t.children.forEach(function(o) {
                ha(e, o, i, r);
            });
        }
        function Vo(e) {
            ...
            if (e.attributes) {
                ...
                n && (t += "#" + n.replace(/[\"\']/g, "")), r && (t += r.replace(/[\"\']/g, "").split(/\s+/).map(function(i) {
                    return "." + i;
                }).join(""));
            }
            return t || "?";
        ...
        function Yo(e, t, n, r) {
            var i, a = e.offsetAt(t), s = r.findNodeAt(a);
            if (!s.tag || !$o(s, a, s.tag)) return null;
            var o = [], l = {
        ...
        function da(e, t, n) {
            var r = e.offsetAt(t), i = n.findNodeAt(r), a = i.tag ? i.tag.length : 0;
            return i.endTagStart && (i.start + 1 <= r && r <= i.start + 1 + a || i.endTagStart + 2 <= r && r <= i.endTagStart + 2 + a) ? [
                V.create(e.positionAt(i.start + 1), e.positionAt(i.start + 1 + a)),
                V.create(e.positionAt(i.endTagStart + 2), e.positionAt(i.endTagStart + 2 + a))
            ] : null;
        }
        function Xo(e, t) {
            e = e.sort(function(g, _) {
                var k = g.startLine - _.startLine;
                return k === 0 && (k = g.endLine - _.endLine), k;
            });
            for(var n = void 0, r = [], i = [], a = [], s = function(g, _) {
                i[g] = _, _ < 30 && (a[_] = (a[_] || 0) + 1);
            }, o = 0; o < e.length; o++){
                var l = e[o];
                if (!n) n = l, s(o, 0);
                else if (l.startLine > n.startLine) {
                    if (l.endLine <= n.endLine) r.push(n), n = l, s(o, r.length);
                    else if (l.startLine > n.endLine) {
                        do n = r.pop();
                        while (n && l.startLine > n.endLine);
                        n && r.push(n), n = l, s(o, r.length);
                    }
                }
            }
            ...
            for(var d = [], o = 0; o < e.length; o++){
                var p = i[o];
                typeof p == "number" && (p < c || p === c && u++ < t) && d.push(e[o]);
            }
            return d;
        }
        function Jo(e, t) {
            var n = be(e.getText()), r = n.scan(), i = [], a = [], s = null, o = -1;
            function l(v) {
                i.push(v), o = v.startLine;
            }
            for(; r !== D.EOS;){
                switch(r){
                    case D.StartTag:
                    ...
                    case D.EndTagClose:
                    case D.StartTagSelfClose:
                        for(var h = a.length - 1; h >= 0 && a[h].tagName !== s;)h--;
                        if (h >= 0) {
                            var d = a[h];
                            a.length = h;
                            var p = e.positionAt(n.getTokenOffset()).line, c = d.startLine, g = p - 1;
                            g > c && o !== c && l({
                                startLine: c,
                                endLine: g
                            });
                        ...
                        break;
                    case D.Comment:
                        var c = e.positionAt(n.getTokenOffset()).line, _ = n.getTokenText(), k = _.match(/^\s*#(region\b)|(endregion\b)/);
                        if (k) {
                            if (k[1]) a.push({
                                startLine: c,
                                tagName: ""
            ...
            var U = t && t.rangeLimit || Number.MAX_VALUE;
            return i.length > U ? Xo(i, U) : i;
        }
        function Zo(e, t) {
            function n(r) {
                for(var i = Ko(e, r), a = void 0, s = void 0, o = i.length - 1; o >= 0; o--){
                    var l = i[o];
                    (!a || l[0] !== a[0] || l[1] !== a[1]) && (s = Qt.create(V.create(e.positionAt(i[o][0]), e.positionAt(i[o][1])), s)), a = l;
                }
                return s || (s = Qt.create(V.create(r, r))), s;
            }
            return t.map(n);
        }
        function Ko(e, t) {
            var n = ta(e.getText()), r = e.offsetAt(t), i = n.findNodeAt(r), a = el(i);
            if (i.startTagEnd && !i.endTagStart) {
                if (i.startTagEnd !== i.end) return [
                    [
                        i.start,
                        i.end
                    ]
                ];
                var s = V.create(e.positionAt(i.startTagEnd - 2), e.positionAt(i.startTagEnd)), o = e.getText(s);
                o === "/>" ? a.unshift([
                    i.start + 1,
                    i.startTagEnd - 2
                ]) : a.unshift([
            ...
            if (a.unshift([
                ...
                var l = fa(e, i, r);
                return a = l.concat(a), a;
            } else return i.startTagEnd <= r && r <= i.endTagStart ? (a.unshift([
                i.startTagEnd,
                i.endTagStart
            ]), a) : (r >= i.endTagStart + 2 && a.unshift([
                i.endTagStart + 2,
                i.end - 1
            ]), a);
        }
        function el(e) {
            ...
            }, r = []; t.parent;)t = t.parent, n(t).forEach(function(i) {
                return r.push(i);
            });
            return r;
        }
        function fa(e, t, n) {
            for(var r = V.create(e.positionAt(t.start), e.positionAt(t.end)), i = e.getText(r), a = n - t.start, s = be(i), o = s.scan(), l = t.start, u = [], c = !1, h = -1; o !== D.EOS;){
                switch(o){
                    case D.AttributeName:
                        ...
                        a <= s.getTokenEnd() && u.unshift([
                            s.getTokenOffset(),
                            s.getTokenEnd()
                        ]), c = !0, h = s.getTokenOffset();
                        break;
                    case D.AttributeValue:
                        if (!c) break;
                        var d = s.getTokenText();
                        if (a < s.getTokenOffset()) {
                            u.push([
                                h,
                                s.getTokenEnd()
                        ...
                        a >= s.getTokenOffset() && a <= s.getTokenEnd() && (u.unshift([
                            s.getTokenOffset(),
                            s.getTokenEnd()
                        ]), (d[0] === '"' && d[d.length - 1] === '"' || d[0] === "'" && d[d.length - 1] === "'") && a >= s.getTokenOffset() + 1 && a <= s.getTokenEnd() - 1 && u.unshift([
                            s.getTokenOffset() + 1,
                            s.getTokenEnd() - 1
                        ]), u.push([
                            h,
...
*   a _positive value_ means that the element should be focusable and reachable via sequential keyboard navigation; the order in which the elements are focused is the increasing value of the [**tabindex**](#attr-tabindex). If several elements share the same tabindex, their relative order follows their relative positions in the document.`
            ...
            return e.prototype.setDataProviders = function(t, n) {
                var r;
                this.dataProviders = [], t && this.dataProviders.push(new lo("html5", tl)), (r = this.dataProviders).push.apply(r, n);
        ...
        function il(e) {
            e === void 0 && (e = rl);
            var t = new nl(e), n = new Lo(e, t), r = new To(e, t);
            return {
                ...
                format: Uo,
                findDocumentHighlights: jo,
                findDocumentLinks: Oo,
                findDocumentSymbols: Go,
                getFoldingRanges: Jo,
                getSelectionRanges: Zo,
                doTagComplete: r.doTagComplete.bind(r),
                doRename: Yo,
                findMatchingTagPosition: Qo,
                findOnTypeRenameRanges: da,
                findLinkedEditingRanges: da
            };
        }
        function al(e, t) {
            return new HTMLDataProvider(e, t);
        }
        function Qu() {
            return al("default", htmlData);
        }
        var en = function() {
            ...
            function e(t, n) {
                this._ctx = t, this._languageSettings = n.languageSettings, this._languageId = n.languageId, this._languageService = il();
            }
            return e.prototype.doValidation = function(t) {
            ...
            }, e.prototype.doComplete = function(t, n) {
                return Le(this, void 0, void 0, function() {
                    var r, i;
                    return De(this, function(a) {
                        return r = this._getTextDocument(t), i = this._languageService.parseHTMLDocument(r), [
                            2,
                            Promise.resolve(this._languageService.doComplete(r, n, i, this._languageSettings && this._languageSettings.suggest))
                        ];
                    });
                });
                ...
                return Le(this, void 0, void 0, function() {
                    ...
                    return De(this, function(o) {
                        return i = this._getTextDocument(t), a = en(en({}, this._languageSettings.format), r), s = this._languageService.format(i, n, a), [
                            2,
                            Promise.resolve(s)
                        ];
                    });
                ...
                return Le(this, void 0, void 0, function() {
                    ...
                    return De(this, function(s) {
                        return r = this._getTextDocument(t), i = this._languageService.parseHTMLDocument(r), a = this._languageService.doHover(r, n, i), [
                            2,
                            Promise.resolve(a)
                        ];
                    });
                ...
                return Le(this, void 0, void 0, function() {
                    var r, i, a;
                    return De(this, function(s) {
                        return r = this._getTextDocument(t), i = this._languageService.parseHTMLDocument(r), a = this._languageService.findDocumentHighlights(r, n, i), [
                            2,
                            Promise.resolve(a)
                        ];
                    });
                ...
                return Le(this, void 0, void 0, function() {
                    ...
                    return De(this, function(i) {
                        return n = this._getTextDocument(t), r = this._languageService.findDocumentLinks(n, null), [
                            2,
                            Promise.resolve(r)
                        ];
                    });
                ...
                return Le(this, void 0, void 0, function() {
                    var n, r, i;
                    return De(this, function(a) {
                        return n = this._getTextDocument(t), r = this._languageService.parseHTMLDocument(n), i = this._languageService.findDocumentSymbols(n, r), [
                            2,
                            Promise.resolve(i)
                        ];
                    });
                ...
                return Le(this, void 0, void 0, function() {
                    var r, i;
                    return De(this, function(a) {
                        return r = this._getTextDocument(t), i = this._languageService.getFoldingRanges(r, n), [
                            2,
                            Promise.resolve(i)
                        ];
                    });
                ...
                return Le(this, void 0, void 0, function() {
                    var r, i;
                    return De(this, function(a) {
                        return r = this._getTextDocument(t), i = this._languageService.getSelectionRanges(r, n), [
                            2,
                            Promise.resolve(i)
                        ];
                    });
                ...
                return Le(this, void 0, void 0, function() {
                    var i, a, s;
                    return De(this, function(o) {
                        return i = this._getTextDocument(t), a = this._languageService.parseHTMLDocument(i), s = this._languageService.doRename(i, n, r, a), [
                            2,
                            Promise.resolve(s)
                        ];
                    });
                ...
                for(var n = this._ctx.getMirrorModels(), r = 0, i = n; r < i.length; r++){
                    var a = i[r];
                    if (a.uri.toString() === t) return On.create(t, this._languageId, a.version, a.getValue());
                }
                return null;
            }, e;
        }();
...
},{}]},["3F5J7","chrle"], "chrle", "parcelRequirec5e9")
