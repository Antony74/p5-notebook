...
})({"idf5y":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "9e16e49b497ac2e5";
"use strict";
...
},{}],"dmVef":[function(require,module,exports) {
"use strict";
(self.webpackChunkstarboard_notebook = self.webpackChunkstarboard_notebook || []).push([
    ...
    {
        "./node_modules/monaco-editor/esm/vs/language/html/htmlMode.js": (Ii, Ze, xe)=>{
            xe.r(Ze), xe.d(Ze, {
                setupMode: ()=>Ri,
                setupMode1: ()=>Mi
            });
            var W = xe("./node_modules/monaco-editor/esm/vs/language/html/fillers/monaco-editor-core.js"), gn = 120000, et = function() {
                function t(a) {
                    var o = this;
                    this._defaults = a, this._worker = null, this._idleCheckInterval = setInterval(function() {
                        return o._checkIfIdle();
                    }, 30000), this._lastUsedTime = 0, this._configChangeListener = this._defaults.onDidChange(function() {
                        return o._stopWorker();
                    });
                }
                return t.prototype._stopWorker = function() {
                ...
                }, t.prototype._checkIfIdle = function() {
                    if (!!this._worker) {
                        var a = Date.now() - this._lastUsedTime;
                        a > gn && this._stopWorker();
                    }
                }, t.prototype._getClient = function() {
                    return this._lastUsedTime = Date.now(), this._client || (this._worker = W.j6.createWebWorker({
                    ...
                    for(var a = this, o = [], i = 0; i < arguments.length; i++)o[i] = arguments[i];
                    var e;
                    return this._getClient().then(function(r) {
                        e = r;
                    }).then(function(r) {
                        return a._worker.withSyncedResources(o);
                    }).then(function(r) {
                        return e;
                    });
                }, t;
            ...
            function bn(t, a) {
                var o;
                return a.length === 0 ? o = t : o = t.replace(/\{(\d+)\}/g, function(i, e) {
                    var r = e[0];
                    return typeof a[r] != "undefined" ? a[r] : i;
                }), o;
            }
            function vn(t, a) {
            ...
            (function(t) {
                function a(i, e) {
                    return i === Number.MAX_VALUE && (i = Ee.MAX_VALUE), e === Number.MAX_VALUE && (e = Ee.MAX_VALUE), {
                        line: i,
                        character: e
                    };
                }
            ...
            (function(t) {
                function a(i, e, r, n) {
                    if (w.uinteger(i) && w.uinteger(e) && w.uinteger(r) && w.uinteger(n)) return {
                        start: Q.create(i, e),
                        end: Q.create(r, n)
                    };
                    if (Q.is(i) && Q.is(e)) return {
                        start: i,
                        end: e
                    };
                    throw new Error("Range#create called with invalid arguments[" + i + ", " + e + ", " + r + ", " + n + "]");
                }
                t.create = a;
                function o(i) {
                    var e = i;
            ...
            (function(t) {
                ...
                function o(i) {
                    var e = i;
                    return w.defined(e) && X.is(e.range) && (w.string(e.uri) || w.undefined(e.uri));
                }
                t.is = o;
            })(Be || (Be = {}));
            var nt;
            (function(t) {
                ...
                function o(i) {
                    var e = i;
                    return w.defined(e) && X.is(e.targetRange) && w.string(e.targetUri) && (X.is(e.targetSelectionRange) || w.undefined(e.targetSelectionRange)) && (X.is(e.originSelectionRange) || w.undefined(e.originSelectionRange));
                }
                t.is = o;
            })(nt || (nt = {}));
            var Fe;
            (function(t) {
                ...
                function o(i) {
                    var e = i;
                    return w.numberRange(e.red, 0, 1) && w.numberRange(e.green, 0, 1) && w.numberRange(e.blue, 0, 1) && w.numberRange(e.alpha, 0, 1);
                }
                t.is = o;
            })(Fe || (Fe = {}));
            var it;
            (function(t) {
                ...
                function o(i) {
                    var e = i;
                    return X.is(e.range) && Fe.is(e.color);
                }
                t.is = o;
            })(it || (it = {}));
            var rt;
            (function(t) {
                ...
                function o(i) {
                    var e = i;
                    return w.string(e.label) && (w.undefined(e.textEdit) || $.is(e)) && (w.undefined(e.additionalTextEdits) || w.typedArray(e.additionalTextEdits, $.is));
                }
                t.is = o;
            })(rt || (rt = {}));
            var be;
            ...
            var at;
            (function(t) {
                function a(i, e, r, n, s) {
                    var l = {
                        startLine: i,
                        endLine: e
                    };
                    return w.defined(r) && (l.startCharacter = r), w.defined(n) && (l.endCharacter = n), w.defined(s) && (l.kind = s), l;
                }
                t.create = a;
                function o(i) {
                    var e = i;
                    return w.uinteger(e.startLine) && w.uinteger(e.startLine) && (w.undefined(e.startCharacter) || w.uinteger(e.startCharacter)) && (w.undefined(e.endCharacter) || w.uinteger(e.endCharacter)) && (w.undefined(e.kind) || w.string(e.kind));
                }
                t.is = o;
            })(at || (at = {}));
            var Pe;
            (function(t) {
                ...
                function o(i) {
                    var e = i;
                    return w.defined(e) && Be.is(e.location) && w.string(e.message);
                }
                t.is = o;
            })(Pe || (Pe = {}));
            var de;
            ...
            (function(t) {
                function a(o) {
                    var i = o;
                    return i != null && w.string(i.href);
                }
                t.is = a;
            })(st || (st = {}));
            var Ce;
            (function(t) {
                function a(i, e, r, n, s, l) {
                    var u = {
                        range: i,
                        message: e
                    };
                    return w.defined(r) && (u.severity = r), w.defined(n) && (u.code = n), w.defined(s) && (u.source = s), w.defined(l) && (u.relatedInformation = l), u;
                }
                t.create = a;
                function o(i) {
                    var e, r = i;
                    return w.defined(r) && X.is(r.range) && w.string(r.message) && (w.number(r.severity) || w.undefined(r.severity)) && (w.integer(r.code) || w.string(r.code) || w.undefined(r.code)) && (w.undefined(r.codeDescription) || w.string((e = r.codeDescription) === null || e === void 0 ? void 0 : e.href)) && (w.string(r.source) || w.undefined(r.source)) && (w.undefined(r.relatedInformation) || w.typedArray(r.relatedInformation, Pe.is));
                }
                t.is = o;
            })(Ce || (Ce = {}));
            var ve;
            (function(t) {
                function a(i, e) {
                    ...
                    return w.defined(r) && r.length > 0 && (s.arguments = r), s;
                }
                t.create = a;
                function o(i) {
                    var e = i;
            ...
            (function(t) {
                ...
                function e(r) {
                    var n = r;
                    return w.objectLiteral(n) && w.string(n.newText) && X.is(n.range);
                }
                t.is = e;
            })($ || ($ = {}));
            var pe;
            (function(t) {
                function a(i, e, r) {
                    ...
                    return e !== void 0 && (n.needsConfirmation = e), r !== void 0 && (n.description = r), n;
                }
                t.create = a;
                function o(i) {
                    var e = i;
                    return e !== void 0 && w.objectLiteral(e) && w.string(e.label) && (w.boolean(e.needsConfirmation) || e.needsConfirmation === void 0) && (w.string(e.description) || e.description === void 0);
                }
                t.is = o;
            })(pe || (pe = {}));
            var Z;
            ...
            (function(t) {
                ...
                function e(r) {
                    var n = r;
                    return $.is(n) && (pe.is(n.annotationId) || Z.is(n.annotationId));
                }
                t.is = e;
            })(se || (se = {}));
            var Le;
            (function(t) {
                ...
                function o(i) {
                    var e = i;
                    return w.defined(e) && Re.is(e.textDocument) && Array.isArray(e.edits);
                }
                t.is = o;
            })(Le || (Le = {}));
            var we;
            (function(t) {
                function a(i, e, r) {
                    ...
                    return e !== void 0 && (e.overwrite !== void 0 || e.ignoreIfExists !== void 0) && (n.options = e), r !== void 0 && (n.annotationId = r), n;
                }
                t.create = a;
                function o(i) {
                    var e = i;
                    return e && e.kind === "create" && w.string(e.uri) && (e.options === void 0 || (e.options.overwrite === void 0 || w.boolean(e.options.overwrite)) && (e.options.ignoreIfExists === void 0 || w.boolean(e.options.ignoreIfExists))) && (e.annotationId === void 0 || Z.is(e.annotationId));
                }
                t.is = o;
            })(we || (we = {}));
            var _e;
            (function(t) {
                function a(i, e, r, n) {
                    ...
                    return r !== void 0 && (r.overwrite !== void 0 || r.ignoreIfExists !== void 0) && (s.options = r), n !== void 0 && (s.annotationId = n), s;
                }
                t.create = a;
                function o(i) {
                    var e = i;
                    return e && e.kind === "rename" && w.string(e.oldUri) && w.string(e.newUri) && (e.options === void 0 || (e.options.overwrite === void 0 || w.boolean(e.options.overwrite)) && (e.options.ignoreIfExists === void 0 || w.boolean(e.options.ignoreIfExists))) && (e.annotationId === void 0 || Z.is(e.annotationId));
                }
                t.is = o;
            })(_e || (_e = {}));
            var ye;
            (function(t) {
                function a(i, e, r) {
                    ...
                    return e !== void 0 && (e.recursive !== void 0 || e.ignoreIfNotExists !== void 0) && (n.options = e), r !== void 0 && (n.annotationId = r), n;
                }
                t.create = a;
                function o(i) {
                    var e = i;
                    return e && e.kind === "delete" && w.string(e.uri) && (e.options === void 0 || (e.options.recursive === void 0 || w.boolean(e.options.recursive)) && (e.options.ignoreIfNotExists === void 0 || w.boolean(e.options.ignoreIfNotExists))) && (e.annotationId === void 0 || Z.is(e.annotationId));
                }
                t.is = o;
            })(ye || (ye = {}));
            var Ne;
            (function(t) {
                function a(o) {
                    var i = o;
                    return i && (i.changes !== void 0 || i.documentChanges !== void 0) && (i.documentChanges === void 0 || i.documentChanges.every(function(e) {
                        return w.string(e.kind) ? we.is(e) || _e.is(e) || ye.is(e) : Le.is(e);
                    }));
                }
                t.is = a;
            })(Ne || (Ne = {}));
            var Me = function() {
                function t(a, o) {
                    this.edits = a, this.changeAnnotations = o;
                }
                return t.prototype.insert = function(a, o, i) {
                    var e, r;
                    if (i === void 0 ? e = $.insert(a, o) : Z.is(i) ? (r = i, e = se.insert(a, o, i)) : (this.assertChangeAnnotations(this.changeAnnotations), r = this.changeAnnotations.manage(i), e = se.insert(a, o, r)), this.edits.push(e), r !== void 0) return r;
                }, t.prototype.replace = function(a, o, i) {
                    var e, r;
                    if (i === void 0 ? e = $.replace(a, o) : Z.is(i) ? (r = i, e = se.replace(a, o, i)) : (this.assertChangeAnnotations(this.changeAnnotations), r = this.changeAnnotations.manage(i), e = se.replace(a, o, r)), this.edits.push(e), r !== void 0) return r;
                }, t.prototype.delete = function(a, o) {
                    var i, e;
                    if (o === void 0 ? i = $.del(a) : Z.is(o) ? (e = o, i = se.del(a, o)) : (this.assertChangeAnnotations(this.changeAnnotations), e = this.changeAnnotations.manage(o), i = se.del(a, e)), this.edits.push(i), e !== void 0) return e;
                ...
                }, t.prototype.assertChangeAnnotations = function(a) {
                    if (a === void 0) throw new Error("Text edit change is not configured to manage change annotations.");
                }, t;
            }(), lt = function() {
                function t(a) {
                    this._annotations = a === void 0 ? Object.create(null) : a, this._counter = 0, this._size = 0;
                }
                return t.prototype.all = function() {
                    ...
                    enumerable: !1,
                    configurable: !0
                }), t.prototype.manage = function(a, o) {
                    var i;
                    if (Z.is(a) ? i = a : (i = this.nextId(), o = a), this._annotations[i] !== void 0) throw new Error("Id " + i + " is already in use.");
                    if (o === void 0) throw new Error("No annotation provided for id " + i);
                    return this._annotations[i] = o, this._size++, i;
                ...
                function t(a) {
                    var o = this;
                    this._textEditChanges = Object.create(null), a !== void 0 ? (this._workspaceEdit = a, a.documentChanges ? (this._changeAnnotations = new lt(a.changeAnnotations), a.changeAnnotations = this._changeAnnotations.all(), a.documentChanges.forEach(function(i) {
                        if (Le.is(i)) {
                            var e = new Me(i.edits, o._changeAnnotations);
                            o._textEditChanges[i.textDocument.uri] = e;
                        }
                    })) : a.changes && Object.keys(a.changes).forEach(function(i) {
                        var e = new Me(a.changes[i]);
                        o._textEditChanges[i] = e;
                    })) : this._workspaceEdit = {};
                }
                return Object.defineProperty(t.prototype, "edit", {
                    ...
                    enumerable: !1,
                    configurable: !0
                }), t.prototype.getTextEditChange = function(a) {
                    if (Re.is(a)) {
                        ...
                        var o = {
                            uri: a.uri,
                            version: a.version
                        }, i = this._textEditChanges[o.uri];
                        if (!i) {
                            var e = [], r = {
                                textDocument: o,
                                edits: e
                            };
                            this._workspaceEdit.documentChanges.push(r), i = new Me(e, this._changeAnnotations), this._textEditChanges[o.uri] = i;
                        }
                        return i;
                    } else {
                        ...
                        var i = this._textEditChanges[a];
                        if (!i) {
                            var e = [];
                            this._workspaceEdit.changes[a] = e, i = new Me(e), this._textEditChanges[a] = i;
                        }
                        return i;
                    }
                }, t.prototype.initDocumentChanges = function() {
                    this._workspaceEdit.documentChanges === void 0 && this._workspaceEdit.changes === void 0 && (this._changeAnnotations = new lt, this._workspaceEdit.documentChanges = [], this._workspaceEdit.changeAnnotations = this._changeAnnotations.all());
                ...
                }, t.prototype.createFile = function(a, o, i) {
                    if (this.initDocumentChanges(), this._workspaceEdit.documentChanges === void 0) throw new Error("Workspace edit is not configured for document changes.");
                    var e;
                    pe.is(o) || Z.is(o) ? e = o : i = o;
                    var r, n;
                    if (e === void 0 ? r = we.create(a, i) : (n = Z.is(e) ? e : this._changeAnnotations.manage(e), r = we.create(a, i, n)), this._workspaceEdit.documentChanges.push(r), n !== void 0) return n;
                }, t.prototype.renameFile = function(a, o, i, e) {
                    if (this.initDocumentChanges(), this._workspaceEdit.documentChanges === void 0) throw new Error("Workspace edit is not configured for document changes.");
                    var r;
                    pe.is(i) || Z.is(i) ? r = i : e = i;
                    var n, s;
                    if (r === void 0 ? n = _e.create(a, o, e) : (s = Z.is(r) ? r : this._changeAnnotations.manage(r), n = _e.create(a, o, e, s)), this._workspaceEdit.documentChanges.push(n), s !== void 0) return s;
                }, t.prototype.deleteFile = function(a, o, i) {
                    if (this.initDocumentChanges(), this._workspaceEdit.documentChanges === void 0) throw new Error("Workspace edit is not configured for document changes.");
                    var e;
                    pe.is(o) || Z.is(o) ? e = o : i = o;
                    var r, n;
                    if (e === void 0 ? r = ye.create(a, i) : (n = Z.is(e) ? e : this._changeAnnotations.manage(e), r = ye.create(a, i, n)), this._workspaceEdit.documentChanges.push(r), n !== void 0) return n;
                }, t;
            }(), ut;
            (function(t) {
                function a(i) {
            ...
            (function(t) {
                function a(o) {
                    var i = o;
                    return w.objectLiteral(o) && ne.is(i.kind) && w.string(i.value);
                }
                t.is = a;
            })(Oe || (Oe = {}));
            var j;
            ...
            (function(t) {
                ...
                function o(i) {
                    var e = i;
                    return e && w.string(e.newText) && X.is(e.insert) && X.is(e.replace);
                }
                t.is = o;
            })(pt || (pt = {}));
            var mt;
            ...
            (function(t) {
                function a(o) {
                    var i = o;
                    return !!i && w.objectLiteral(i) && (Oe.is(i.contents) || ze.is(i.contents) || w.typedArray(i.contents, ze.is)) && (o.range === void 0 || X.is(o.range));
                }
                t.is = a;
            })(bt || (bt = {}));
            var vt;
            ...
            (function(t) {
                function a(o, i) {
                    ...
                    return w.defined(i) && (n.documentation = i), w.defined(e) ? n.parameters = e : n.parameters = [], n;
                }
                t.create = a;
            })(wt || (wt = {}));
            var Te;
            ...
            (function(t) {
                ...
                function o(i) {
                    var e = i;
                    return e && w.string(e.name) && w.number(e.kind) && X.is(e.range) && X.is(e.selectionRange) && (e.detail === void 0 || w.string(e.detail)) && (e.deprecated === void 0 || w.boolean(e.deprecated)) && (e.children === void 0 || Array.isArray(e.children)) && (e.tags === void 0 || Array.isArray(e.tags));
                }
                t.is = o;
            })(kt || (kt = {}));
            var St;
            ...
            (function(t) {
                ...
                function o(i) {
                    var e = i;
                    return w.defined(e) && w.typedArray(e.diagnostics, Ce.is) && (e.only === void 0 || w.typedArray(e.only, w.string));
                }
                t.is = o;
            })(At || (At = {}));
            var xt;
            (function(t) {
                function a(i, e, r) {
                    ...
                    return typeof e == "string" ? (s = !1, n.kind = e) : ve.is(e) ? n.command = e : n.edit = e, s && r !== void 0 && (n.kind = r), n;
                }
                t.create = a;
                function o(i) {
                    var e = i;
                    return e && w.string(e.title) && (e.diagnostics === void 0 || w.typedArray(e.diagnostics, Ce.is)) && (e.kind === void 0 || w.string(e.kind)) && (e.edit !== void 0 || e.command !== void 0) && (e.command === void 0 || ve.is(e.command)) && (e.isPreferred === void 0 || w.boolean(e.isPreferred)) && (e.edit === void 0 || Ne.is(e.edit));
                }
                t.is = o;
            })(xt || (xt = {}));
            var Dt;
            (function(t) {
                ...
                function o(i) {
                    var e = i;
                    return w.defined(e) && X.is(e.range) && (w.undefined(e.command) || ve.is(e.command));
                }
                t.is = o;
            })(Dt || (Dt = {}));
            var Et;
            ...
            (function(t) {
                ...
                function o(i) {
                    var e = i;
                    return w.defined(e) && X.is(e.range) && (w.undefined(e.target) || w.string(e.target));
                }
                t.is = o;
            })(Ct || (Ct = {}));
            var Lt;
            (function(t) {
                ...
                function o(i) {
                    var e = i;
                    return e !== void 0 && X.is(e.range) && (e.parent === void 0 || t.is(e.parent));
                }
                t.is = o;
            })(Lt || (Lt = {}));
            var Wi = null, Mt;
            (function(t) {
                function a(r, n, s, l) {
                    return new wn(r, n, s, l);
                }
                t.create = a;
                function o(r) {
                    var n = r;
                    return !!(w.defined(n) && w.string(n.uri) && (w.undefined(n.languageId) || w.string(n.languageId)) && w.uinteger(n.lineCount) && w.func(n.getText) && w.func(n.positionAt) && w.func(n.offsetAt));
                }
                t.is = o;
                function i(r, n) {
                    for(var s = r.getText(), l = e(n, function(f, b) {
                        var E = f.range.start.line - b.range.start.line;
                        return E === 0 ? f.range.start.character - b.range.start.character : E;
                    }), u = s.length, c = l.length - 1; c >= 0; c--){
                        var d = l[c], p = r.offsetAt(d.range.start), m = r.offsetAt(d.range.end);
                        if (m <= u) s = s.substring(0, p) + d.newText + s.substring(m, s.length);
                ...
                function e(r, n) {
                    ...
                    var s = r.length / 2 | 0, l = r.slice(0, s), u = r.slice(s);
                    e(l, n), e(u, n);
                    for(var c = 0, d = 0, p = 0; c < l.length && d < u.length;){
                        var m = n(l[c], u[d]);
                        m <= 0 ? r[p++] = l[c++] : r[p++] = u[d++];
                    }
                    for(; c < l.length;)r[p++] = l[c++];
                    for(; d < u.length;)r[p++] = u[d++];
                    return r;
                }
            })(Mt || (Mt = {}));
            var wn = function() {
                function t(a, o, i, e) {
                    this._uri = a, this._languageId = o, this._version = i, this._content = e, this._lineOffsets = void 0;
                }
                return Object.defineProperty(t.prototype, "uri", {
                    ...
                    enumerable: !1,
                    configurable: !0
                }), t.prototype.getText = function(a) {
                    if (a) {
                        var o = this.offsetAt(a.start), i = this.offsetAt(a.end);
                        return this._content.substring(o, i);
                    }
                    return this._content;
                }, t.prototype.update = function(a, o) {
                    this._content = a.text, this._version = o, this._lineOffsets = void 0;
                }, t.prototype.getLineOffsets = function() {
                    if (this._lineOffsets === void 0) {
                        for(var a = [], o = this._content, i = !0, e = 0; e < o.length; e++){
                            i && (a.push(e), i = !1);
                            var r = o.charAt(e);
                            i = r === "\r" || r === `
...
` && e++;
                        ...
                        i && o.length > 0 && a.push(o.length), this._lineOffsets = a;
                    }
                    return this._lineOffsets;
                }, t.prototype.positionAt = function(a) {
                    a = Math.max(Math.min(a, this._content.length), 0);
                    var o = this.getLineOffsets(), i = 0, e = o.length;
                    if (e === 0) return Q.create(0, a);
                    for(; i < e;){
                        var r = Math.floor((i + e) / 2);
                        o[r] > a ? e = r : i = r + 1;
                    }
                    var n = i - 1;
                    return Q.create(n, a - o[n]);
                }, t.prototype.offsetAt = function(a) {
                    var o = this.getLineOffsets();
                    if (a.line >= o.length) return this._content.length;
                    if (a.line < 0) return 0;
                    var i = o[a.line], e = a.line + 1 < o.length ? o[a.line + 1] : this._content.length;
                    return Math.max(Math.min(i + a.character, e), i);
            ...
            (function(t) {
                ...
                t.boolean = e;
                function r(m) {
                    return a.call(m) === "[object String]";
                }
                t.string = r;
                function n(m) {
                    return a.call(m) === "[object Number]";
                }
                t.number = n;
                function s(m, f, b) {
                    return a.call(m) === "[object Number]" && f <= m && m <= b;
                }
                t.numberRange = s;
                function l(m) {
                    return a.call(m) === "[object Number]" && -2147483648 <= m && m <= 2147483647;
                }
                t.integer = l;
                function u(m) {
                    return a.call(m) === "[object Number]" && 0 <= m && m <= 2147483647;
                }
                t.uinteger = u;
                function c(m) {
                    return a.call(m) === "[object Function]";
                }
                t.func = c;
                function d(m) {
                ...
                return Object.defineProperty(t.prototype, "uri", {
                    ...
                    for(var i = 0, e = a; i < e.length; i++){
                        ...
                        if (t.isIncremental(r)) {
                            var n = Ht(r.range), s = this.offsetAt(n.start), l = this.offsetAt(n.end);
                            this._content = this._content.substring(0, s) + r.text + this._content.substring(l, this._content.length);
                            var u = Math.max(n.start.line, 0), c = Math.max(n.end.line, 0), d = this._lineOffsets, p = It(r.text, !1, s);
                            if (c - u === p.length) for(var m = 0, f = p.length; m < f; m++)d[m + u + 1] = p[m];
                            else p.length < 1e4 ? d.splice.apply(d, [
                                u + 1,
                                c - u
                            ].concat(p)) : this._lineOffsets = d = d.slice(0, u + 1).concat(p, d.slice(c + 1));
                            var b = r.text.length - (l - s);
                            if (b !== 0) for(var m = u + 1 + p.length, f = d.length; m < f; m++)d[m] = d[m] + b;
                        } else if (t.isFull(r)) this._content = r.text, this._lineOffsets = void 0;
                        else throw new Error("Unknown change event received");
                    }
                    this._version = o;
                }, t.prototype.getLineOffsets = function() {
                    return this._lineOffsets === void 0 && (this._lineOffsets = It(this._content, !0)), this._lineOffsets;
                }, t.prototype.positionAt = function(a) {
                    a = Math.max(Math.min(a, this._content.length), 0);
                    var o = this.getLineOffsets(), i = 0, e = o.length;
                    if (e === 0) return {
                    ...
                    enumerable: !0,
                    configurable: !0
                }), t.isIncremental = function(a) {
                    var o = a;
                    return o != null && typeof o.text == "string" && o.range !== void 0 && (o.rangeLength === void 0 || typeof o.rangeLength == "number");
                }, t.isFull = function(a) {
                    var o = a;
            ...
            (function(t) {
                function a(e, r, n, s) {
                    return new Rt(e, r, n, s);
                }
                t.create = a;
                function o(e, r, n) {
                    if (e instanceof Rt) return e.update(r, n), e;
                    throw new Error("TextDocument.update: document must be created by TextDocument.create");
                }
                t.update = o;
                function i(e, r) {
                    for(var n = e.getText(), s = qe(r.map(_n), function(f, b) {
                        var E = f.range.start.line - b.range.start.line;
                        return E === 0 ? f.range.start.character - b.range.start.character : E;
                    }), l = 0, u = [], c = 0, d = s; c < d.length; c++){
                        var p = d[c], m = e.offsetAt(p.range.start);
                        if (m < l) throw new Error("Overlapping edit");
                        m > l && u.push(n.substring(l, m)), p.newText.length && u.push(p.newText), l = e.offsetAt(p.range.end);
                    }
                    return u.push(n.substr(l)), u.join("");
                }
                t.applyEdits = i;
            })(zt || (zt = {}));
            function qe(t, a) {
                if (t.length <= 1) return t;
                var o = t.length / 2 | 0, i = t.slice(0, o), e = t.slice(o);
                qe(i, a), qe(e, a);
                for(var r = 0, n = 0, s = 0; r < i.length && n < e.length;){
                    var l = a(i[r], e[n]);
                    l <= 0 ? t[s++] = i[r++] : t[s++] = e[n++];
                }
                for(; r < i.length;)t[s++] = i[r++];
                for(; n < e.length;)t[s++] = e[n++];
                return t;
            }
            function It(t, a, o) {
                o === void 0 && (o = 0);
                for(var i = a ? [
                    ...
                    (r === 13 || r === 10) && (r === 13 && e + 1 < t.length && t.charCodeAt(e + 1) === 10 && e++, i.push(o + e + 1));
                }
                return i;
            }
            function Ht(t) {
                var a = t.start, o = t.end;
                return a.line > o.line || a.line === o.line && a.character > o.character ? {
                    start: o,
                    end: a
                } : t;
            }
            ...
            var L;
            (function(t) {
                t[t.StartCommentTag = 0] = "StartCommentTag", t[t.Comment = 1] = "Comment", t[t.EndCommentTag = 2] = "EndCommentTag", t[t.StartTagOpen = 3] = "StartTagOpen", t[t.StartTagClose = 4] = "StartTagClose", t[t.StartTagSelfClose = 5] = "StartTagSelfClose", t[t.StartTag = 6] = "StartTag", t[t.EndTagOpen = 7] = "EndTagOpen", t[t.EndTagClose = 8] = "EndTagClose", t[t.EndTag = 9] = "EndTag", t[t.DelimiterAssign = 10] = "DelimiterAssign", t[t.AttributeName = 11] = "AttributeName", t[t.AttributeValue = 12] = "AttributeValue", t[t.StartDoctypeTag = 13] = "StartDoctypeTag", t[t.Doctype = 14] = "Doctype", t[t.EndDoctypeTag = 15] = "EndDoctypeTag", t[t.Content = 16] = "Content", t[t.Whitespace = 17] = "Whitespace", t[t.Unknown = 18] = "Unknown", t[t.Script = 19] = "Script", t[t.Styles = 20] = "Styles", t[t.EOS = 21] = "EOS";
            })(L || (L = {}));
            var z;
            (function(t) {
                t[t.WithinContent = 0] = "WithinContent", t[t.AfterOpeningStartTag = 1] = "AfterOpeningStartTag", t[t.AfterOpeningEndTag = 2] = "AfterOpeningEndTag", t[t.WithinDoctype = 3] = "WithinDoctype", t[t.WithinTag = 4] = "WithinTag", t[t.WithinEndTag = 5] = "WithinEndTag", t[t.WithinComment = 6] = "WithinComment", t[t.WithinScriptContent = 7] = "WithinScriptContent", t[t.WithinStyleContent = 8] = "WithinStyleContent", t[t.AfterAttributeName = 9] = "AfterAttributeName", t[t.BeforeAttributeValue = 10] = "BeforeAttributeValue";
            })(z || (z = {}));
            var Ut;
            (function(t) {
                t.LATEST = {
            ...
            var le = De(), yn = function() {
                function t(a, o) {
                    this.source = a, this.len = a.length, this.position = o;
                }
                return t.prototype.eos = function() {
                    return this.len <= this.position;
                }, t.prototype.getSource = function() {
                    return this.source;
                }, t.prototype.pos = function() {
                    return this.position;
                }, t.prototype.goBackTo = function(a) {
                    this.position = a;
                }, t.prototype.goBack = function(a) {
                    this.position -= a;
                ...
                }, t.prototype.peekChar = function(a) {
                    return a === void 0 && (a = 0), this.source.charCodeAt(this.position + a) || 0;
                }, t.prototype.advanceIfChar = function(a) {
                    return a === this.source.charCodeAt(this.position) ? (this.position++, !0) : !1;
                }, t.prototype.advanceIfChars = function(a) {
                    var o;
                    if (this.position + a.length > this.source.length) return !1;
                    for(o = 0; o < a.length; o++)if (this.source.charCodeAt(this.position + o) !== a[o]) return !1;
                    return this.advance(o), !0;
                }, t.prototype.advanceIfRegExp = function(a) {
                    var o = this.source.substr(this.position), i = o.match(a);
                    return i ? (this.position = this.position + i.index + i[0].length, i[0]) : "";
                }, t.prototype.advanceUntilRegExp = function(a) {
                    var o = this.source.substr(this.position), i = o.match(a);
                    return i ? (this.position = this.position + i.index, i[0]) : (this.goToEnd(), "");
                }, t.prototype.advanceUntilChar = function(a) {
                    for(; this.position < this.source.length;){
                        if (this.source.charCodeAt(this.position) === a) return !0;
                        this.advance(1);
                    }
                    return !1;
                }, t.prototype.advanceUntilChars = function(a) {
                    for(; this.position + a.length <= this.source.length;){
                        for(var o = 0; o < a.length && this.source.charCodeAt(this.position + o) === a[o]; o++);
                        if (o === a.length) return !0;
                        this.advance(1);
                    }
                    return this.goToEnd(), !1;
                }, t.prototype.skipWhitespace = function() {
                    var a = this.advanceWhileChar(function(o) {
                        return o === En || o === Cn || o === An || o === Dn || o === xn;
                    });
                    return a > 0;
                }, t.prototype.advanceWhileChar = function(a) {
                    for(var o = this.position; this.position < this.len && a(this.source.charCodeAt(this.position));)this.position++;
                    return this.position - o;
                }, t;
            }(), Wt = "!".charCodeAt(0), me = "-".charCodeAt(0), Ie = "<".charCodeAt(0), re = ">".charCodeAt(0), Ge = "/".charCodeAt(0), Tn = "=".charCodeAt(0), kn = '"'.charCodeAt(0), Sn = "'".charCodeAt(0), An = `
`.charCodeAt(0), xn = "\r".charCodeAt(0), Dn = "\f".charCodeAt(0), En = " ".charCodeAt(0), Cn = "	".charCodeAt(0), Ln = {
                "text/x-handlebars-template": !0
            };
            function fe(t, a, o, i) {
                a === void 0 && (a = 0), o === void 0 && (o = z.WithinContent), i === void 0 && (i = !1);
                var e = new yn(t, a), r = o, n = 0, s = L.Unknown, l, u, c, d, p;
                function m() {
                ...
                function b(x, g, h) {
                    return s = g, n = x, l = h, g;
                }
                function E() {
                    var x = e.pos(), g = r, h = H();
                    return h !== L.EOS && x === e.pos() && !(i && (h === L.StartTagClose || h === L.EndTagClose)) ? (console.log("Scanner.scan has not advanced at offset " + x + ", state before: " + g + " after: " + r), e.advance(1), b(x, L.Unknown)) : h;
                }
                function H() {
                    var x = e.pos();
                    if (e.eos()) return b(x, L.EOS);
                    var g;
                    switch(r){
                        case z.WithinComment:
                            return e.advanceIfChars([
                                me,
                                me,
                                re
                            ]) ? (r = z.WithinContent, b(x, L.EndCommentTag)) : (e.advanceUntilChars([
                                me,
                                me,
                                re
                            ]), b(x, L.Comment));
                        case z.WithinDoctype:
                            return e.advanceIfChar(re) ? (r = z.WithinContent, b(x, L.EndDoctypeTag)) : (e.advanceUntilChar(re), b(x, L.Doctype));
                        case z.WithinContent:
                            if (e.advanceIfChar(Ie)) {
                                if (!e.eos() && e.peekChar() === Wt) {
                                    if (e.advanceIfChars([
                                        Wt,
                                        me,
                                        me
                                    ])) return r = z.WithinComment, b(x, L.StartCommentTag);
                                    if (e.advanceIfRegExp(/^!doctype/i)) return r = z.WithinDoctype, b(x, L.StartDoctypeTag);
                                }
                                return e.advanceIfChar(Ge) ? (r = z.AfterOpeningEndTag, b(x, L.EndTagOpen)) : (r = z.AfterOpeningStartTag, b(x, L.StartTagOpen));
                            }
                            return e.advanceUntilChar(Ie), b(x, L.Content);
                        case z.AfterOpeningEndTag:
                            var h = m();
                            return h.length > 0 ? (r = z.WithinEndTag, b(x, L.EndTag)) : e.skipWhitespace() ? b(x, L.Whitespace, le("error.unexpectedWhitespace", "Tag name must directly follow the open bracket.")) : (r = z.WithinEndTag, e.advanceUntilChar(re), x < e.pos() ? b(x, L.Unknown, le("error.endTagNameExpected", "End tag name expected.")) : H());
                        case z.WithinEndTag:
                            if (e.skipWhitespace()) return b(x, L.Whitespace);
                            if (e.advanceIfChar(re)) return r = z.WithinContent, b(x, L.EndTagClose);
                            if (i && e.peekChar() === Ie) return r = z.WithinContent, b(x, L.EndTagClose, le("error.closingBracketMissing", "Closing bracket missing."));
                            g = le("error.closingBracketExpected", "Closing bracket expected.");
                            break;
                        case z.AfterOpeningStartTag:
                            return c = m(), p = void 0, d = void 0, c.length > 0 ? (u = !1, r = z.WithinTag, b(x, L.StartTag)) : e.skipWhitespace() ? b(x, L.Whitespace, le("error.unexpectedWhitespace", "Tag name must directly follow the open bracket.")) : (r = z.WithinTag, e.advanceUntilChar(re), x < e.pos() ? b(x, L.Unknown, le("error.startTagNameExpected", "Start tag name expected.")) : H());
                        case z.WithinTag:
                            return e.skipWhitespace() ? (u = !0, b(x, L.Whitespace)) : u && (d = f(), d.length > 0) ? (r = z.AfterAttributeName, u = !1, b(x, L.AttributeName)) : e.advanceIfChars([
                                Ge,
                                re
                            ]) ? (r = z.WithinContent, b(x, L.StartTagSelfClose)) : e.advanceIfChar(re) ? (c === "script" ? p && Ln[p] ? r = z.WithinContent : r = z.WithinScriptContent : c === "style" ? r = z.WithinStyleContent : r = z.WithinContent, b(x, L.StartTagClose)) : i && e.peekChar() === Ie ? (r = z.WithinContent, b(x, L.StartTagClose, le("error.closingBracketMissing", "Closing bracket missing."))) : (e.advance(1), b(x, L.Unknown, le("error.unexpectedCharacterInTag", "Unexpected character in tag.")));
                        case z.AfterAttributeName:
                            return e.skipWhitespace() ? (u = !0, b(x, L.Whitespace)) : e.advanceIfChar(Tn) ? (r = z.BeforeAttributeValue, b(x, L.DelimiterAssign)) : (r = z.WithinTag, H());
                        case z.BeforeAttributeValue:
                            if (e.skipWhitespace()) return b(x, L.Whitespace);
                            var v = e.advanceIfRegExp(/^[^\s"'`=<>]+/);
                            if (v.length > 0) return e.peekChar() === re && e.peekChar(-1) === Ge && (e.goBack(1), v = v.substr(0, v.length - 1)), d === "type" && (p = v), r = z.WithinTag, u = !1, b(x, L.AttributeValue);
                            var B = e.peekChar();
                            return B === Sn || B === kn ? (e.advance(1), e.advanceUntilChar(B) && e.advance(1), d === "type" && (p = e.getSource().substring(x + 1, e.pos() - 1)), r = z.WithinTag, u = !1, b(x, L.AttributeValue)) : (r = z.WithinTag, u = !1, H());
                        case z.WithinScriptContent:
                            for(var C = 1; !e.eos();){
                                var P = e.advanceIfRegExp(/<!--|-->|<\/?script\s*\/?>?/i);
                                if (P.length === 0) return e.goToEnd(), b(x, L.Script);
                                if (P === "<!--") C === 1 && (C = 2);
                                else if (P === "-->") C = 1;
                                else if (P[1] !== "/") C === 2 && (C = 3);
                                else if (C === 3) C = 2;
                            ...
                            return r = z.WithinContent, x < e.pos() ? b(x, L.Script) : H();
                        case z.WithinStyleContent:
                            return e.advanceUntilRegExp(/<\/style/i), r = z.WithinContent, x < e.pos() ? b(x, L.Styles) : H();
                    }
                    return e.advance(1), r = z.WithinContent, b(x, L.Unknown, g);
                }
                return {
                    scan: E,
                    ...
                    getTokenText: function() {
                        return e.getSource().substring(n, e.pos());
                    },
            ...
            function Bt(t, a) {
                ...
                if (i === 0) return 0;
                for(; o < i;){
                    var e = Math.floor((o + i) / 2);
                    a(t[e]) ? i = e : o = e + 1;
                }
                return o;
            }
            function Mn(t, a, o) {
                for(var i = 0, e = t.length - 1; i <= e;){
                    var r = (i + e) / 2 | 0, n = o(t[r], a);
                    if (n < 0) i = r + 1;
                    else if (n > 0) e = r - 1;
                    else return r;
                }
            ...
            var Ft = function() {
                function t(a, o, i, e) {
                    this.start = a, this.end = o, this.children = i, this.parent = e, this.closed = !1;
                }
                return Object.defineProperty(t.prototype, "attributeNames", {
                    get: function() {
                        return this.attributes ? Object.keys(this.attributes) : [];
                    },
                    enumerable: !1,
                    configurable: !0
                }), t.prototype.isSameTag = function(a) {
                    return this.tag === void 0 ? a === void 0 : a !== void 0 && this.tag.length === a.length && this.tag.toLowerCase() === a;
                    ...
                    enumerable: !1,
                    configurable: !0
                }), t.prototype.findNodeBefore = function(a) {
                    var o = Bt(this.children, function(r) {
                        return a <= r.start;
                    }) - 1;
                    if (o >= 0) {
                        var i = this.children[o];
                        if (a > i.start) {
                            if (a < i.end) return i.findNodeBefore(a);
                            var e = i.lastChild;
                            return e && e.end === i.end ? i.findNodeBefore(a) : i;
                        }
                    }
                    return this;
                }, t.prototype.findNodeAt = function(a) {
                    var o = Bt(this.children, function(e) {
                        return a <= e.start;
                    }) - 1;
                    if (o >= 0) {
                        var i = this.children[o];
                        if (a > i.start && a <= i.end) return i.findNodeAt(a);
                    }
                    return this;
                }, t;
            }();
            function Bi(t) {
                for(var a = createScanner(t, void 0, void 0, !0), o = new Ft(0, t.length, [], void 0), i = o, e = -1, r = void 0, n = null, s = a.scan(); s !== TokenType.EOS;){
                    switch(s){
                        case TokenType.StartTagOpen:
                            var l = new Ft(a.getTokenOffset(), t.length, [], i);
                            i.children.push(l), i = l;
                            break;
                        case TokenType.StartTag:
                            i.tag = a.getTokenText();
                            break;
                        case TokenType.StartTagClose:
                            i.parent && (i.end = a.getTokenEnd(), a.getTokenLength() ? (i.startTagEnd = a.getTokenEnd(), i.tag && isVoidElement(i.tag) && (i.closed = !0, i = i.parent)) : i = i.parent);
                            break;
                        case TokenType.StartTagSelfClose:
                            i.parent && (i.closed = !0, i.end = a.getTokenEnd(), i.startTagEnd = a.getTokenEnd(), i = i.parent);
                            break;
                        case TokenType.EndTagOpen:
                            e = a.getTokenOffset(), r = void 0;
                            break;
                        case TokenType.EndTag:
                            r = a.getTokenText().toLowerCase();
                            break;
                        case TokenType.EndTagClose:
                            for(var u = i; !u.isSameTag(r) && u.parent;)u = u.parent;
                            if (u.parent) {
                                for(; i !== u;)i.end = e, i.closed = !1, i = i.parent;
                                i.closed = !0, i.endTagStart = e, i.end = a.getTokenEnd(), i = i.parent;
                            }
                            break;
                        case TokenType.AttributeName:
                            n = a.getTokenText();
                            var c = i.attributes;
                            c || (i.attributes = c = {}), c[n] = null;
                            break;
                        case TokenType.AttributeValue:
                            var d = a.getTokenText(), c = i.attributes;
                            c && n && (c[n] = d, n = null);
                            break;
                    }
                    s = a.scan();
                }
                for(; i.parent;)i.end = t.length, i.closed = !1, i = i.parent;
                return {
                    roots: o.children,
...
`,
            ...
            function ge(t, a) {
                ...
                for(var o = 0; o < a.length; o++)if (t[o] !== a[o]) return !1;
                return !0;
            }
            function Rn(t, a) {
                var o = t.length - a.length;
                return o > 0 ? t.lastIndexOf(a) === o : o === 0 ? t === a : !1;
            }
            function Fi(t, a) {
                var o, i = Math.min(t.length, a.length);
                for(o = 0; o < i; o++)if (t.charCodeAt(o) !== a.charCodeAt(o)) return o;
                return i;
            }
            function Pi(t, a) {
                for(var o = ""; a > 0;)(a & 1) == 1 && (o += t), t += t, a = a >>> 1;
                return o;
            }
            var zn = "a".charCodeAt(0), In = "z".charCodeAt(0), Hn = "A".charCodeAt(0), Un = "Z".charCodeAt(0), Wn = "0".charCodeAt(0), Bn = "9".charCodeAt(0);
            function Se(t, a) {
                var o = t.charCodeAt(a);
                return zn <= o && o <= In || Hn <= o && o <= Un || Wn <= o && o <= Bn;
            }
            var Fn = [
                "area",
                "base",
            ...
            function Pt(t) {
                return !!t && Mn(Fn, t.toLowerCase(), function(a, o) {
            ...
            var Nn = function() {
                function t(a, o) {
                    var i = this;
                    this.id = a, this._tags = [], this._tagMap = {}, this._valueSetMap = {}, this._tags = o.tags || [], this._globalAttributes = o.globalAttributes || [], this._tags.forEach(function(e) {
                        i._tagMap[e.name.toLowerCase()] = e;
                    }), o.valueSets && o.valueSets.forEach(function(e) {
                        i._valueSetMap[e.name] = e.values;
                    });
                }
                return t.prototype.isApplicable = function() {
                    return !0;
                }, t.prototype.getId = function() {
                    return this.id;
                }, t.prototype.provideTags = function() {
                    return this._tags;
                }, t.prototype.provideAttributes = function(a) {
                    var o = [], i = function(r) {
                        o.push(r);
                    }, e = this._tagMap[a.toLowerCase()];
                    return e && e.attributes.forEach(i), this._globalAttributes.forEach(i), o;
                }, t.prototype.provideValues = function(a, o) {
                    var i = this, e = [];
                    o = o.toLowerCase();
                    var r = function(s) {
                        s.forEach(function(l) {
                            l.name.toLowerCase() === o && (l.values && l.values.forEach(function(u) {
                                e.push(u);
                            }), l.valueSet && i._valueSetMap[l.valueSet] && i._valueSetMap[l.valueSet].forEach(function(u) {
                                e.push(u);
                            }));
                        });
                    }, n = this._tagMap[a.toLowerCase()];
                    return n ? (r(n.attributes), r(this._globalAttributes), e) : [];
                }, t;
            }();
            function ce(t, a, o) {
                a === void 0 && (a = {});
                ...
                if (t.description && a.documentation !== !1) {
                    var e = Pn(t.description);
                    e && (i.value += e.value);
                }
                if (t.references && t.references.length > 0 && a.references !== !1 && (i.value.length && (i.value += `

`), o ? i.value += t.references.map(function(r) {
                    return "[" + r.name + "](" + r.url + ")";
                }).join(" | ") : i.value += t.references.map(function(r) {
                    return r.name + ": " + r.url;
                }).join(`
`)), i.value !== "") return i;
            }
            var Nt = function(t, a, o, i) {
                function e(r) {
                    return r instanceof o ? r : new o(function(n) {
                        n(r);
                    });
                }
                return new (o || (o = Promise))(function(r, n) {
                    ...
                    function u(c) {
                        c.done ? r(c.value) : e(c.value).then(s, l);
                    }
                    u((i = i.apply(t, a || [])).next());
                });
            }, Ot = function(t, a) {
                var o = {
                    label: 0,
                ...
                function l(u) {
                    ...
                    for(; o;)try {
                        if (i = 1, e && (r = u[0] & 2 ? e.return : u[0] ? e.throw || ((r = e.return) && r.call(e), 0) : e.next) && !(r = r.call(e, u[1])).done) return r;
                        switch(e = 0, r && (u = [
                            u[0] & 2,
                            r.value
                        ]), u[0]){
                            ...
                            case 7:
                                ...
                                continue;
                            default:
                                if (r = o.trys, !(r = r.length > 0 && r[r.length - 1]) && (u[0] === 6 || u[0] === 2)) {
                                    o = 0;
                                    continue;
                                }
                ...
                function t(a) {
                    this.readDirectory = a, this.atributeCompletions = [];
                }
                return t.prototype.onHtmlAttributeValue = function(a) {
                    Vn(a.tag, a.attribute) && this.atributeCompletions.push(a);
                }, t.prototype.computeCompletions = function(a, o) {
                    return Nt(this, void 0, void 0, function() {
                        var i, e, r, n, s, l, u, c, d, p;
                        return Ot(this, function(m) {
                            switch(m.label){
                                case 0:
                                    i = {
                                        items: [],
                                        isIncomplete: !1
                                    }, e = 0, r = this.atributeCompletions, m.label = 1;
                                case 1:
                                    return e < r.length ? (n = r[e], s = jn(a.getText(n.range)), Gn(s) ? s === "." || s === ".." ? (i.isIncomplete = !0, [
                                        3,
                                        4
                                    ]) : [
                                        3,
                                ...
                                case 2:
                                    return l = Jn(n.value, s, n.range), [
                                        4,
                                        this.providePathSuggestions(n.value, l, a, o)
                                    ];
                                case 3:
                                    for(u = m.sent(), c = 0, d = u; c < d.length; c++)p = d[c], i.items.push(p);
                                    m.label = 4;
                                case 4:
                                    return e++, [
                                        3,
                ...
                }, t.prototype.providePathSuggestions = function(a, o, i, e) {
                    return Nt(this, void 0, void 0, function() {
                        var r, n, s, l, u, c, d, p, m, f;
                        return Ot(this, function(b) {
                            switch(b.label){
                                case 0:
                                    if (r = a.substring(0, a.lastIndexOf("/") + 1), n = e.resolveReference(r || ".", i.uri), !n) return [
                                        3,
                                        4
                                    ];
                                    b.label = 1;
                                case 1:
                                    return b.trys.push([
                                        ...
                                        4,
                                        this.readDirectory(n)
                                    ];
                                case 2:
                                    for(l = b.sent(), u = 0, c = l; u < c.length; u++)d = c[u], p = d[0], m = d[1], p.charCodeAt(0) !== qn && s.push(Xn(p, m === je.Directory, o));
                                    return [
                                        2,
                                        s
                                    ];
            ...
            function Vn(t, a) {
                var o = $n[t];
                return o ? typeof o == "string" ? o === a : o.indexOf(a) !== -1 : !1;
            }
            function Jn(t, a, o) {
                var i, e = t.lastIndexOf("/");
                if (e === -1) i = Yn(o, 1, -1);
                else {
                    var r = a.slice(e + 1), n = Ae(o.end, -1 - r.length), s = r.indexOf(" "), l = void 0;
                    s !== -1 ? l = Ae(n, s) : l = Ae(o.end, -1), i = X.create(n, l);
                }
                return i;
            }
            function Xn(t, a, o) {
            ...
            function Ae(t, a) {
                return Q.create(t.line, t.character + a);
            }
            function Yn(t, a, o) {
                var i = Ae(t.start, a), e = Ae(t.end, o);
                return X.create(i, e);
            }
            var $n = {
                a: "href",
                ...
                function t(a, o) {
                    this.lsOptions = a, this.dataManager = o, this.completionParticipants = [];
                }
                return t.prototype.setCompletionParticipants = function(a) {
                    this.completionParticipants = a || [];
                }, t.prototype.doComplete2 = function(a, o, i, e, r) {
                            ...
                            switch(c.label){
                                case 0:
                                    if (!this.lsOptions.fileSystemProvider || !this.lsOptions.fileSystemProvider.readDirectory) return [
                                        2,
                                        this.doComplete(a, o, i, r)
                                    ];
                                    n = new On(this.lsOptions.fileSystemProvider.readDirectory), s = this.completionParticipants, this.completionParticipants = [
                                        n
                                    ].concat(s), l = this.doComplete(a, o, i, r), c.label = 1;
                                case 1:
                                    return c.trys.push([
                                        1,
                                        ,
                                ...
                                case 3:
                                    return this.completionParticipants = s, [
                                        7
                                    ];
                                case 4:
                                    return [
                ...
                }, t.prototype.doComplete = function(a, o, i, e) {
                    var r = this._doComplete(a, o, i, e);
                    return this.convertCompletionList(r);
                }, t.prototype._doComplete = function(a, o, i, e) {
                    var r = {
                        isIncomplete: !1,
                        items: []
                    }, n = this.completionParticipants, s = this.dataManager.getDataProviders().filter(function(A) {
                        return A.isApplicable(a.languageId) && (!e || e[A.getId()] !== !1);
                    }), l = this.doesSupportMarkdown(), u = a.getText(), c = a.offsetAt(o), d = i.findNodeBefore(c);
                    if (!d) return r;
                    var p = fe(u, d.start), m = "", f;
                    function b(A, k) {
                        return k === void 0 && (k = c), A > c && (A = c), {
                            start: a.positionAt(A),
                            end: a.positionAt(k)
                        };
                    }
                    function E(A, k) {
                        ...
                        return s.forEach(function(M) {
                            M.provideTags().forEach(function(F) {
                                r.items.push({
                                    label: F.name,
                                    kind: j.Property,
                                    documentation: ce(F, void 0, l),
                                    textEdit: $.replace(D, F.name),
                                    insertTextFormat: te.PlainText
                                });
                            });
                        }), r;
                    }
                    function H(A) {
                        for(var k = A; k > 0;){
                            var D = u.charAt(k - 1);
                            if (`
\r`.indexOf(D) >= 0) return u.substring(k, A);
                            if (!Ue(D)) return null;
                            k--;
                        }
                        return u.substring(0, A);
                    }
                    function x(A, k, D) {
                        D === void 0 && (D = c);
                        var M = b(A, D), F = qt(u, D, z.WithinEndTag, L.EndTagClose) ? "" : ">", q = d;
                        for(k && (q = q.parent); q;){
                            var J = q.tag;
                            if (J && (!q.closed || q.endTagStart && q.endTagStart > c)) {
                                var Y = {
                                    label: "/" + J,
                                    kind: j.Property,
                                    filterText: "/" + J,
                                    textEdit: $.replace(M, "/" + J + F),
                                    insertTextFormat: te.PlainText
                                }, ae = H(q.start), oe = H(A - 1);
                                if (ae !== null && oe !== null && ae !== oe) {
                                    var Ke = ae + "</" + J + F;
                                    Y.textEdit = $.replace(b(A - 1 - oe.length), Ke), Y.filterText = oe + "</" + J;
                                }
                                return r.items.push(Y), r;
                            }
                            q = q.parent;
                        }
                        return k || s.forEach(function(Qe) {
                            Qe.provideTags().forEach(function(ue) {
                                r.items.push({
                                    label: "/" + ue.name,
                                    kind: j.Property,
                                    documentation: ce(ue, void 0, l),
                                    filterText: "/" + ue.name + F,
                                    textEdit: $.replace(M, "/" + ue.name + F),
                                    insertTextFormat: te.PlainText
                                });
                            });
                        }), r;
                    ...
                    function g(A, k) {
                        ...
                        if (!Pt(k)) {
                            var D = a.positionAt(A);
                            r.items.push({
                                label: "</" + k + ">",
                                kind: j.Property,
                                filterText: "</" + k + ">",
                                textEdit: $.insert(D, "$0</" + k + ">"),
                    ...
                    function h(A, k) {
                        return E(A, k), x(A, !0, k), r;
                    }
                    function v(A, k) {
                        k === void 0 && (k = c);
                        for(var D = c; D < k && u[D] !== "<";)D++;
                        var M = b(A, D), F = qt(u, k, z.AfterAttributeName, L.DelimiterAssign) ? "" : '="$1"', q = Object.create(null);
                        return s.forEach(function(J) {
                            J.provideAttributes(m).forEach(function(Y) {
                                if (!q[Y.name]) {
                                    q[Y.name] = !0;
                                    var ae = Y.name, oe;
                                    Y.valueSet !== "v" && F.length && (ae = ae + F, (Y.valueSet || Y.name === "style") && (oe = {
                                        title: "Suggest",
                                        command: "editor.action.triggerSuggest"
                                    })), r.items.push({
                                        label: Y.name,
                                        kind: Y.valueSet === "handler" ? j.Function : j.Value,
                                        documentation: ce(Y, void 0, l),
                                        textEdit: $.replace(M, ae),
                                        insertTextFormat: te.Snippet,
                                        command: oe
                                    });
                                }
                    ...
                    function B(A, k) {
                        ...
                        M[D] = D + '$1="$2"';
                        function F(q) {
                            q.attributeNames.forEach(function(J) {
                                ge(J, D) && !M[J] && !k[J] && (M[J] = J + '="$1"');
                            }), q.children.forEach(function(J) {
                                return F(J);
                            });
                        }
                        i && i.roots.forEach(function(q) {
                            return F(q);
                        }), Object.keys(M).forEach(function(q) {
                            return r.items.push({
                                label: q,
                                kind: j.Value,
                                textEdit: $.replace(A, M[q]),
                                insertTextFormat: te.Snippet
                            });
                        });
                    }
                    function C(A, k) {
                        ...
                        if (c > A && c <= k && ei(u[A])) {
                            var q = A + 1, J = k;
                            k > A && u[k - 1] === u[A] && J--;
                            var Y = ti(u, c, q), ae = ni(u, c, J);
                            D = b(Y, ae), F = c >= q && c <= J ? u.substring(q, c) : "", M = !1;
                        } else D = b(A, k), F = u.substring(A, c), M = !0;
                        if (n.length > 0) for(var oe = m.toLowerCase(), Ke = f.toLowerCase(), Qe = b(A, k), ue = 0, pn = n; ue < pn.length; ue++){
                            var mn = pn[ue];
                            mn.onHtmlAttributeValue && mn.onHtmlAttributeValue({
                                document: a,
                                position: o,
                                tag: oe,
                                attribute: Ke,
                        ...
                        return s.forEach(function(zi) {
                            zi.provideValues(m, f).forEach(function(We) {
                                var fn = M ? '"' + We.name + '"' : We.name;
                                r.items.push({
                                    label: We.name,
                                    filterText: fn,
                                    kind: j.Unit,
                                    documentation: ce(We, void 0, l),
                                    textEdit: $.replace(D, fn),
                                    insertTextFormat: te.PlainText
                                });
                            });
                        }), V(), r;
                    ...
                    function P(A) {
                        return c === p.getTokenEnd() && (R = p.scan(), R === A && p.getTokenOffset() === c) ? p.getTokenEnd() : c;
                    }
                    function G() {
                        for(var A = 0, k = n; A < k.length; A++){
                            var D = k[A];
                            D.onHtmlContent && D.onHtmlContent({
                                document: a,
                                position: o
                            });
                        }
                    ...
                    function V() {
                        for(var A = c - 1, k = o.character; A >= 0 && Se(u, A);)A--, k--;
                        if (A >= 0 && u[A] === "&") {
                            var D = X.create(Q.create(o.line, k - 1), o);
                            for(var M in ke)if (Rn(M, ";")) {
                                var F = "&" + M;
                                r.items.push({
                                    label: F,
                                    kind: j.Keyword,
                                    documentation: Zn("entity.propose", "Character entity representing '" + ke[M] + "'"),
                                    textEdit: $.replace(D, F),
                                    insertTextFormat: te.PlainText
                                });
                            }
                        }
                    ...
                    function N(A, k) {
                        ...
                        r.items.push({
                            ...
                            textEdit: $.replace(D, "!DOCTYPE html>"),
                            insertTextFormat: te.PlainText
                        });
                    }
                    for(var R = p.scan(); R !== L.EOS && p.getTokenOffset() <= c;){
                        switch(R){
                            case L.StartTagOpen:
                                if (p.getTokenEnd() === c) {
                                    var I = P(L.StartTag);
                                    return o.line === 0 && N(c, I), h(c, I);
                                }
                                break;
                            case L.StartTag:
                                if (p.getTokenOffset() <= c && c <= p.getTokenEnd()) return E(p.getTokenOffset(), p.getTokenEnd());
                                m = p.getTokenText();
                                break;
                            case L.AttributeName:
                                if (p.getTokenOffset() <= c && c <= p.getTokenEnd()) return v(p.getTokenOffset(), p.getTokenEnd());
                                f = p.getTokenText();
                                break;
                            case L.DelimiterAssign:
                                if (p.getTokenEnd() === c) {
                                    var I = P(L.AttributeValue);
                                    return C(c, I);
                                }
                                break;
                            case L.AttributeValue:
                                if (p.getTokenOffset() <= c && c <= p.getTokenEnd()) return C(p.getTokenOffset(), p.getTokenEnd());
                                break;
                            case L.Whitespace:
                                if (c <= p.getTokenEnd()) switch(p.getScannerState()){
                                    case z.AfterOpeningStartTag:
                                        var U = p.getTokenOffset(), O = P(L.StartTag);
                                        return h(U, O);
                                    case z.WithinTag:
                                    case z.AfterAttributeName:
                                        return v(p.getTokenEnd());
                                    case z.BeforeAttributeValue:
                                        return C(p.getTokenEnd());
                                    case z.AfterOpeningEndTag:
                                        return x(p.getTokenOffset() - 1, !1);
                                    case z.WithinContent:
                                        return G();
                                }
                                break;
                            case L.EndTagOpen:
                                if (c <= p.getTokenEnd()) {
                                    var y = p.getTokenOffset() + 1, _ = P(L.EndTag);
                                    return x(y, !1, _);
                                }
                                break;
                            case L.EndTag:
                                if (c <= p.getTokenEnd()) for(var T = p.getTokenOffset() - 1; T >= 0;){
                                    var S = u.charAt(T);
                                    if (S === "/") return x(T, !1, p.getTokenEnd());
                                    if (!Ue(S)) break;
                                    T--;
                                }
                                break;
                            case L.StartTagClose:
                                if (c <= p.getTokenEnd() && m) return g(p.getTokenEnd(), m);
                                break;
                            case L.Content:
                                if (c <= p.getTokenEnd()) return G();
                                break;
                            default:
                                if (c <= p.getTokenEnd()) return r;
                                break;
                        }
                        R = p.scan();
                    }
                    return r;
                }, t.prototype.doTagComplete = function(a, o, i) {
                    var e = a.offsetAt(o);
                    if (e <= 0) return null;
                    var r = a.getText().charAt(e - 1);
                    if (r === ">") {
                        var n = i.findNodeBefore(e);
                        if (n && n.tag && !Pt(n.tag) && n.start < e && (!n.endTagStart || n.endTagStart > e)) for(var s = fe(a.getText(), n.start), l = s.scan(); l !== L.EOS && s.getTokenEnd() <= e;){
                            if (l === L.StartTagClose && s.getTokenEnd() === e) return "$0</" + n.tag + ">";
                            l = s.scan();
                        }
                    } else if (r === "/") {
                        for(var n = i.findNodeBefore(e); n && n.closed;)n = n.parent;
                        if (n && n.tag) for(var s = fe(a.getText(), n.start), l = s.scan(); l !== L.EOS && s.getTokenEnd() <= e;){
                            if (l === L.EndTagOpen && s.getTokenEnd() === e) return n.tag + ">";
                            l = s.scan();
                        }
                    }
                    return null;
                }, t.prototype.convertCompletionList = function(a) {
                    return this.doesSupportMarkdown() || a.items.forEach(function(o) {
                        o.documentation && typeof o.documentation != "string" && (o.documentation = {
                            kind: "plaintext",
                    ...
                    var a, o, i;
                    if (!He(this.supportsMarkdown)) {
                        if (!He(this.lsOptions.clientCapabilities)) return this.supportsMarkdown = !0, this.supportsMarkdown;
                        var e = (i = (o = (a = this.lsOptions.clientCapabilities.textDocument) === null || a === void 0 ? void 0 : a.completion) === null || o === void 0 ? void 0 : o.completionItem) === null || i === void 0 ? void 0 : i.documentationFormat;
            ...
            function qt(t, a, o, i) {
                for(var e = fe(t, a, o), r = e.scan(); r === L.Whitespace;)r = e.scan();
                return r === i;
            }
            function ti(t, a, o) {
                for(; a > o && !Ue(t[a - 1]);)a--;
            ...
            var ii = De(), Oi = function() {
                function t(a, o) {
                    this.lsOptions = a, this.dataManager = o;
                }
                return t.prototype.doHover = function(a, o, i, e) {
                    var r = this.convertContents.bind(this), n = this.doesSupportMarkdown(), s = a.offsetAt(o), l = i.findNodeAt(s), u = a.getText();
                    if (!l || !l.tag) return null;
                    var c = this.dataManager.getDataProviders().filter(function(R) {
                        return R.isApplicable(a.languageId);
                    });
                    function d(R, I, U) {
                        for(var O = function(A) {
                            var k = null;
                            if (A.provideTags().forEach(function(D) {
                                if (D.name.toLowerCase() === R.toLowerCase()) {
                                    var M = ce(D, e, n);
                                    M || (M = {
                            ...
                            }), k) return k.contents = r(k.contents), {
                                value: k
                            };
                        }, y = 0, _ = c; y < _.length; y++){
                            var T = _[y], S = O(T);
                    ...
                    function p(R, I, U) {
                        for(var O = function(A) {
                            var k = null;
                            if (A.provideAttributes(R).forEach(function(D) {
                                if (I === D.name && D.description) {
                                    var M = ce(D, e, n);
                                    M ? k = {
                                        contents: M,
                                        range: U
                    ...
                    function m(R, I, U, O) {
                        for(var y = function(k) {
                            var D = null;
                            if (k.provideValues(R, I).forEach(function(M) {
                                if (U === M.name && M.description) {
                                    var F = ce(M, e, n);
                                    F ? D = {
                                        contents: F,
                                        range: O
                            ...
                            }), D) return D.contents = r(D.contents), {
                                value: D
                            };
                        }, _ = 0, T = c; _ < T.length; _++){
                            var S = T[_], A = y(S);
                    ...
                    function f(R, I) {
                        ...
                        for(var O in ke){
                            var y = null, _ = "&" + O;
                            if (U === _) {
                                var T = ke[O].charCodeAt(0).toString(16).toUpperCase(), S = "U+";
                                if (T.length < 4) for(var A = 4 - T.length, k = 0; k < A;)S += "0", k += 1;
                                S += T;
                                var D = ii("entity.propose", "Character entity representing '" + ke[O] + "', unicode equivalent '" + S + "'");
                                D ? y = {
                                    contents: D,
                                    range: I
                                } : y = null;
                            }
                            if (y) return y.contents = r(y.contents), y;
                        }
                        return null;
                    }
                    function b(R, I) {
                        for(var U = fe(a.getText(), I), O = U.scan(); O !== L.EOS && (U.getTokenEnd() < s || U.getTokenEnd() === s && O !== R);)O = U.scan();
                        return O === R && s <= U.getTokenEnd() ? {
                            start: a.positionAt(U.getTokenOffset()),
                            end: a.positionAt(U.getTokenEnd())
                        } : null;
                    }
                    function E() {
                        for(var R = s - 1, I = o.character; R >= 0 && Se(u, R);)R--, I--;
                        for(var U = R + 1, O = I; Se(u, U);)U++, O++;
                        if (R >= 0 && u[R] === "&") {
                            var y = null;
                            return u[U] === ";" ? y = X.create(Q.create(o.line, I), Q.create(o.line, O + 1)) : y = X.create(Q.create(o.line, I), Q.create(o.line, O)), y;
                        }
                        return null;
                    }
                    function H(R) {
                        for(var I = s - 1, U = "&"; I >= 0 && Se(R, I);)I--;
                        for(I = I + 1; Se(R, I);)U += R[I], I += 1;
                        return U += ";", U;
                    }
                    if (l.endTagStart && s >= l.endTagStart) {
                        var x = b(L.EndTag, l.endTagStart);
                        return x ? d(l.tag, x, !1) : null;
                    }
                    var g = b(L.StartTag, l.start);
                    if (g) return d(l.tag, g, !0);
                    var h = b(L.AttributeName, l.start);
                    if (h) {
                        var v = l.tag, B = a.getText(h);
                        return p(v, B, h);
                    }
                    var C = E();
                    if (C) return f(u, C);
                    function P(R, I) {
                        for(var U = fe(a.getText(), R), O = U.scan(), y = void 0; O !== L.EOS && U.getTokenEnd() <= I;)O = U.scan(), O === L.AttributeName && (y = U.getTokenText());
                        return y;
                    }
                    var G = b(L.AttributeValue, l.start);
                    if (G) {
                        var v = l.tag, V = ri(a.getText(G)), N = P(l.start, a.offsetAt(G.start));
                        if (N) return m(v, N, V, G);
                    }
                    return null;
                }, t.prototype.convertContents = function(a) {
                    if (!this.doesSupportMarkdown()) {
                        ...
                        if (Array.isArray(a)) a.map(function(o) {
                    ...
                    if (!He(this.supportsMarkdown)) {
                        if (!He(this.lsOptions.clientCapabilities)) return this.supportsMarkdown = !0, this.supportsMarkdown;
                        var e = (i = (o = (a = this.lsOptions.clientCapabilities) === null || a === void 0 ? void 0 : a.textDocument) === null || o === void 0 ? void 0 : o.hover) === null || i === void 0 ? void 0 : i.contentFormat;
                        this.supportsMarkdown = Array.isArray(e) && e.indexOf(ne.Markdown) !== -1;
                    }
                    return this.supportsMarkdown;
                }, t;
            ...
            function ri(t) {
                return t.length <= 1 ? t.replace(/['"]/, "") : ((t[0] === "'" || t[0] === '"') && (t = t.slice(1)), (t[t.length - 1] === "'" || t[t.length - 1] === '"') && (t = t.slice(0, -1)), t);
            }
            var qi = function(t) {
                var a = {};
                function o(i) {
                ...
                return o.m = t, o.c = a, o.d = function(i, e, r) {
                    ...
                    if (e & 1 && (i = o(i)), e & 8 || e & 4 && typeof i == "object" && i && i.__esModule) return i;
                    var r = Object.create(null);
                    if (o.r(r), Object.defineProperty(r, "default", {
                        enumerable: !0,
                        value: i
                    }), e & 2 && typeof i != "string") for(var n in i)o.d(r, n, (function(s) {
                        return i[s];
                    }).bind(null, n));
                    return r;
                }, o.n = function(i) {
                ...
                function(t, a, o) {
                    "use strict";
                    function i(n) {
                        this.__parent = n, this.__character_count = 0, this.__indent_count = -1, this.__alignment_count = 0, this.__wrap_point_index = 0, this.__wrap_point_character_count = 0, this.__wrap_point_indent_count = -1, this.__wrap_point_alignment_count = 0, this.__items = [];
                    }
                    i.prototype.clone_empty = function() {
                        var n = new i(this.__parent);
                    ...
                    }, i.prototype.has_match = function(n) {
                        for(var s = this.__items.length - 1; s >= 0; s--)if (this.__items[s].match(n)) return !0;
                        return !1;
                    }, i.prototype.set_indent = function(n, s) {
                        this.is_empty() && (this.__indent_count = n || 0, this.__alignment_count = s || 0, this.__character_count = this.__parent.get_indent_size(this.__indent_count, this.__alignment_count));
                        ...
                        if (this._should_wrap()) {
                            ...
                            return n.set_indent(this.__wrap_point_indent_count, this.__wrap_point_alignment_count), n.__items = this.__items.slice(this.__wrap_point_index), this.__items = this.__items.slice(0, this.__wrap_point_index), n.__character_count += this.__character_count - this.__wrap_point_character_count, this.__character_count = this.__wrap_point_character_count, n.__items[0] === " " && (n.__items.splice(0, 1), n.__character_count -= 1), !0;
                        }
                        return !1;
                        ...
                        var s = n.lastIndexOf(`
`);
                        s !== -1 ? this.__character_count = n.length - s : this.__character_count += n.length;
                    }, i.prototype.pop = function() {
                        var n = null;
                        return this.is_empty() || (n = this.__items.pop(), this.__character_count -= n.length), n;
                        ...
                        var n = "";
                        return this.is_empty() ? this.__parent.indent_empty_lines && (n = this.__parent.get_indent_string(this.__indent_count)) : (n = this.__parent.get_indent_string(this.__indent_count, this.__alignment_count), n += this.__items.join("")), n;
                    };
                    function e(n, s) {
                        this.__cache = [
                            ""
                        ], this.__indent_size = n.indent_size, this.__indent_string = n.indent_char, n.indent_with_tabs || (this.__indent_string = new Array(n.indent_size + 1).join(n.indent_char)), s = s || "", n.indent_level > 0 && (s = new Array(n.indent_level + 1).join(this.__indent_string)), this.__base_string = s, this.__base_string_length = s.length;
                    }
                    e.prototype.get_indent_size = function(n, s) {
                        var l = this.__base_string_length;
                        return s = s || 0, n < 0 && (l = 0), l += n * this.__indent_size, l += s, l;
                    }, e.prototype.get_indent_string = function(n, s) {
                        var l = this.__base_string;
                        return s = s || 0, n < 0 && (n = 0, l = ""), s += n * this.__indent_size, this.__ensure_cache(s), l += this.__cache[s], l;
                    }, e.prototype.__ensure_cache = function(n) {
                        for(; n >= this.__cache.length;)this.__add_column();
                    }, e.prototype.__add_column = function() {
                        var n = this.__cache.length, s = 0, l = "";
                        this.__indent_size && n >= this.__indent_size && (s = Math.floor(n / this.__indent_size), n -= s * this.__indent_size, l = new Array(s + 1).join(this.__indent_string)), n && (l += new Array(n + 1).join(" ")), this.__cache.push(l);
                    };
                    function r(n, s) {
                        this.__indent_cache = new e(n, s), this.raw = !1, this._end_with_newline = n.end_with_newline, this.indent_size = n.indent_size, this.wrap_line_length = n.wrap_line_length, this.indent_empty_lines = n.indent_empty_lines, this.__lines = [], this.previous_line = null, this.current_line = null, this.next_line = new i(this), this.space_before_token = !1, this.non_breaking_space = !1, this.previous_token_wrapped = !1, this.__add_outputline();
                    }
                    r.prototype.__add_outputline = function() {
                        this.previous_line = this.current_line, this.current_line = this.next_line.clone_empty(), this.__lines.push(this.current_line);
                    }, r.prototype.get_line_number = function() {
                        return this.__lines.length;
                    }, r.prototype.get_indent_string = function(n, s) {
                        return this.__indent_cache.get_indent_string(n, s);
                    }, r.prototype.get_indent_size = function(n, s) {
                        return this.__indent_cache.get_indent_size(n, s);
                    }, r.prototype.is_empty = function() {
                        return !this.previous_line && this.current_line.is_empty();
                    }, r.prototype.add_new_line = function(n) {
                        return this.is_empty() || !n && this.just_added_newline() ? !1 : (this.raw || this.__add_outputline(), !0);
                    }, r.prototype.get_code = function(n) {
                        this.trim(!0);
...
` && (l = l.replace(/[\n]/g, n)), l;
                    ...
                    }, r.prototype.set_indent = function(n, s) {
                        return n = n || 0, s = s || 0, this.next_line.set_indent(n, s), this.__lines.length > 1 ? (this.current_line.set_indent(n, s), !0) : (this.current_line.set_indent(), !1);
                    }, r.prototype.add_raw_token = function(n) {
                        for(var s = 0; s < n.newlines; s++)this.__add_outputline();
                        this.current_line.set_indent(-1), this.current_line.push(n.whitespace_before), this.current_line.push(n.text), this.space_before_token = !1, this.non_breaking_space = !1, this.previous_token_wrapped = !1;
                    }, r.prototype.add_token = function(n) {
                        this.__add_space_before_token(), this.current_line.push(n), this.space_before_token = !1, this.non_breaking_space = !1, this.previous_token_wrapped = this.current_line._allow_wrap();
                    }, r.prototype.__add_space_before_token = function() {
                        this.space_before_token && !this.just_added_newline() && (this.non_breaking_space || this.set_wrap_point(), this.current_line.push(" "));
                    }, r.prototype.remove_indent = function(n) {
                        for(var s = this.__lines.length; n < s;)this.__lines[n]._remove_indent(), n++;
                        this.current_line._remove_wrap_indent();
                    }, r.prototype.trim = function(n) {
                        for(n = n === void 0 ? !1 : n, this.current_line.trim(); n && this.__lines.length > 1 && this.current_line.is_empty();)this.__lines.pop(), this.current_line = this.__lines[this.__lines.length - 1], this.current_line.trim();
                        this.previous_line = this.__lines.length > 1 ? this.__lines[this.__lines.length - 2] : null;
                    }, r.prototype.just_added_newline = function() {
                        return this.current_line.is_empty();
                    }, r.prototype.just_added_blankline = function() {
                        return this.is_empty() || this.current_line.is_empty() && this.previous_line.is_empty();
                    }, r.prototype.ensure_empty_line_above = function(n, s) {
                        for(var l = this.__lines.length - 2; l >= 0;){
                            var u = this.__lines[l];
                            if (u.is_empty()) break;
                            if (u.item(0).indexOf(n) !== 0 && u.item(-1) !== s) {
                                this.__lines.splice(l + 1, 0, new i(this)), this.previous_line = this.__lines[this.__lines.length - 2];
                                break;
                            }
                            l--;
                        }
                ...
                function(t, a, o) {
                    ...
                    i.prototype._get_array = function(n, s) {
                        var l = this.raw_options[n], u = s || [];
                        return typeof l == "object" ? l !== null && typeof l.concat == "function" && (u = l.concat()) : typeof l == "string" && (u = l.split(/[^a-zA-Z0-9_\/\-]+/)), u;
                    }, i.prototype._get_boolean = function(n, s) {
                        var l = this.raw_options[n], u = l === void 0 ? !!s : !!l;
                        return u;
                    }, i.prototype._get_characters = function(n, s) {
                        var l = this.raw_options[n], u = s || "";
                        return typeof l == "string" && (u = l.replace(/\\r/, "\r").replace(/\\n/, `
`).replace(/\\t/, "	")), u;
                    }, i.prototype._get_number = function(n, s) {
                        var l = this.raw_options[n];
                        s = parseInt(s, 10), isNaN(s) && (s = 0);
                        var u = parseInt(l, 10);
                        return isNaN(u) && (u = s), u;
                    }, i.prototype._get_selection = function(n, s, l) {
                        var u = this._get_selection_list(n, s, l);
                        if (u.length !== 1) throw new Error("Invalid Option Value: The option '" + n + `' can only be one of the following values:
` + s + `
You passed in: '` + this.raw_options[n] + "'");
                        return u[0];
                    }, i.prototype._get_selection_list = function(n, s, l) {
                        if (!s || s.length === 0) throw new Error("Selection list cannot be empty.");
                        if (l = l || [
                            s[0]
                        ], !this._is_valid_selection(l, s)) throw new Error("Invalid Default Value!");
                        var u = this._get_array(n, l);
                        if (!this._is_valid_selection(u, s)) throw new Error("Invalid Option Value: The option '" + n + `' can contain only the following values:
` + s + `
You passed in: '` + this.raw_options[n] + "'");
                        return u;
                    }, i.prototype._is_valid_selection = function(n, s) {
                        return n.length && s.length && !n.some(function(l) {
                    ...
                    t.exports.Options = i, t.exports.normalizeOpts = r, t.exports.mergeOpts = e;
                },
                ,
                function(t, a, o) {
                    "use strict";
                    ...
                    e.prototype.restart = function() {
                        ...
                        var r = null;
                        return this.hasNext() && (r = this.__input.charAt(this.__position), this.__position += 1), r;
                    }, e.prototype.peek = function(r) {
                        var n = null;
                        return r = r || 0, r += this.__position, r >= 0 && r < this.__input_length && (n = this.__input.charAt(r)), n;
                    }, e.prototype.__match = function(r, n) {
                        r.lastIndex = n;
                        var s = r.exec(this.__input);
                        return s && !(i && r.sticky) && s.index !== n && (s = null), s;
                    }, e.prototype.test = function(r, n) {
                        return n = n || 0, n += this.__position, n >= 0 && n < this.__input_length ? !!this.__match(r, n) : !1;
                    }, e.prototype.testChar = function(r, n) {
                        var s = this.peek(n);
                        return r.lastIndex = 0, s !== null && r.test(s);
                    }, e.prototype.match = function(r) {
                        var n = this.__match(r, this.__position);
                        return n ? this.__position += n[0].length : n = null, n;
                    }, e.prototype.read = function(r, n, s) {
                        var l = "", u;
                        return r && (u = this.match(r), u && (l += u[0])), n && (u || !r) && (l += this.readUntil(n, s)), l;
                    }, e.prototype.readUntil = function(r, n) {
                        var s = "", l = this.__position;
                        r.lastIndex = this.__position;
                        var u = r.exec(this.__input);
                        return u ? (l = u.index, n && (l += u[0].length)) : l = this.__input_length, s = this.__input.substring(this.__position, l), this.__position = l, s;
                    }, e.prototype.readUntilAfter = function(r) {
                        return this.readUntil(r, !0);
                    }, e.prototype.get_regexp = function(r, n) {
                        var s = null, l = "g";
                        return n && i && (l = "y"), typeof r == "string" && r !== "" ? s = new RegExp(r, l) : r && (s = new RegExp(r.source, l)), s;
                    }, e.prototype.get_literal_regexp = function(r) {
                        return RegExp(r.replace(/[-\/\\^$*+?.()|[\]{}]/g, "\\$&"));
                    }, e.prototype.peekUntilAfter = function(r) {
                        var n = this.__position, s = this.readUntilAfter(r);
                        return this.__position = n, s;
                    }, e.prototype.lookBack = function(r) {
                        var n = this.__position - 1;
                        return n >= r.length && this.__input.substring(n - r.length, n).toLowerCase() === r;
                ...
                function(t, a, o) {
                    "use strict";
                    function i(e, r) {
                        e = typeof e == "string" ? e : e.source, r = typeof r == "string" ? r : r.source, this.__directives_block_pattern = new RegExp(e + / beautify( \w+[:]\w+)+ /.source + r, "g"), this.__directive_pattern = / (\w+)[:](\w+)/g, this.__directives_end_ignore_pattern = new RegExp(e + /\sbeautify\signore:end\s/.source + r, "g");
                    }
                    i.prototype.get_directives = function(e) {
                        if (!e.match(this.__directives_block_pattern)) return null;
                        var r = {};
                        this.__directive_pattern.lastIndex = 0;
                        for(var n = this.__directive_pattern.exec(e); n;)r[n[1]] = n[2], n = this.__directive_pattern.exec(e);
                        return r;
                ...
                function(t, a, o) {
                    "use strict";
                    var i = o(16).Beautifier, e = o(17).Options;
                    function r(n, s) {
                        var l = new i(n, s);
                        return l.beautify();
                    }
                ...
                function(t, a, o) {
                    "use strict";
                    var i = o(17).Options, e = o(2).Output, r = o(8).InputScanner, n = o(13).Directives, s = new n(/\/\*/, /\*\//), l = /\r\n|[\r\n]/, u = /\r\n|[\r\n]/g, c = /\s/, d = /(?:\s|\n)+/g, p = /\/\*(?:[\s\S]*?)((?:\*\/)|$)/g, m = /\/\/(?:[^\n\r\u2028\u2029]*)/g;
                    function f(b, E) {
                        this._source_text = b || "", this._options = new i(E), this._ch = null, this._input = null, this.NESTED_AT_RULE = {
                            "@page": !0,
                            "@font-face": !0,
                            "@keyframes": !0,
                            "@media": !0,
                    ...
                    f.prototype.eatString = function(b) {
                        var E = "";
...
`) break;
                        ...
                        return E;
                    }, f.prototype.eatWhitespace = function(b) {
                        for(var E = c.test(this._input.peek()), H = 0; c.test(this._input.peek());)this._ch = this._input.next(), b && this._ch === `
` && (H === 0 || H < this._options.max_preserve_newlines) && (H++, this._output.add_new_line(!0));
                        return E;
                    }, f.prototype.foundNestedPseudoClass = function() {
                        for(var b = 0, E = 1, H = this._input.peek(E); H;){
                            if (H === "{") return !0;
                            if (H === "(") b += 1;
                            else if (H === ")") {
                                if (b === 0) return !1;
...
`);
                ...
                function(t, a, o) {
                    ...
                    var i = o(6).Options;
                    function e(r) {
                        i.call(this, r, "css"), this.selector_separator_newline = this._get_boolean("selector_separator_newline", !0), this.newline_between_rules = this._get_boolean("newline_between_rules", !0);
                        ...
                        for(var l = 0; l < s.length; l++)s[l] !== "expand" ? this.brace_style = "collapse" : this.brace_style = s[l];
                    }
                    e.prototype = new i, t.exports.Options = e;
                }
            ]), ji = null, ai = function(t) {
                var a = {};
                function o(i) {
                    if (a[i]) return a[i].exports;
                    var e = a[i] = {
...
` && (l = l.replace(/[\n]/g, n)), l;
                ...
                function(t, a, o) {
                    "use strict";
                    function i(e, r, n, s) {
                        this.type = e, this.text = r, this.comments_before = null, this.newlines = n || 0, this.whitespace_before = s || "", this.parent = null, this.next = null, this.previous = null, this.opened = null, this.closed = null, this.directives = null;
                    }
                    t.exports.Token = i;
                },
                ,
...
You passed in: '` + this.raw_options[n] + "'");
                ...
                function(t, a, o) {
                    "use strict";
                    var i = o(8).InputScanner, e = o(3).Token, r = o(10).TokenStream, n = o(11).WhitespacePattern, s = {
                        START: "TK_START",
                        RAW: "TK_RAW",
                        EOF: "TK_EOF"
                    }, l = function(u, c) {
                        this._input = new i(u), this._options = c || {}, this.__tokens = null, this._patterns = {}, this._patterns.whitespace = new n(this._input);
                    };
                    l.prototype.tokenize = function() {
                        this._input.restart(), this.__tokens = new r, this._reset();
                        for(var u, c = new e(s.START, ""), d = null, p = [], m = new r; c.type !== s.EOF;){
                            for(u = this._get_next_token(c, d); this._is_comment(u);)m.add(u), u = this._get_next_token(c, d);
                            m.isEmpty() || (u.comments_before = m, m = new r), u.parent = d, this._is_opening(u) ? (p.push(d), d = u) : d && this._is_closing(u, d) && (u.opened = d, d.closed = u, d = p.pop(), u.parent = d), u.previous = c, c.next = u, this.__tokens.add(u), c = u;
                        }
                        ...
                        return d ? this._create_token(s.RAW, d) : this._create_token(s.EOF, "");
                        ...
                        var d = new e(u, c, this._patterns.whitespace.newline_count, this._patterns.whitespace.whitespace_before_token);
                        return d;
                ...
                function(t, a, o) {
                    ...
                    i.prototype.restart = function() {
                        ...
                        var r = null;
                        return e = e || 0, e += this.__position, e >= 0 && e < this.__tokens_length && (r = this.__tokens[e]), r;
                ...
                function(t, a, o) {
                    ...
                    var i = o(12).Pattern;
                    function e(r, n) {
                        i.call(this, r, n), n ? this._line_regexp = this._input.get_regexp(n._line_regexp) : this.__set_whitespace_patterns("", ""), this.newline_count = 0, this.whitespace_before_token = "";
                    }
                    e.prototype = new i, e.prototype.__set_whitespace_patterns = function(r, n) {
                        ...
                        if (r === " ") this.whitespace_before_token = " ";
                            ...
                            var n = this.__split(this._newline_regexp, r);
                            this.newline_count = n.length - 1, this.whitespace_before_token = n[this.newline_count];
                        }
                        return r;
                    }, e.prototype.matching = function(r, n) {
                        var s = this._create();
                        return s.__set_whitespace_patterns(r, n), s._update(), s;
                    }, e.prototype._create = function() {
                        return new e(this._input, this);
                    }, e.prototype.__split = function(r, n) {
                        r.lastIndex = 0;
                        for(var s = 0, l = [], u = r.exec(n); u;)l.push(n.substring(s, u.index)), s = u.index + u[0].length, u = r.exec(n);
                        return s < n.length ? l.push(n.substring(s, n.length)) : l.push(""), l;
                    }, t.exports.WhitespacePattern = e;
                },
                function(t, a, o) {
                    "use strict";
                    function i(e, r) {
                    ...
                    i.prototype.read = function() {
                        ...
                        var r = this._create();
                        return r._until_after = !0, r._until_pattern = this._input.get_regexp(e), r._update(), r;
                    }, i.prototype.until = function(e) {
                        var r = this._create();
                        return r._until_after = !1, r._until_pattern = this._input.get_regexp(e), r._update(), r;
                    }, i.prototype.starting_with = function(e) {
                        var r = this._create();
                        return r._starting_pattern = this._input.get_regexp(e, !0), r._update(), r;
                    }, i.prototype.matching = function(e) {
                        var r = this._create();
                        return r._match_pattern = this._input.get_regexp(e, !0), r._update(), r;
                    }, i.prototype._create = function() {
                        return new i(this._input, this);
                    }, i.prototype._update = function() {}, t.exports.Pattern = i;
                },
                function(t, a, o) {
                    "use strict";
                    function i(e, r) {
                ...
                function(t, a, o) {
                    ...
                    function r(n, s) {
                        i.call(this, n, s), this.__template_pattern = null, this._disabled = Object.assign({}, e), this._excluded = Object.assign({}, e), s && (this.__template_pattern = this._input.get_regexp(s.__template_pattern), this._excluded = Object.assign(this._excluded, s._excluded), this._disabled = Object.assign(this._disabled, s._disabled));
                        var l = new i(n);
                        this.__patterns = {
                    ...
                    }, r.prototype.disable = function(n) {
                        var s = this._create();
                        return s._disabled[n] = !0, s._update(), s;
                    }, r.prototype.read_options = function(n) {
                        var s = this._create();
                        for(var l in e)s._disabled[l] = n.templating.indexOf(l) === -1;
                        return s._update(), s;
                    }, r.prototype.exclude = function(n) {
                        var s = this._create();
                        return s._excluded[n] = !0, s._update(), s;
                    }, r.prototype.read = function() {
                        var n = "";
                        this._match_pattern ? n = this._input.read(this._starting_pattern) : n = this._input.read(this._starting_pattern, this.__template_pattern);
                        for(var s = this._read_template(); s;)this._match_pattern ? s += this._input.read(this._match_pattern) : s += this._input.readUntil(this.__template_pattern), n += s, s = this._read_template();
                        return this._until_after && (n += this._input.readUntilAfter(this._until_pattern)), n;
                    }, r.prototype.__set_templated_pattern = function() {
                        var n = [];
                        this._disabled.php || n.push(this.__patterns.php._starting_pattern.source), this._disabled.handlebars || n.push(this.__patterns.handlebars._starting_pattern.source), this._disabled.erb || n.push(this.__patterns.erb._starting_pattern.source), this._disabled.django || (n.push(this.__patterns.django._starting_pattern.source), n.push(this.__patterns.django_value._starting_pattern.source), n.push(this.__patterns.django_comment._starting_pattern.source)), this._disabled.smarty || n.push(this.__patterns.smarty._starting_pattern.source), this._until_pattern && n.push(this._until_pattern.source), this.__template_pattern = this._input.get_regexp("(?:" + n.join("|") + ")");
                    }, r.prototype._read_template = function() {
                        var n = "", s = this._input.peek();
                        if (s === "<") {
                            var l = this._input.peek(1);
                            !this._disabled.php && !this._excluded.php && l === "?" && (n = n || this.__patterns.php.read()), !this._disabled.erb && !this._excluded.erb && l === "%" && (n = n || this.__patterns.erb.read());
                        } else s === "{" && (!this._disabled.handlebars && !this._excluded.handlebars && (n = n || this.__patterns.handlebars_comment.read(), n = n || this.__patterns.handlebars_unescaped.read(), n = n || this.__patterns.handlebars.read()), this._disabled.django || (!this._excluded.django && !this._excluded.handlebars && (n = n || this.__patterns.django_value.read()), this._excluded.django || (n = n || this.__patterns.django_comment.read(), n = n || this.__patterns.django.read())), this._disabled.smarty || this._disabled.django && this._disabled.handlebars && (n = n || this.__patterns.smarty_comment.read(), n = n || this.__patterns.smarty_literal.read(), n = n || this.__patterns.smarty.read()));
                        return n;
                ...
                function(t, a, o) {
                    "use strict";
                    var i = o(19).Beautifier, e = o(20).Options;
                    function r(n, s, l, u) {
                        var c = new i(n, s, l, u);
                        return c.beautify();
                    }
                ...
                function(t, a, o) {
                    "use strict";
                    var i = o(20).Options, e = o(2).Output, r = o(21).Tokenizer, n = o(21).TOKEN, s = /\r\n|[\r\n]/, l = /\r\n|[\r\n]/g, u = function(g, h) {
                        this.indent_level = 0, this.alignment_size = 0, this.max_preserve_newlines = g.max_preserve_newlines, this.preserve_newlines = g.preserve_newlines, this._output = new e(g, h);
                    };
                    u.prototype.current_line_has_match = function(g) {
                        return this._output.current_line.has_match(g);
                    }, u.prototype.set_space_before_token = function(g, h) {
                        this._output.space_before_token = g, this._output.non_breaking_space = h;
                    }, u.prototype.set_wrap_point = function() {
                        this._output.set_indent(this.indent_level, this.alignment_size), this._output.set_wrap_point();
                    }, u.prototype.add_raw_token = function(g) {
                        this._output.add_raw_token(g);
                    }, u.prototype.print_preserved_newlines = function(g) {
                        var h = 0;
                        g.type !== n.TEXT && g.previous.type !== n.TEXT && (h = g.newlines ? 1 : 0), this.preserve_newlines && (h = g.newlines < this.max_preserve_newlines + 1 ? g.newlines : this.max_preserve_newlines + 1);
                        for(var v = 0; v < h; v++)this.print_newline(v > 0);
                        return h !== 0;
                    }, u.prototype.traverse_whitespace = function(g) {
                    ...
                    }, u.prototype.print_newline = function(g) {
                        this._output.add_new_line(g);
                    }, u.prototype.print_token = function(g) {
                        ...
                        this.indent_level++;
                    }, u.prototype.get_full_indent = function(g) {
                        return g = this.indent_level + (g || 0), g < 1 ? "" : this._output.get_indent_string(g);
                    };
                    var c = function(g) {
                        for(var h = null, v = g.next; v.type !== n.EOF && g.closed !== v;){
                            if (v.type === n.ATTRIBUTE && v.text === "type") {
                                v.next && v.next.type === n.EQUALS && v.next.next && v.next.next.type === n.VALUE && (h = v.next.next.text);
                                break;
                            }
                            v = v.next;
                        }
                        ...
                        var v = null, B = null;
                        return h.closed ? (g === "script" ? v = "text/javascript" : g === "style" && (v = "text/css"), v = c(h) || v, v.search("text/css") > -1 ? B = "css" : v.search(/module|((text|application|dojo)\/(x-)?(javascript|ecmascript|jscript|livescript|(ld\+)?json|method|aspect))/) > -1 ? B = "javascript" : v.search(/(text|application|dojo)\/(x-)?(html)/) > -1 ? B = "html" : v.search(/test\/null/) > -1 && (B = "null"), B) : null;
                    };
                    function p(g, h) {
                        return h.indexOf(g) !== -1;
                    }
                    function m(g, h, v) {
                        this.parent = g || null, this.tag = h ? h.tag_name : "", this.indent_level = v || 0, this.parser_token = h || null;
                    }
                    function f(g) {
                    ...
                    f.prototype.get_parser_token = function() {
                        ...
                        var h = new m(this._current_frame, g, this._printer.indent_level);
                        this._current_frame = h;
                    }, f.prototype._try_pop_frame = function(g) {
                        var h = null;
                        return g && (h = g.parser_token, this._printer.indent_level = g.indent_level, this._current_frame = g.parent), h;
                    }, f.prototype._get_frame = function(g, h) {
                        for(var v = this._current_frame; v && g.indexOf(v.tag) === -1;){
                            if (h && h.indexOf(v.tag) !== -1) {
                                v = null;
                                break;
                            }
                            v = v.parent;
                        ...
                        return v;
                    }, f.prototype.try_pop = function(g, h) {
                        var v = this._get_frame([
                            g
                        ], h);
                        return this._try_pop_frame(v);
                    }, f.prototype.indent_to_tag = function(g) {
                        var h = this._get_frame(g);
                        h && (this._printer.indent_level = h.indent_level);
                    };
                    function b(g, h, v, B) {
                        this._source_text = g || "", h = h || {}, this._js_beautify = v, this._css_beautify = B, this._tag_stack = null;
                        var C = new i(h, "html");
                    ...
                    b.prototype.beautify = function() {
                        if (this._options.disabled) return this._source_text;
                        var g = this._source_text, h = this._options.eol;
                        this._options.eol === "auto" && (h = `
`, g && s.test(g) && (h = g.match(s)[0])), g = g.replace(l, `
`);
                        var v = g.match(/^[\t ]*/)[0], B = {
                            text: "",
                            type: ""
                        }, C = new E, P = new u(this._options, v), G = new r(g, this._options).tokenize();
                        this._tag_stack = new f(P);
                        for(var V = null, N = G.next(); N.type !== n.EOF;)N.type === n.TAG_OPEN || N.type === n.COMMENT ? (V = this._handle_tag_open(P, N, C, B), C = V) : N.type === n.ATTRIBUTE || N.type === n.EQUALS || N.type === n.VALUE || N.type === n.TEXT && !C.tag_complete ? V = this._handle_inside_tag(P, N, C, G) : N.type === n.TAG_CLOSE ? V = this._handle_tag_close(P, N, C) : N.type === n.TEXT ? V = this._handle_text(P, N, C) : P.add_raw_token(N), B = V, N = G.next();
                        var R = P._output.get_code(h);
                        return R;
                    }, b.prototype._handle_tag_close = function(g, h, v) {
                        var B = {
                            text: h.text,
                            type: h.type
                        };
                        return g.alignment_size = 0, v.tag_complete = !0, g.set_space_before_token(h.newlines || h.whitespace_before !== "", !0), v.is_unformatted ? g.add_raw_token(h) : (v.tag_start_char === "<" && (g.set_space_before_token(h.text[0] === "/", !0), this._is_wrap_attributes_force_expand_multiline && v.has_wrapped_attrs && g.print_newline(!1)), g.print_token(h)), v.indent_content && !(v.is_unformatted || v.is_content_unformatted) && (g.indent(), v.indent_content = !1), !v.is_inline_element && !(v.is_unformatted || v.is_content_unformatted) && g.set_wrap_point(), B;
                    }, b.prototype._handle_inside_tag = function(g, h, v, B) {
                        var C = v.has_wrapped_attrs, P = {
                            text: h.text,
                            type: h.type
                        };
                        if (g.set_space_before_token(h.newlines || h.whitespace_before !== "", !0), v.is_unformatted) g.add_raw_token(h);
                        else if (v.tag_start_char === "{" && h.type === n.TEXT) g.print_preserved_newlines(h) ? (h.newlines = 0, g.add_raw_token(h)) : g.print_token(h);
                        else {
                            if (h.type === n.ATTRIBUTE ? (g.set_space_before_token(!0), v.attr_count += 1) : (h.type === n.EQUALS || h.type === n.VALUE && h.previous.type === n.EQUALS) && g.set_space_before_token(!1), h.type === n.ATTRIBUTE && v.tag_start_char === "<" && ((this._is_wrap_attributes_preserve || this._is_wrap_attributes_preserve_aligned) && (g.traverse_whitespace(h), C = C || h.newlines !== 0), this._is_wrap_attributes_force)) {
                                var G = v.attr_count > 1;
                                if (this._is_wrap_attributes_force_expand_multiline && v.attr_count === 1) {
                                    var V = !0, N = 0, R;
                                    do {
                                        if (R = B.peek(N), R.type === n.ATTRIBUTE) {
                                            V = !1;
                                            break;
                                        }
                                        N += 1;
                                    }while (N < 4 && R.type !== n.EOF && R.type !== n.TAG_CLOSE);
                                    G = !V;
                                }
                                G && (g.print_newline(!1), C = !0);
                            }
                            g.print_token(h), C = C || g.previous_token_wrapped(), v.has_wrapped_attrs = C;
                        }
                        return P;
                    }, b.prototype._handle_text = function(g, h, v) {
                        var B = {
                            text: h.text,
                            type: "TK_CONTENT"
                        };
                        return v.custom_beautifier_name ? this._print_custom_beatifier_text(g, h, v) : v.is_unformatted || v.is_content_unformatted ? g.add_raw_token(h) : (g.traverse_whitespace(h), g.print_token(h)), B;
                    }, b.prototype._print_custom_beatifier_text = function(g, h, v) {
                        var B = this;
                        if (h.text !== "") {
                            var C = h.text, P, G = 1, V = "", N = "";
                            v.custom_beautifier_name === "javascript" && typeof this._js_beautify == "function" ? P = this._js_beautify : v.custom_beautifier_name === "css" && typeof this._css_beautify == "function" ? P = this._css_beautify : v.custom_beautifier_name === "html" && (P = function(_, T) {
                                var S = new b(_, T, B._js_beautify, B._css_beautify);
                                return S.beautify();
                            }), this._options.indent_scripts === "keep" ? G = 0 : this._options.indent_scripts === "separate" && (G = -g.indent_level);
                            var R = g.get_full_indent(G);
                            if (C = C.replace(/\n[ \t]*$/, ""), v.custom_beautifier_name !== "html" && C[0] === "<" && C.match(/^(<!--|<!\[CDATA\[)/)) {
                                var I = /^(<!--[^\n]*|<!\[CDATA\[)(\n?)([ \t\n]*)([\s\S]*)(-->|]]>)$/.exec(C);
                                if (!I) {
                                    g.add_raw_token(h);
                                    return;
...
`) !== -1) && (I = I[3].match(/[ \t]+$/), I && (h.whitespace_before = I[0]));
                            }
                            if (C) {
                                if (P) {
                                    var U = function() {
...
`;
                                    ...
                                    var y = h.whitespace_before;
                                    y && (C = C.replace(new RegExp(`
(` + y + ")?", "g"), `
`)), C = R + C.replace(/\n/g, `
` + R);
                                }
                            ...
                            V && (C ? C = V + C + `
` + N : C = V + N), g.print_newline(!1), C && (h.text = C, h.whitespace_before = "", h.newlines = 0, g.add_raw_token(h), g.print_newline(!0));
                        }
                    }, b.prototype._handle_tag_open = function(g, h, v, B) {
                        var C = this._get_tag_open_token(h);
                        return (v.is_unformatted || v.is_content_unformatted) && !v.is_empty_element && h.type === n.TAG_OPEN && h.text.indexOf("</") === 0 ? (g.add_raw_token(h), C.start_tag_token = this._tag_stack.try_pop(C.tag_name)) : (g.traverse_whitespace(h), this._set_tag_position(g, h, C, v, B), C.is_inline_element || g.set_wrap_point(), g.print_token(h)), (this._is_wrap_attributes_force_aligned || this._is_wrap_attributes_aligned_multiple || this._is_wrap_attributes_preserve_aligned) && (C.alignment_size = h.text.length + 1), !C.tag_complete && !C.is_unformatted && (g.alignment_size = C.alignment_size), C;
                    };
                    var E = function(g, h) {
                    ...
                    b.prototype._get_tag_open_token = function(g) {
                        ...
                        if (v.is_empty_element || (v.is_end_tag ? v.start_tag_token = this._tag_stack.try_pop(v.tag_name) : (this._do_optional_end_element(v) && (v.is_inline_element || g.print_newline(!1)), this._tag_stack.record_tag(v), (v.tag_name === "script" || v.tag_name === "style") && !(v.is_unformatted || v.is_content_unformatted) && (v.custom_beautifier_name = d(v.tag_check, h)))), p(v.tag_check, this._options.extra_liners) && (g.print_newline(!1), g._output.just_added_blankline() || g.print_newline(!0)), v.is_empty_element) {
                            if (v.tag_start_char === "{" && v.tag_check === "else") {
                                ...
                                var P = g.current_line_has_match(/{{#if/);
                                P || g.print_newline(!1);
                            }
                            v.tag_name === "!--" && C.type === n.TAG_CLOSE && B.is_end_tag && v.text.indexOf(`
`) === -1 || (v.is_inline_element || v.is_unformatted || g.print_newline(!1), this._calcluate_parent_multiline(g, v));
                        } else if (v.is_end_tag) {
                            var G = !1;
                            G = v.start_tag_token && v.start_tag_token.multiline_content, G = G || !v.is_inline_element && !(B.is_inline_element || B.is_unformatted) && !(C.type === n.TAG_CLOSE && v.start_tag_token === B) && C.type !== "TK_CONTENT", (v.is_content_unformatted || v.is_unformatted) && (G = !1), G && g.print_newline(!1);
                        } else v.indent_content = !v.custom_beautifier_name, v.tag_start_char === "<" && (v.tag_name === "html" ? v.indent_content = this._options.indent_inner_html : v.tag_name === "head" ? v.indent_content = this._options.indent_head_inner_html : v.tag_name === "body" && (v.indent_content = this._options.indent_body_inner_html)), !(v.is_inline_element || v.is_unformatted) && (C.type !== "TK_CONTENT" || v.is_content_unformatted) && g.print_newline(!1), this._calcluate_parent_multiline(g, v);
                    }, b.prototype._calcluate_parent_multiline = function(g, h) {
                        h.parent && g._output.just_added_newline() && !((h.is_inline_element || h.is_unformatted) && h.parent.is_inline_element) && (h.parent.multiline_content = !0);
                    };
                    var H = [
                        "address",
                        "article",
                    ...
                    b.prototype._do_optional_end_element = function(g) {
                        var h = null;
                        if (!(g.is_empty_element || !g.is_start_tag || !g.parent)) {
                            if (g.tag_name === "body") h = h || this._tag_stack.try_pop("head");
                            else if (g.tag_name === "li") h = h || this._tag_stack.try_pop("li", [
                                "ol",
                                "ul"
                            ]);
                            else if (g.tag_name === "dd" || g.tag_name === "dt") h = h || this._tag_stack.try_pop("dt", [
                                "dl"
                            ]), h = h || this._tag_stack.try_pop("dd", [
                                "dl"
                            ]);
                            else if (g.parent.tag_name === "p" && H.indexOf(g.tag_name) !== -1) {
                                var v = g.parent.parent;
                                (!v || x.indexOf(v.tag_name) === -1) && (h = h || this._tag_stack.try_pop("p"));
                            } else g.tag_name === "rp" || g.tag_name === "rt" ? (h = h || this._tag_stack.try_pop("rt", [
                                "ruby",
                                "rtc"
                            ]), h = h || this._tag_stack.try_pop("rp", [
                                "ruby",
                                "rtc"
                            ])) : g.tag_name === "optgroup" ? h = h || this._tag_stack.try_pop("optgroup", [
                                "select"
                            ]) : g.tag_name === "option" ? h = h || this._tag_stack.try_pop("option", [
                                "select",
                                "datalist",
                                "optgroup"
                            ]) : g.tag_name === "colgroup" ? h = h || this._tag_stack.try_pop("caption", [
                                "table"
                            ]) : g.tag_name === "thead" ? (h = h || this._tag_stack.try_pop("caption", [
                                "table"
                            ]), h = h || this._tag_stack.try_pop("colgroup", [
                                "table"
                            ])) : g.tag_name === "tbody" || g.tag_name === "tfoot" ? (h = h || this._tag_stack.try_pop("caption", [
                                "table"
                            ]), h = h || this._tag_stack.try_pop("colgroup", [
                                "table"
                            ]), h = h || this._tag_stack.try_pop("thead", [
                                "table"
                            ]), h = h || this._tag_stack.try_pop("tbody", [
                                "table"
                            ])) : g.tag_name === "tr" ? (h = h || this._tag_stack.try_pop("caption", [
                                "table"
                            ]), h = h || this._tag_stack.try_pop("colgroup", [
                                "table"
                            ]), h = h || this._tag_stack.try_pop("tr", [
                                "table",
                                "thead",
                                "tbody",
                                "tfoot"
                            ])) : (g.tag_name === "th" || g.tag_name === "td") && (h = h || this._tag_stack.try_pop("td", [
                                "table",
                                "thead",
                                "tbody",
                                "tfoot",
                                "tr"
                            ]), h = h || this._tag_stack.try_pop("th", [
                                "table",
                                "thead",
                                "tbody",
                                "tfoot",
                            ...
                            return g.parent = this._tag_stack.get_parser_token(), h;
                        }
                    }, t.exports.Beautifier = b;
                },
                function(t, a, o) {
                    "use strict";
                    var i = o(6).Options;
                    function e(r) {
                        i.call(this, r, "html"), this.templating.length === 1 && this.templating[0] === "auto" && (this.templating = [
                            "django",
                            "erb",
                            "handlebars",
                            "php"
                ...
                function(t, a, o) {
                    "use strict";
                    var i = o(9).Tokenizer, e = o(9).TOKEN, r = o(13).Directives, n = o(14).TemplatablePattern, s = o(12).Pattern, l = {
                        ...
                        RAW: e.RAW,
                        EOF: e.EOF
                    }, u = new r(/<\!--/, /-->/), c = function(d, p) {
                        i.call(this, d, p), this._current_tag_name = "";
                        var m = new n(this._input).read_options(this._options), f = new s(this._input);
                        if (this.__patterns = {
                            word: m.until(/[\n\r\t <]/),
                            ...
                            this.__patterns.unformatted_content_delimiter = f.matching(b).until_after(b);
                        }
                    };
                    c.prototype = new i, c.prototype._is_comment = function(d) {
                        return !1;
                    }, c.prototype._is_opening = function(d) {
                        return d.type === l.TAG_OPEN;
                    }, c.prototype._is_closing = function(d, p) {
                        return d.type === l.TAG_CLOSE && p && ((d.text === ">" || d.text === "/>") && p.text[0] === "<" || d.text === "}}" && p.text[0] === "{" && p.text[1] === "{");
                    }, c.prototype._reset = function() {
                        this._current_tag_name = "";
                    }, c.prototype._get_next_token = function(d, p) {
                        var m = null;
                        this._readWhitespace();
                    ...
                    }, c.prototype._read_comment_or_cdata = function(d) {
                        var p = null, m = null, f = null;
                        if (d === "<") {
                            var b = this._input.peek(1);
                            b === "!" && (m = this.__patterns.comment.read(), m ? (f = u.get_directives(m), f && f.ignore === "start" && (m += u.readIgnored(this._input))) : m = this.__patterns.cdata.read()), m && (p = this._create_token(l.COMMENT, m), p.directives = f);
                        }
                        return p;
                    }, c.prototype._read_processing = function(d) {
                        var p = null, m = null, f = null;
                        if (d === "<") {
                            var b = this._input.peek(1);
                            (b === "!" || b === "?") && (m = this.__patterns.conditional_comment.read(), m = m || this.__patterns.processing.read()), m && (p = this._create_token(l.COMMENT, m), p.directives = f);
                        }
                        return p;
                    }, c.prototype._read_open = function(d, p) {
                        var m = null, f = null;
                        return p || d === "<" && (m = this._input.next(), this._input.peek() === "/" && (m += this._input.next()), m += this.__patterns.element_name.read(), f = this._create_token(l.TAG_OPEN, m)), f;
                    }, c.prototype._read_open_handlebars = function(d, p) {
                        var m = null, f = null;
                        return p || this._options.indent_handlebars && d === "{" && this._input.peek(1) === "{" && (this._input.peek(2) === "!" ? (m = this.__patterns.handlebars_comment.read(), m = m || this.__patterns.handlebars.read(), f = this._create_token(l.COMMENT, m)) : (m = this.__patterns.handlebars_open.read(), f = this._create_token(l.TAG_OPEN, m))), f;
                    }, c.prototype._read_close = function(d, p) {
                        var m = null, f = null;
                        return p && (p.text[0] === "<" && (d === ">" || d === "/" && this._input.peek(1) === ">") ? (m = this._input.next(), d === "/" && (m += this._input.next()), f = this._create_token(l.TAG_CLOSE, m)) : p.text[0] === "{" && d === "}" && this._input.peek(1) === "}" && (this._input.next(), this._input.next(), f = this._create_token(l.TAG_CLOSE, "}}"))), f;
                    }, c.prototype._read_attribute = function(d, p, m) {
                        var f = null, b = "";
                        if (m && m.text[0] === "<") {
                            if (d === "=") f = this._create_token(l.EQUALS, this._input.next());
                            else if (d === '"' || d === "'") {
                                var E = this._input.next();
                                d === '"' ? E += this.__patterns.double_quote.read() : E += this.__patterns.single_quote.read(), f = this._create_token(l.VALUE, E);
                            } else b = this.__patterns.attribute.read(), b && (p.type === l.EQUALS ? f = this._create_token(l.VALUE, b) : f = this._create_token(l.ATTRIBUTE, b));
                        }
                        return f;
                    }, c.prototype._is_content_unformatted = function(d) {
                    ...
                    }, c.prototype._read_raw_content = function(d, p, m) {
                        var f = "";
                        if (m && m.text[0] === "{") f = this.__patterns.handlebars_raw_close.read();
                        else if (p.type === l.TAG_CLOSE && p.opened.text[0] === "<" && p.text[0] !== "/") {
                            var b = p.opened.text.substr(1).toLowerCase();
                            if (b === "script" || b === "style") {
                                var E = this._read_comment_or_cdata(d);
                                if (E) return E.type = l.TEXT, E;
                                f = this._input.readUntil(new RegExp("</" + b + "[\\n\\r\\t ]*?>", "ig"));
                            } else this._is_content_unformatted(b) && (f = this._input.readUntil(new RegExp("</" + b + "[\\n\\r\\t ]*?>", "ig")));
                        }
                        return f ? this._create_token(l.TEXT, f) : null;
                    }, c.prototype._read_content_word = function(d) {
                        var p = "";
                        if (this._options.unformatted_content_delimiter && d === this._options.unformatted_content_delimiter[0] && (p = this.__patterns.unformatted_content_delimiter.read()), p || (p = this.__patterns.word.read()), p) return this._create_token(l.TEXT, p);
                    }, t.exports.Tokenizer = c, t.exports.TOKEN = l;
                }
            ]);
            function Gi(t, a) {
                return ai(t, a, js_beautify, css_beautify);
            }
            function Vi(t, a, o) {
                var i = t.getText(), e = !0, r = 0, n = o.tabSize || 4;
                if (a) {
                    for(var s = t.offsetAt(a.start), l = s; l > 0 && jt(i, l - 1);)l--;
                    l === 0 || Je(i, l - 1) ? s = l : l < s && (s = l + 1);
                    for(var u = t.offsetAt(a.end), c = u; c < i.length && jt(i, c);)c++;
                    (c === i.length || Je(i, c)) && (u = c), a = Range.create(t.positionAt(s), t.positionAt(u));
                    var d = i.substring(0, s);
                    if (new RegExp(/.*[<][^>]*$/).test(d)) return i = i.substring(s, u), [
                        {
                            range: a,
                            newText: i
                        }
                    ];
                    if (e = u === i.length, i = i.substring(s, u), s !== 0) {
                        var p = t.offsetAt(Position.create(a.start.line, 0));
                        r = li(t.getText(), p, o);
                    }
                } else a = Range.create(Position.create(0, 0), t.positionAt(i.length));
                var m = {
                    indent_size: n,
                    indent_char: o.insertSpaces ? " " : "	",
                    indent_empty_lines: ee(o, "indentEmptyLines", !1),
                    wrap_line_length: ee(o, "wrapLineLength", 120),
                    unformatted: Ve(o, "unformatted", void 0),
                    content_unformatted: Ve(o, "contentUnformatted", void 0),
                    indent_inner_html: ee(o, "indentInnerHtml", !1),
                    preserve_newlines: ee(o, "preserveNewLines", !0),
                    max_preserve_newlines: ee(o, "maxPreserveNewLines", 32786),
                    indent_handlebars: ee(o, "indentHandlebars", !1),
                    end_with_newline: e && ee(o, "endWithNewline", !1),
                    extra_liners: Ve(o, "extraLiners", void 0),
                    wrap_attributes: ee(o, "wrapAttributes", "auto"),
                    wrap_attributes_indent_size: ee(o, "wrapAttributesIndentSize", void 0),
                    eol: `
`,
                    indent_scripts: ee(o, "indentScripts", "normal"),
                    templating: si(o, "all"),
                    unformatted_content_delimiter: ee(o, "unformattedContentDelimiter", "")
                }, f = html_beautify(oi(i), m);
                if (r > 0) {
                    var b = o.insertSpaces ? repeat(" ", n * r) : repeat("	", r);
                    f = f.split(`
`).join(`
` + b), a.start.character === 0 && (f = b + f);
                }
                return [
                    {
                        range: a,
            ...
            function Ve(t, a, o) {
                var i = ee(t, a, null);
                return typeof i == "string" ? i.length > 0 ? i.split(",").map(function(e) {
                    return e.trim().toLowerCase();
                }) : [] : o;
            }
            function si(t, a) {
                var o = ee(t, "templating", a);
                return o === !0 ? [
                    "auto"
                ] : [
                    "none"
            ...
            function li(t, a, o) {
                for(var i = a, e = 0, r = o.tabSize || 4; i < t.length;){
                    var n = t.charAt(i);
                    if (n === " ") e++;
                    else if (n === "	") e += r;
                    else break;
            ...
            function Ji(t) {
                var a = t.getText();
                if (t.lineCount > 1) {
                    for(var o = t.offsetAt(Position.create(1, 0)), i = o; i > 0 && Je(a, i - 1);)i--;
                    return a.substr(i, o - i);
                }
                return `
`;
            }
            function Je(t, a) {
                return `\r
`.indexOf(t.charAt(a)) !== -1;
            }
            function jt(t, a) {
                return " 	".indexOf(t.charAt(a)) !== -1;
            }
            var Xe = xe("./node_modules/process/browser.js"), Gt;
            Gt = (()=>{
                "use strict";
                var t = {
                    470: (i)=>{
                        ...
                        function r(s, l) {
                            for(var u, c = "", d = 0, p = -1, m = 0, f = 0; f <= s.length; ++f){
                                if (f < s.length) u = s.charCodeAt(f);
                                else {
                                    if (u === 47) break;
                                    u = 47;
                                }
                                if (u === 47) {
                                    if (!(p === f - 1 || m === 1)) {
                                        if (p !== f - 1 && m === 2) {
                                            if (c.length < 2 || d !== 2 || c.charCodeAt(c.length - 1) !== 46 || c.charCodeAt(c.length - 2) !== 46) {
                                                if (c.length > 2) {
                                                    var b = c.lastIndexOf("/");
                                                    if (b !== c.length - 1) {
                                                        b === -1 ? (c = "", d = 0) : d = (c = c.slice(0, b)).length - 1 - c.lastIndexOf("/"), p = f, m = 0;
                                                        continue;
                                                    }
                                        ...
                                        } else c.length > 0 ? c += "/" + s.slice(p + 1, f) : c = s.slice(p + 1, f), d = f - p - 1;
                                    }
                                    p = f, m = 0;
                                } else u === 46 && m !== -1 ? ++m : m = -1;
                            }
                        ...
                        var n = {
                            resolve: function() {
                                for(var s, l = "", u = !1, c = arguments.length - 1; c >= -1 && !u; c--){
                                    var d;
                                    c >= 0 ? d = arguments[c] : (s === void 0 && (s = Xe.cwd()), d = s), e(d), d.length !== 0 && (l = d + "/" + l, u = d.charCodeAt(0) === 47);
                                }
                                return l = r(l, !u), u ? l.length > 0 ? "/" + l : "/" : l.length > 0 ? l : ".";
                            },
                            normalize: function(s) {
                                if (e(s), s.length === 0) return ".";
                                var l = s.charCodeAt(0) === 47, u = s.charCodeAt(s.length - 1) === 47;
                                return (s = r(s, !l)).length !== 0 || l || (s = "."), s.length > 0 && u && (s += "/"), l ? "/" + s : s;
                            },
                            ...
                            relative: function(s, l) {
                                if (e(s), e(l), s === l || (s = n.resolve(s)) === (l = n.resolve(l))) return "";
                                for(var u = 1; u < s.length && s.charCodeAt(u) === 47; ++u);
                                for(var c = s.length, d = c - u, p = 1; p < l.length && l.charCodeAt(p) === 47; ++p);
                                for(var m = l.length - p, f = d < m ? d : m, b = -1, E = 0; E <= f; ++E){
                                    if (E === f) {
                                        if (m > f) {
                                            if (l.charCodeAt(p + E) === 47) return l.slice(p + E + 1);
                                            if (E === 0) return l.slice(p + E);
                                        } else d > f && (s.charCodeAt(u + E) === 47 ? b = E : E === 0 && (b = 0));
                                        break;
                                    }
                                    var H = s.charCodeAt(u + E);
                                    if (H !== l.charCodeAt(p + E)) break;
                                    H === 47 && (b = E);
                                }
                                var x = "";
                                for(E = u + b + 1; E <= c; ++E)E !== c && s.charCodeAt(E) !== 47 || (x.length === 0 ? x += ".." : x += "/..");
                                return x.length > 0 ? x + l.slice(p + b) : (p += b, l.charCodeAt(p) === 47 && ++p, l.slice(p));
                            },
                            ...
                            dirname: function(s) {
                                if (e(s), s.length === 0) return ".";
                                for(var l = s.charCodeAt(0), u = l === 47, c = -1, d = !0, p = s.length - 1; p >= 1; --p)if ((l = s.charCodeAt(p)) === 47) {
                                    if (!d) {
                                        c = p;
                                        break;
                                    }
                            ...
                            basename: function(s, l) {
                                ...
                                if (l !== void 0 && l.length > 0 && l.length <= s.length) {
                                    ...
                                    var m = l.length - 1, f = -1;
                                    for(u = s.length - 1; u >= 0; --u){
                                        var b = s.charCodeAt(u);
                                        if (b === 47) {
                                            if (!p) {
                                                c = u + 1;
                                                break;
                                            }
                                        } else f === -1 && (p = !1, f = u + 1), m >= 0 && (b === l.charCodeAt(m) ? --m == -1 && (d = u) : (m = -1, d = f));
                                    }
                                    return c === d ? d = f : d === -1 && (d = s.length), s.slice(c, d);
                                }
                            ...
                            extname: function(s) {
                                e(s);
                                for(var l = -1, u = 0, c = -1, d = !0, p = 0, m = s.length - 1; m >= 0; --m){
                                    var f = s.charCodeAt(m);
                                    if (f !== 47) c === -1 && (d = !1, c = m + 1), f === 46 ? l === -1 ? l = m : p !== 1 && (p = 1) : l !== -1 && (p = -1);
                                    else if (!d) {
                                        u = m + 1;
                                        break;
                                    }
                                }
                                return l === -1 || c === -1 || p === 0 || p === 1 && l === c - 1 && l === u + 1 ? "" : s.slice(l, c);
                            },
                            format: function(s) {
                            ...
                            parse: function(s) {
                                ...
                                var u, c = s.charCodeAt(0), d = c === 47;
                                d ? (l.root = "/", u = 1) : u = 0;
                                for(var p = -1, m = 0, f = -1, b = !0, E = s.length - 1, H = 0; E >= u; --E)if ((c = s.charCodeAt(E)) !== 47) f === -1 && (b = !1, f = E + 1), c === 46 ? p === -1 ? p = E : H !== 1 && (H = 1) : p !== -1 && (H = -1);
                                else if (!b) {
                                    m = E + 1;
                                    break;
                                }
                                return p === -1 || f === -1 || H === 0 || H === 1 && p === f - 1 && p === m + 1 ? f !== -1 && (l.base = l.name = m === 0 && d ? s.slice(1, f) : s.slice(m, f)) : (m === 0 && d ? (l.name = s.slice(1, p), l.base = s.slice(1, f)) : (l.name = s.slice(m, p), l.base = s.slice(m, f)), l.ext = s.slice(p, f)), m > 0 ? l.dir = s.slice(0, m - 1) : d && (l.dir = "/"), l;
                            },
                            sep: "/",
                            delimiter: ":",
                            win32: null,
                    ...
                    447: (i, e, r)=>{
                        ...
                        if (r.r(e), r.d(e, {
                            URI: ()=>H,
                            Utils: ()=>R
                        }), typeof Xe == "object") n = Xe.platform === "win32";
                        else if (typeof navigator == "object") {
                            var s = navigator.userAgent;
                            n = s.indexOf("Windows") >= 0;
                        }
                        var l, u, c = (l = function(y, _) {
                            ...
                            l(y, _), y.prototype = _ === null ? Object.create(_) : (T.prototype = _.prototype, new T);
                        }), d = /^\w[\w\d+.-]*$/, p = /^\//, m = /^\/\//, f = "", b = "/", E = /^(([^:/?#]+?):)?(\/\/([^/?#]*))?([^?#]*)(\?([^#]*))?(#(.*))?/, H = function() {
                            function y(_, T, S, A, k, D) {
                                D === void 0 && (D = !1), typeof _ == "object" ? (this.scheme = _.scheme || f, this.authority = _.authority || f, this.path = _.path || f, this.query = _.query || f, this.fragment = _.fragment || f) : (this.scheme = function(M, F) {
                                    return M || F ? M : "file";
                                }(_, D), this.authority = T || f, this.path = function(M, F) {
                                    switch(M){
                                        case "https":
                                        case "http":
                                        case "file":
                                    ...
                                    return F;
                                }(this.scheme, S || f), this.query = A || f, this.fragment = k || f, function(M, F) {
                                    if (!M.scheme && F) throw new Error('[UriError]: Scheme is missing: {scheme: "", authority: "' + M.authority + '", path: "' + M.path + '", query: "' + M.query + '", fragment: "' + M.fragment + '"}');
                                    if (M.scheme && !d.test(M.scheme)) throw new Error("[UriError]: Scheme contains illegal characters.");
                                    if (M.path) {
                                        if (M.authority) {
                                            if (!p.test(M.path)) throw new Error('[UriError]: If a URI contains an authority component, then the path component must either be empty or begin with a slash ("/") character');
                                        } else if (m.test(M.path)) throw new Error('[UriError]: If a URI does not contain an authority component, then the path cannot begin with two slash characters ("//")');
                                    }
                                }(this, D));
                            }
                            return y.isUri = function(_) {
                                return _ instanceof y || !!_ && typeof _.authority == "string" && typeof _.fragment == "string" && typeof _.path == "string" && typeof _.query == "string" && typeof _.scheme == "string" && typeof _.fsPath == "function" && typeof _.with == "function" && typeof _.toString == "function";
                                ...
                                enumerable: !1,
                                configurable: !0
                            }), y.prototype.with = function(_) {
                                if (!_) return this;
                                var T = _.scheme, S = _.authority, A = _.path, k = _.query, D = _.fragment;
                                return T === void 0 ? T = this.scheme : T === null && (T = f), S === void 0 ? S = this.authority : S === null && (S = f), A === void 0 ? A = this.path : A === null && (A = f), k === void 0 ? k = this.query : k === null && (k = f), D === void 0 ? D = this.fragment : D === null && (D = f), T === this.scheme && S === this.authority && A === this.path && k === this.query && D === this.fragment ? this : new g(T, S, A, k, D);
                            }, y.parse = function(_, T) {
                                T === void 0 && (T = !1);
                                var S = E.exec(_);
                                return S ? new g(S[2] || f, N(S[4] || f), N(S[5] || f), N(S[7] || f), N(S[9] || f), T) : new g(f, f, f, f, f);
                            }, y.file = function(_) {
                                var T = f;
                                if (n && (_ = _.replace(/\\/g, b)), _[0] === b && _[1] === b) {
                                    var S = _.indexOf(b, 2);
                                    S === -1 ? (T = _.substring(2), _ = b) : (T = _.substring(2, S), _ = _.substring(S) || b);
                                }
                                return new g("file", T, _, f, f);
                            }, y.from = function(_) {
                                return new g(_.scheme, _.authority, _.path, _.query, _.fragment);
                            }, y.prototype.toString = function(_) {
                                return _ === void 0 && (_ = !1), P(this, _);
                                ...
                                if (_) {
                                    ...
                                    var T = new g(_);
                                    return T._formatted = _.external, T._fsPath = _._sep === x ? _.fsPath : null, T;
                                }
                                return _;
                            }, y;
                        }(), x = n ? 1 : void 0, g = function(y) {
                            function _() {
                                var T = y !== null && y.apply(this, arguments) || this;
                                return T._formatted = null, T._fsPath = null, T;
                            }
                            return c(_, y), Object.defineProperty(_.prototype, "fsPath", {
                                get: function() {
                                ...
                                return T === void 0 && (T = !1), T ? P(this, !0) : (this._formatted || (this._formatted = P(this, !1)), this._formatted);
                            }, _.prototype.toJSON = function() {
                                var T = {
                                    $mid: 1
                                };
                                return this._fsPath && (T.fsPath = this._fsPath, T._sep = x), this._formatted && (T.external = this._formatted), this.path && (T.path = this.path), this.scheme && (T.scheme = this.scheme), this.authority && (T.authority = this.authority), this.query && (T.query = this.query), this.fragment && (T.fragment = this.fragment), T;
                            }, _;
                        }(H), h = ((u = {})[58] = "%3A", u[47] = "%2F", u[63] = "%3F", u[35] = "%23", u[91] = "%5B", u[93] = "%5D", u[64] = "%40", u[33] = "%21", u[36] = "%24", u[38] = "%26", u[39] = "%27", u[40] = "%28", u[41] = "%29", u[42] = "%2A", u[43] = "%2B", u[44] = "%2C", u[59] = "%3B", u[61] = "%3D", u[32] = "%20", u);
                        function v(y, _) {
                            for(var T = void 0, S = -1, A = 0; A < y.length; A++){
                                var k = y.charCodeAt(A);
                                if (k >= 97 && k <= 122 || k >= 65 && k <= 90 || k >= 48 && k <= 57 || k === 45 || k === 46 || k === 95 || k === 126 || _ && k === 47) S !== -1 && (T += encodeURIComponent(y.substring(S, A)), S = -1), T !== void 0 && (T += y.charAt(A));
                                else {
                                    T === void 0 && (T = y.substr(0, A));
                                    var D = h[k];
                                    D !== void 0 ? (S !== -1 && (T += encodeURIComponent(y.substring(S, A)), S = -1), T += D) : S === -1 && (S = A);
                                }
                            }
                            return S !== -1 && (T += encodeURIComponent(y.substring(S))), T !== void 0 ? T : y;
                        }
                        function B(y) {
                            for(var _ = void 0, T = 0; T < y.length; T++){
                                var S = y.charCodeAt(T);
                                S === 35 || S === 63 ? (_ === void 0 && (_ = y.substr(0, T)), _ += h[S]) : _ !== void 0 && (_ += y[T]);
                            }
                            return _ !== void 0 ? _ : y;
                        }
                        function C(y, _) {
                            var T;
                            return T = y.authority && y.path.length > 1 && y.scheme === "file" ? "//" + y.authority + y.path : y.path.charCodeAt(0) === 47 && (y.path.charCodeAt(1) >= 65 && y.path.charCodeAt(1) <= 90 || y.path.charCodeAt(1) >= 97 && y.path.charCodeAt(1) <= 122) && y.path.charCodeAt(2) === 58 ? _ ? y.path.substr(1) : y.path[1].toLowerCase() + y.path.substr(2) : y.path, n && (T = T.replace(/\//g, "\\")), T;
                        }
                        function P(y, _) {
                            var T = _ ? B : v, S = "", A = y.scheme, k = y.authority, D = y.path, M = y.query, F = y.fragment;
                            if (A && (S += A, S += ":"), (k || A === "file") && (S += b, S += b), k) {
                                var q = k.indexOf("@");
                                if (q !== -1) {
                                    var J = k.substr(0, q);
                                    k = k.substr(q + 1), (q = J.indexOf(":")) === -1 ? S += T(J, !1) : (S += T(J.substr(0, q), !1), S += ":", S += T(J.substr(q + 1), !1)), S += "@";
                                }
                                (q = (k = k.toLowerCase()).indexOf(":")) === -1 ? S += T(k, !1) : (S += T(k.substr(0, q), !1), S += k.substr(q));
                            }
                            if (D) {
                                if (D.length >= 3 && D.charCodeAt(0) === 47 && D.charCodeAt(2) === 58) (Y = D.charCodeAt(1)) >= 65 && Y <= 90 && (D = "/" + String.fromCharCode(Y + 32) + ":" + D.substr(3));
                                else if (D.length >= 2 && D.charCodeAt(1) === 58) {
                                    var Y;
                                    (Y = D.charCodeAt(0)) >= 65 && Y <= 90 && (D = String.fromCharCode(Y + 32) + ":" + D.substr(2));
                                }
                                S += T(D, !0);
                            }
                            return M && (S += "?", S += T(M, !1)), F && (S += "#", S += _ ? F : v(F, !1)), S;
                        }
                        function G(y) {
                            try {
                                return decodeURIComponent(y);
                            } catch (_) {
                                return y.length > 3 ? y.substr(0, 3) + G(y.substr(3)) : y;
                            }
                        }
                        var V = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
                        function N(y) {
                            return y.match(V) ? y.replace(V, function(_) {
                                return G(_);
                            }) : y;
                        }
                        var R, I = r(470), U = function() {
                            for(var y = 0, _ = 0, T = arguments.length; _ < T; _++)y += arguments[_].length;
                            var S = Array(y), A = 0;
                            for(_ = 0; _ < T; _++)for(var k = arguments[_], D = 0, M = k.length; D < M; D++, A++)S[A] = k[D];
                            return S;
                        }, O = I.posix || I;
                        (function(y) {
                            y.joinPath = function(_) {
                                for(var T = [], S = 1; S < arguments.length; S++)T[S - 1] = arguments[S];
                                return _.with({
                                    path: O.join.apply(O, U([
                                        _.path
                                    ], T))
                                });
                            }, y.resolvePath = function(_) {
                                for(var T = [], S = 1; S < arguments.length; S++)T[S - 1] = arguments[S];
                                var A = _.path || "/";
                                return _.with({
                                    path: O.resolve.apply(O, U([
                                        A
                                    ], T))
                                });
                            }, y.dirname = function(_) {
                                var T = O.dirname(_.path);
                                return T.length === 1 && T.charCodeAt(0) === 46 ? _ : _.with({
                                    path: T
                                });
                            }, y.basename = function(_) {
                                return O.basename(_.path);
                            }, y.extname = function(_) {
                                return O.extname(_.path);
                            };
                        })(R || (R = {}));
                    }
                }, a = {};
                function o(i) {
                    ...
                    return t[i](e, e.exports, o), e.exports;
                }
                return o.d = (i, e)=>{
                    for(var r in e)o.o(e, r) && !o.o(i, r) && Object.defineProperty(i, r, {
                        enumerable: !0,
                        get: e[r]
                    });
                }, o.o = (i, e)=>Object.prototype.hasOwnProperty.call(i, e), o.r = (i)=>{
                    typeof Symbol != "undefined" && Symbol.toStringTag && Object.defineProperty(i, Symbol.toStringTag, {
                        value: "Module"
                    }), Object.defineProperty(i, "__esModule", {
                        value: !0
            ...
            const { URI: Xi, Utils: Yi } = Gt;
            function Ye(t) {
                var a = t[0], o = t[t.length - 1];
                return a === o && (a === "'" || a === '"') && (t = t.substr(1, t.length - 2)), t;
            }
            function ui(t, a) {
                return !t.length || a === "handlebars" && /{{.*}}/.test(t) ? !1 : /\b(w[\w\d+.-]*:\/\/)?[^\s()<>]+(?:\([\w\d]+\)|([^[:punct:]\s]|\/?))/.test(t);
            }
            function ci(t, a, o, i) {
                if (!(/^\s*javascript\:/i.test(a) || /[\n\r]/.test(a))) {
                    if (a = a.replace(/^\s*/g, ""), /^https?:\/\//i.test(a) || /^file:\/\//i.test(a)) return a;
                    if (/^\#/i.test(a)) return t + a;
                    if (/^\/\//i.test(a)) {
                        var e = strings.startsWith(t, "https://") ? "https" : "http";
                        return e + ":" + a.replace(/^\s*/g, "");
                    }
                    return o ? o.resolveReference(a, i || t) : a;
                }
            }
            function hi(t, a, o, i, e, r) {
                var n = Ye(o);
                if (!!ui(n, t.languageId)) {
                    n.length < o.length && (i++, e--);
                    var s = ci(t.uri, n, a, r);
                    if (!(!s || !di(s))) return {
                        range: Range.create(t.positionAt(i), t.positionAt(e)),
                        target: s
                    };
                }
            }
            function di(t) {
                try {
                    return Uri.parse(t), !0;
                } catch (a) {
                    return !1;
                }
            }
            function $i(t, a) {
                for(var o = [], i = createScanner(t.getText(), 0), e = i.scan(), r = void 0, n = !1, s = void 0, l = {}; e !== TokenType.EOS;){
                    switch(e){
                        case TokenType.StartTag:
                            if (!s) {
                        ...
                        case TokenType.AttributeValue:
                            if (r === "src" || r === "href") {
                                ...
                                if (!n) {
                                    var d = hi(t, a, c, i.getTokenOffset(), i.getTokenEnd(), s);
                                    d && o.push(d);
                                }
                                n && typeof s == "undefined" && (s = Ye(c), s && a && (s = a.resolveReference(s, t.uri))), n = !1, r = void 0;
                            } else if (r === "id") {
                                var p = Ye(i.getTokenText());
                                l[p] = i.getTokenOffset();
                            }
                            break;
                    }
                    e = i.scan();
                }
                for(var m = 0, f = o; m < f.length; m++){
                    var d = f[m], b = t.uri + "#";
                    if (d.target && strings.startsWith(d.target, b)) {
                        var E = d.target.substr(b.length), H = l[E];
                        if (H !== void 0) {
                            var x = t.positionAt(H);
                            d.target = "" + b + (x.line + 1) + "," + (x.character + 1);
                        }
                    }
                }
                return o;
            ...
            function Ki(t, a, o) {
                var i = t.offsetAt(a), e = o.findNodeAt(i);
                if (!e.tag) return [];
                var r = [], n = Xt(TokenType.StartTag, t, e.start), s = typeof e.endTagStart == "number" && Xt(TokenType.EndTag, t, e.endTagStart);
                return (n && Jt(n, a) || s && Jt(s, a)) && (n && r.push({
            ...
            function Vt(t, a) {
                return t.line < a.line || t.line === a.line && t.character <= a.character;
            }
            function Jt(t, a) {
                return Vt(t.start, a) && Vt(a, t.end);
            }
            function Xt(t, a, o) {
                for(var i = createScanner(a.getText(), o), e = i.scan(); e !== TokenType.EOS && e !== t;)e = i.scan();
                return e !== TokenType.EOS ? {
                    start: a.positionAt(i.getTokenOffset()),
                    end: a.positionAt(i.getTokenEnd())
                } : null;
            }
            function Qi(t, a) {
                var o = [];
                return a.roots.forEach(function(i) {
                    Yt(t, i, "", o);
                }), o;
            }
            function Yt(t, a, o, i) {
                var e = pi(a), r = Location.create(t.uri, Range.create(t.positionAt(a.start), t.positionAt(a.end))), n = {
                    name: e,
                    location: r,
                    containerName: o,
                    kind: SymbolKind.Field
                };
                i.push(n), a.children.forEach(function(s) {
                    Yt(t, s, e, i);
                });
            }
            function pi(t) {
                var a = t.tag;
                if (t.attributes) {
                    var o = t.attributes.id, i = t.attributes.class;
                    o && (a += "#" + o.replace(/[\"\']/g, "")), i && (a += i.replace(/[\"\']/g, "").split(/\s+/).map(function(e) {
                        return "." + e;
                    }).join(""));
                }
                return a || "?";
            ...
            function Zi(t, a, o) {
                var i = t.offsetAt(a), e = o.findNodeAt(i), r = e.tag ? e.tag.length : 0;
                return e.endTagStart && (e.start + 1 <= i && i <= e.start + 1 + r || e.endTagStart + 2 <= i && i <= e.endTagStart + 2 + r) ? [
                    Range.create(t.positionAt(e.start + 1), t.positionAt(e.start + 1 + r)),
                    Range.create(t.positionAt(e.endTagStart + 2), t.positionAt(e.endTagStart + 2 + r))
                ] : null;
            }
            function mi(t, a) {
                t = t.sort(function(f, b) {
                    var E = f.startLine - b.startLine;
                    return E === 0 && (E = f.endLine - b.endLine), E;
                });
                for(var o = void 0, i = [], e = [], r = [], n = function(f, b) {
                    e[f] = b, b < 30 && (r[b] = (r[b] || 0) + 1);
                }, s = 0; s < t.length; s++){
                    var l = t[s];
                    if (!o) o = l, n(s, 0);
                    else if (l.startLine > o.startLine) {
                        if (l.endLine <= o.endLine) i.push(o), o = l, n(s, i.length);
                        else if (l.startLine > o.endLine) {
                            do o = i.pop();
                            while (o && l.startLine > o.endLine);
                            o && i.push(o), o = l, n(s, i.length);
                        }
                    }
                }
                for(var u = 0, c = 0, s = 0; s < r.length; s++){
                    var d = r[s];
                    if (d) {
                        if (d + u > a) {
                            c = s;
                ...
                for(var p = [], s = 0; s < t.length; s++){
                    var m = e[s];
                    typeof m == "number" && (m < c || m === c && u++ < a) && p.push(t[s]);
                }
                return p;
            }
            function er(t, a) {
                var o = createScanner(t.getText()), i = o.scan(), e = [], r = [], n = null, s = -1;
                function l(x) {
                    e.push(x), s = x.startLine;
                }
                for(; i !== TokenType.EOS;){
                    switch(i){
                        case TokenType.StartTag:
                            var u = o.getTokenText(), c = t.positionAt(o.getTokenOffset()).line;
                            r.push({
                                startLine: c,
                                tagName: u
                            }), n = u;
                        ...
                        case TokenType.EndTag:
                            ...
                            break;
                        case TokenType.StartTagClose:
                            if (!n || !isVoidElement(n)) break;
                        case TokenType.EndTagClose:
                        case TokenType.StartTagSelfClose:
                            for(var d = r.length - 1; d >= 0 && r[d].tagName !== n;)d--;
                            if (d >= 0) {
                                var p = r[d];
                                r.length = d;
                                var m = t.positionAt(o.getTokenOffset()).line, c = p.startLine, f = m - 1;
                                f > c && s !== c && l({
                                    startLine: c,
                                    endLine: f
                                });
                        ...
                        case TokenType.Comment:
                            var c = t.positionAt(o.getTokenOffset()).line, b = o.getTokenText(), E = b.match(/^\s*#(region\b)|(endregion\b)/);
                            if (E) {
                                if (E[1]) r.push({
                                    startLine: c,
                                    tagName: ""
                                    ...
                                    for(var d = r.length - 1; d >= 0 && r[d].tagName.length;)d--;
                                    if (d >= 0) {
                                        var p = r[d];
                                        r.length = d;
                                        var f = c;
                                        c = p.startLine, f > c && s !== c && l({
                                            startLine: c,
                                            endLine: f,
                                ...
                                var f = t.positionAt(o.getTokenOffset() + o.getTokenLength()).line;
                                c < f && l({
                                    startLine: c,
                                    endLine: f,
                ...
                var H = a && a.rangeLimit || Number.MAX_VALUE;
                return e.length > H ? mi(e, H) : e;
            }
            function tr(t, a) {
                function o(i) {
                    for(var e = fi(t, i), r = void 0, n = void 0, s = e.length - 1; s >= 0; s--){
                        var l = e[s];
                        (!r || l[0] !== r[0] || l[1] !== r[1]) && (n = SelectionRange.create(Range.create(t.positionAt(e[s][0]), t.positionAt(e[s][1])), n)), r = l;
                    }
                    return n || (n = SelectionRange.create(Range.create(i, i))), n;
                }
                return a.map(o);
            }
            function fi(t, a) {
                var o = parse(t.getText()), i = t.offsetAt(a), e = o.findNodeAt(i), r = gi(e);
                if (e.startTagEnd && !e.endTagStart) {
                    if (e.startTagEnd !== e.end) return [
                        [
                            e.start,
                            e.end
                        ]
                    ];
                    var n = Range.create(t.positionAt(e.startTagEnd - 2), t.positionAt(e.startTagEnd)), s = t.getText(n);
                    s === "/>" ? r.unshift([
                        e.start + 1,
                        e.startTagEnd - 2
                    ]) : r.unshift([
                    ...
                    var l = $t(t, e, i);
                    return r = l.concat(r), r;
                }
                if (!e.startTagEnd || !e.endTagStart) return r;
                if (r.unshift([
                    e.start,
                    e.end
                ]), e.start < i && i < e.startTagEnd) {
                    r.unshift([
                        e.start + 1,
                        e.startTagEnd - 1
                    ]);
                    var l = $t(t, e, i);
                    return r = l.concat(r), r;
                } else return e.startTagEnd <= i && i <= e.endTagStart ? (r.unshift([
                    e.startTagEnd,
                    e.endTagStart
                ]), r) : (i >= e.endTagStart + 2 && r.unshift([
                    e.endTagStart + 2,
                    e.end - 1
                ]), r);
            }
            function gi(t) {
                for(var a = t, o = function(e) {
                ...
                }, i = []; a.parent;)a = a.parent, o(a).forEach(function(e) {
                    return i.push(e);
                });
                return i;
            }
            function $t(t, a, o) {
                for(var i = Range.create(t.positionAt(a.start), t.positionAt(a.end)), e = t.getText(i), r = o - a.start, n = createScanner(e), s = n.scan(), l = a.start, u = [], c = !1, d = -1; s !== TokenType.EOS;){
                    switch(s){
                        case TokenType.AttributeName:
                            if (r < n.getTokenOffset()) {
                                c = !1;
                                break;
                            }
                            r <= n.getTokenEnd() && u.unshift([
                                n.getTokenOffset(),
                                n.getTokenEnd()
                            ]), c = !0, d = n.getTokenOffset();
                            break;
                        case TokenType.AttributeValue:
                            if (!c) break;
                            var p = n.getTokenText();
                            if (r < n.getTokenOffset()) {
                                u.push([
                                    d,
                                    n.getTokenEnd()
                            ...
                            r >= n.getTokenOffset() && r <= n.getTokenEnd() && (u.unshift([
                                n.getTokenOffset(),
                                n.getTokenEnd()
                            ]), (p[0] === '"' && p[p.length - 1] === '"' || p[0] === "'" && p[p.length - 1] === "'") && r >= n.getTokenOffset() + 1 && r <= n.getTokenEnd() - 1 && u.unshift([
                                n.getTokenOffset() + 1,
                                n.getTokenEnd() - 1
                            ]), u.push([
                                d,
...
*   a _positive value_ means that the element should be focusable and reachable via sequential keyboard navigation; the order in which the elements are focused is the increasing value of the [**tabindex**](#attr-tabindex). If several elements share the same tabindex, their relative order follows their relative positions in the document.`
                ...
                function t(a) {
                    this.dataProviders = [], this.setDataProviders(a.useDefaultDataProvider !== !1, a.customDataProviders || []);
                }
                return t.prototype.setDataProviders = function(a, o) {
                    var i;
                    this.dataProviders = [], a && this.dataProviders.push(new Nn("html5", bi)), (i = this.dataProviders).push.apply(i, o);
            ...
            function ir(t) {
                t === void 0 && (t = vi);
                var a = new HTMLDataManager(t), o = new HTMLHover(t, a), i = new HTMLCompletion(t, a);
                return {
                    setDataProviders: a.setDataProviders.bind(a),
                    createScanner,
                    parseHTMLDocument: function(e) {
                        return parse(e.getText());
                    },
            ...
            function wi(t, a) {
                return new HTMLDataProvider(t, a);
            }
            function rr() {
                return wi("default", htmlData);
            }
            var Kt = function() {
                function t(a, o, i) {
                    var e = this;
                    this._languageId = a, this._worker = o, this._disposables = [], this._listener = Object.create(null);
                    var r = function(s) {
                        var l = s.getModeId();
                        if (l === e._languageId) {
                            var u;
                            e._listener[s.uri.toString()] = s.onDidChangeContent(function() {
                                clearTimeout(u), u = setTimeout(function() {
                                    return e._doValidate(s.uri, l);
                                }, 500);
                            }), e._doValidate(s.uri, l);
                        }
                    }, n = function(s) {
                        W.j6.setModelMarkers(s, e._languageId, []);
                        var l = s.uri.toString(), u = e._listener[l];
                        u && (u.dispose(), delete e._listener[l]);
                    };
                    this._disposables.push(W.j6.onDidCreateModel(r)), this._disposables.push(W.j6.onWillDisposeModel(function(s) {
                        n(s);
                    })), this._disposables.push(W.j6.onDidChangeModelLanguage(function(s) {
                        n(s.model), r(s.model);
                    })), this._disposables.push(i.onDidChange(function(s) {
                        W.j6.getModels().forEach(function(l) {
                            l.getModeId() === e._languageId && (n(l), r(l));
                        });
                    })), this._disposables.push({
                        dispose: function() {
                            for(var s in e._listener)e._listener[s].dispose();
                        }
                    }), W.j6.getModels().forEach(r);
                }
                return t.prototype.dispose = function() {
                    this._disposables.forEach(function(a) {
                        return a && a.dispose();
                    }), this._disposables = [];
                }, t.prototype._doValidate = function(a, o) {
                    this._worker(a).then(function(i) {
                        return i.doValidation(a.toString()).then(function(e) {
                            var r = e.map(function(s) {
                                return yi(a, s);
                            }), n = W.j6.getModel(a);
                            n && n.getModeId() === o && W.j6.setModelMarkers(n, o, r);
                        });
            ...
            function yi(t, a) {
                var o = typeof a.code == "number" ? String(a.code) : a.code;
                return {
                    severity: _i(a.severity),
                    startLineNumber: a.range.start.line + 1,
                    startColumn: a.range.start.character + 1,
                    endLineNumber: a.range.end.line + 1,
                    endColumn: a.range.end.character + 1,
                    message: a.message,
                    code: o,
                    source: a.source
                };
            ...
            function Ti(t) {
                if (!!t) return {
                    start: he(t.getStartPosition()),
                    end: he(t.getEndPosition())
                };
            }
            function ie(t) {
                if (!!t) return new W.e6(t.start.line + 1, t.start.character + 1, t.end.line + 1, t.end.character + 1);
            }
            function ki(t) {
                return typeof t.insert != "undefined" && typeof t.replace != "undefined";
            }
            function Si(t) {
                var a = W.Mj.CompletionItemKind;
                switch(t){
                    case j.Text:
                        return a.Text;
                    case j.Method:
            ...
            function ar(t) {
                var a = languages.CompletionItemKind;
                switch(t){
                    case a.Text:
            ...
            var Qt = function() {
                ...
                return Object.defineProperty(t.prototype, "triggerCharacters", {
                    get: function() {
                        return [
                            ".",
                            ":",
                    ...
                    enumerable: !1,
                    configurable: !0
                }), t.prototype.provideCompletionItems = function(a, o, i, e) {
                    var r = a.uri;
                    return this._worker(r).then(function(n) {
                        return n.doComplete(r.toString(), he(o));
                    }).then(function(n) {
                        if (!!n) {
                            var s = a.getWordUntilPosition(o), l = new W.e6(o.lineNumber, s.startColumn, o.lineNumber, s.endColumn), u = n.items.map(function(c) {
                                var d = {
                                    label: c.label,
                                ...
                                return c.textEdit && (ki(c.textEdit) ? d.range = {
                                    insert: ie(c.textEdit.insert),
                                    replace: ie(c.textEdit.replace)
                                } : d.range = ie(c.textEdit.range), d.insertText = c.textEdit.newText), c.additionalTextEdits && (d.additionalTextEdits = c.additionalTextEdits.map($e)), c.insertTextFormat === te.Snippet && (d.insertTextRules = W.Mj.CompletionItemInsertTextRule.InsertAsSnippet), d;
                            });
                            return {
...
` + t.value + "\n```\n"
            ...
            function xi(t) {
                if (!!t) return Array.isArray(t) ? t.map(Zt) : [
                    Zt(t)
                ];
            }
            var en = function() {
                ...
                return t.prototype.provideHover = function(a, o, i) {
                    var e = a.uri;
                    return this._worker(e).then(function(r) {
                        return r.doHover(e.toString(), he(o));
                    }).then(function(r) {
                        if (!!r) return {
                            range: ie(r.range),
                            contents: xi(r.contents)
                        };
                    });
                }, t;
            }();
            function Di(t) {
                var a = W.Mj.DocumentHighlightKind;
                switch(t){
                    case Te.Read:
                        return a.Read;
                    case Te.Write:
            ...
            var tn = function() {
                ...
                return t.prototype.provideDocumentHighlights = function(a, o, i) {
                    var e = a.uri;
                    return this._worker(e).then(function(r) {
                        return r.findDocumentHighlights(e.toString(), he(o));
                    }).then(function(r) {
                        if (!!r) return r.map(function(n) {
                            return {
                                range: ie(n.range),
                                kind: Di(n.kind)
                            };
            ...
            var nn = function() {
                ...
                return t.prototype.provideDocumentSymbols = function(a, o) {
                    var i = a.uri;
                    return this._worker(i).then(function(e) {
                        return e.findDocumentSymbols(i.toString());
                    }).then(function(e) {
                        if (!!e) return e.map(function(r) {
                            return {
                                name: r.name,
                                detail: "",
                                ...
                                kind: Ei(r.kind),
                                tags: [],
                                range: ie(r.location.range),
                                selectionRange: ie(r.location.range)
                            };
                        });
                    });
                }, t;
                ...
                return t.prototype.provideLinks = function(a, o) {
                    var i = a.uri;
                    return this._worker(i).then(function(e) {
                        return e.findDocumentLinks(i.toString());
                    }).then(function(e) {
                        if (!!e) return {
                            links: e.map(function(r) {
                                return {
                                    range: ie(r.range),
                                    url: r.target
                                };
            ...
            var on = function() {
                ...
                return t.prototype.provideDocumentFormattingEdits = function(a, o, i) {
                    var e = a.uri;
                    return this._worker(e).then(function(r) {
                        return r.format(e.toString(), null, an(o)).then(function(n) {
                ...
                return t.prototype.provideDocumentRangeFormattingEdits = function(a, o, i, e) {
                    var r = a.uri;
                    return this._worker(r).then(function(n) {
                        return n.format(r.toString(), Ti(o), an(i)).then(function(s) {
                            if (!(!s || s.length === 0)) return s.map($e);
                        });
                    });
                }, t;
            }(), ln = function() {
                ...
                return t.prototype.provideRenameEdits = function(a, o, i, e) {
                    var r = a.uri;
                    return this._worker(r).then(function(n) {
                        return n.doRename(r.toString(), he(o), i);
                    }).then(function(n) {
                        return Ci(n);
                    });
                }, t;
            ...
            function Ci(t) {
                if (!(!t || !t.changes)) {
                    var a = [];
                    for(var o in t.changes)for(var i = W.Sf.parse(o), e = 0, r = t.changes[o]; e < r.length; e++){
                        var n = r[e];
                        a.push({
                            resource: i,
                            edit: {
            ...
            var un = function() {
                ...
                return t.prototype.provideFoldingRanges = function(a, o, i) {
                    var e = a.uri;
                    return this._worker(e).then(function(r) {
                        return r.getFoldingRanges(e.toString(), o);
                    }).then(function(r) {
                        if (!!r) return r.map(function(n) {
                            var s = {
                                start: n.startLine + 1,
                            ...
                            return typeof n.kind != "undefined" && (s.kind = Li(n.kind)), s;
                        });
                    });
                }, t;
            }();
            function Li(t) {
                switch(t){
                    case be.Comment:
                        return W.Mj.FoldingRangeKind.Comment;
                    case be.Imports:
                        return W.Mj.FoldingRangeKind.Imports;
                    case be.Region:
                        return W.Mj.FoldingRangeKind.Region;
                }
            }
            var cn = function() {
                function t(a) {
                ...
                return t.prototype.provideSelectionRanges = function(a, o, i) {
                    var e = a.uri;
                    return this._worker(e).then(function(r) {
                        return r.getSelectionRanges(e.toString(), o.map(he));
                    }).then(function(r) {
                        if (!!r) return r.map(function(n) {
                            for(var s = []; n;)s.push({
                                range: ie(n.range)
            ...
            function Mi(t) {
                var a = new et(t), o = function() {
                    for(var e = [], r = 0; r < arguments.length; r++)e[r] = arguments[r];
                    return a.getLanguageServiceWorker.apply(a, e);
                }, i = t.languageId;
                W.Mj.registerCompletionItemProvider(i, new Qt(o)), W.Mj.registerHoverProvider(i, new en(o)), W.Mj.registerDocumentHighlightProvider(i, new tn(o)), W.Mj.registerLinkProvider(i, new rn(o)), W.Mj.registerFoldingRangeProvider(i, new un(o)), W.Mj.registerDocumentSymbolProvider(i, new nn(o)), W.Mj.registerSelectionRangeProvider(i, new cn(o)), W.Mj.registerRenameProvider(i, new ln(o)), i === "html" && (W.Mj.registerDocumentFormattingEditProvider(i, new on(o)), W.Mj.registerDocumentRangeFormattingEditProvider(i, new sn(o)), new Kt(i, o, t));
            }
            function Ri(t) {
                var a = [], o = [], i = new et(t);
                a.push(i);
...
},{}]},["idf5y","dmVef"], "dmVef", "parcelRequirec5e9")
